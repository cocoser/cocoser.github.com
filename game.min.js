...
cc.AsyncPool=function(a,c,b,d,e){var f=this;f._srcObj=a;f._limit=c;f._pool=[];f._iterator=b;f._iteratorTarget=e;f._onEnd=d;f._onEndTarget=e;f._results=a instanceof Array?[]:{};cc.each(a,function(a,c){f._pool.push({index:c,value:a})});f.size=f._pool.length;f.finishedSize=0;f._workingSize=0;f._limit=f._limit||f.size;f.onIterator=function(a,c){f._iterator=a;f._iteratorTarget=c};f.onEnd=function(a,c){f._onEnd=a;f._onEndTarget=c};f._handleItem=function(){var a=this;if(!(0===a._pool.length||a._workingSize>=
a._limit)){var c=a._pool.shift(),b=c.value,d=c.index;a._workingSize++;a._iterator.call(a._iteratorTarget,b,d,function(c){a.finishedSize++;a._workingSize--;var b=Array.prototype.slice.call(arguments,1);a._results[this.index]=b[0];a.finishedSize===a.size?a._onEnd&&a._onEnd.call(a._onEndTarget,null,a._results):a._handleItem()}.bind(c),a)}};f.flow=function(){if(0===this._pool.length)this._onEnd&&this._onEnd.call(this._onEndTarget,null,[]);else for(var a=0;a<this._limit;a++)this._handleItem()}};
...
Array?b:[b],e[2]=d;else throw Error("arguments error to load js!");return e},loadJs:function(a,c,b){var d=this,e=d._jsCache,f=d._getArgs4Js(arguments),g=f[0],h=f[1],f=f[2];-1<navigator.userAgent.indexOf("Trident/5")?d._loadJs4Dependency(g,h,0,f):cc.async.map(h,function(a,c,b){a=cc.path.join(g,a);if(e[a])return b(null);d._createScript(a,!1,b)},f)},loadJsWithImg:function(a,c,b){var d=this._loadJsImg(),e=this._getArgs4Js(arguments);this.loadJs(e[0],e[1],function(a){if(a)throw Error(a);d.parentNode.removeChild(d);
if(e[2])e[2]()})},_createScript:function(a,c,b){var d=document,e=cc.newElement("script");e.async=c;this._jsCache[a]=!0;cc.game.config.noCache&&"string"===typeof a?this._noCacheRex.test(a)?e.src=a+"\x26_t\x3d"+(new Date-0):e.src=a+"?_t\x3d"+(new Date-0):e.src=a;cc._addEventListener(e,"load",function(){e.parentNode.removeChild(e);this.removeEventListener("load",arguments.callee,!1);b()},!1);cc._addEventListener(e,"error",function(){e.parentNode.removeChild(e);b("Load "+a+" failed!")},!1);d.body.appendChild(e)},
_loadJs4Dependency:function(a,c,b,d){if(b>=c.length)d&&d();else{var e=this;e._createScript(cc.path.join(a,c[b]),!1,function(f){if(f)return d(f);e._loadJs4Dependency(a,c,b+1,d)})}},_loadJsImg:function(){var a=document,c=a.getElementById("cocos2d_loadJsImg");if(!c){c=cc.newElement("img");cc._loadingImage&&(c.src=cc._loadingImage);a=a.getElementById(cc.game.config.id);a.style.backgroundColor="transparent";a.parentNode.appendChild(c);var b=getComputedStyle?getComputedStyle(a):a.currentStyle;b||(b={width:a.width,
height:a.height});c.style.left=a.offsetLeft+(parseFloat(b.width)-c.width)/2+"px";c.style.top=a.offsetTop+(parseFloat(b.height)-c.height)/2+"px";c.style.position="absolute"}return c},loadTxt:function(a,c){if(cc._isNodeJs)require("fs").readFile(a,function(a,b){a?c(a):c(null,b.toString())});else{var b=this.getXMLHttpRequest(),d="load "+a+" failed!";b.open("GET",a,!0);/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)?(b.setRequestHeader("Accept-Charset","utf-8"),b.onreadystatechange=
function(){4===b.readyState&&(200===b.status?c(null,b.responseText):c({status:b.status,errorMessage:d},null))}):(b.overrideMimeType&&b.overrideMimeType("text/plain; charset\x3dutf-8"),b.onload=function(){4===b.readyState&&(200===b.status?c(null,b.responseText):c({status:b.status,errorMessage:d},null))},b.onerror=function(){c({status:b.status,errorMessage:d},null)});b.send(null)}},_loadTxtSync:function(a){if(cc._isNodeJs)return require("fs").readFileSync(a).toString();var c=this.getXMLHttpRequest();
c.open("GET",a,!1);/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)?c.setRequestHeader("Accept-Charset","utf-8"):c.overrideMimeType&&c.overrideMimeType("text/plain; charset\x3dutf-8");c.send(null);return 4===!c.readyState||200!==c.status?null:c.responseText},loadCsb:function(a,c){var b=new XMLHttpRequest,d="load "+a+" failed!";b.open("GET",a,!0);b.responseType="arraybuffer";b.onload=function(){var a=b.response;a&&(window.msg=a);4===b.readyState&&(200===b.status?c(null,b.response):
c({status:b.status,errorMessage:d},null))};b.onerror=function(){c({status:b.status,errorMessage:d},null)};b.send(null)},loadJson:function(a,c){this.loadTxt(a,function(b,d){if(b)c(b);else{try{var e=JSON.parse(d)}catch(f){throw Error("parse json ["+a+"] failed : "+f);}c(null,e)}})},_checkIsImageURL:function(a){return null!=/(\.png)|(\.jpg)|(\.bmp)|(\.jpeg)|(\.gif)/.exec(a)},loadImg:function(a,c,b){var d={isCrossOrigin:!0};void 0!==b?d.isCrossOrigin=null===c.isCrossOrigin?d.isCrossOrigin:c.isCrossOrigin:
void 0!==c&&(b=c);var e=this.getRes(a);if(e)return b&&b(null,e),e;e=new Image;d.isCrossOrigin&&"file://"!==location.origin&&(e.crossOrigin="Anonymous");var f=function(){this.removeEventListener("load",f,!1);this.removeEventListener("error",h,!1);b&&b(null,e)},g=this,h=function(){this.removeEventListener("error",h,!1);e.crossOrigin&&"anonymous"===e.crossOrigin.toLowerCase()?(d.isCrossOrigin=!1,g.release(a),cc.loader.loadImg(a,d,b)):"function"===typeof b&&b("load image failed")};cc._addEventListener(e,
"load",f);cc._addEventListener(e,"error",h);e.src=a;return e},_loadResIterator:function(a,c,b){var d=this,e=null,f=a.type;f?(f="."+f.toLowerCase(),e=a.src?a.src:a.name+f):(e=a,f=cc.path.extname(e));if(c=d.getRes(e))return b(null,c);c=null;f&&(c=d._register[f.toLowerCase()]);if(!c)return cc.error("loader for ["+f+"] not exists!"),b();f=e;cc._urlRegExp.test(e)||(f=c.getBasePath?c.getBasePath():d.resPath,f=d.getUrl(f,e));cc.game.config.noCache&&"string"===typeof f&&(f=d._noCacheRex.test(f)?f+("\x26_t\x3d"+
(new Date-0)):f+("?_t\x3d"+(new Date-0)));c.load(f,e,a,function(a,c){a?(cc.log(a),d.cache[e]=null,delete d.cache[e],b({status:520,errorMessage:a},null)):(d.cache[e]=c,b(null,c))})},_noCacheRex:/\?/,getUrl:function(a,c){var b=this._langPathCache,d=cc.path;if(void 0!==a&&void 0===c){c=a;var e=d.extname(c),e=e?e.toLowerCase():"";a=(e=this._register[e])?e.getBasePath?e.getBasePath():this.resPath:this.resPath}c=cc.path.join(a||"",c);if(c.match(/[\/(\\\\)]lang[\/(\\\\)]/i)){if(b[c])return b[c];d=d.extname(c)||
"";c=b[c]=c.substring(0,c.length-d.length)+"_"+cc.sys.language+d}return c},load:function(a,c,b){var d=this,e=arguments.length;if(0===e)throw Error("arguments error!");3===e?"function"===typeof c&&(c="function"===typeof b?{trigger:c,cb:b}:{cb:c,cbTarget:b}):2===e?"function"===typeof c&&(c={cb:c}):1===e&&(c={});a instanceof Array||(a=[a]);e=new cc.AsyncPool(a,0,function(a,b,e,k){d._loadResIterator(a,b,function(a){var b=Array.prototype.slice.call(arguments,1);c.trigger&&c.trigger.call(c.triggerTarget,
b[0],k.size,k.finishedSize);e(a,b[0])})},c.cb,c.cbTarget);e.flow();return e},_handleAliases:function(a,c){var b=this._aliases,d=[],e;for(e in a){var f=a[e];b[e]=f;d.push(f)}this.load(d,c)},loadAliases:function(a,c){var b=this,d=b.getRes(a);d?b._handleAliases(d.filenames,c):b.load(a,function(a,d){b._handleAliases(d[0].filenames,c)})},register:function(a,c){if(a&&c){if("string"===typeof a)return this._register[a.trim().toLowerCase()]=c;for(var b=0,d=a.length;b<d;b++)this._register["."+a[b].trim().toLowerCase()]=
c}},getRes:function(a){return this.cache[a]||this.cache[this._aliases[a]]},release:function(a){var c=this.cache,b=this._aliases;delete c[a];delete c[b[a]];delete b[a]},releaseAll:function(){var a=this.cache,c=this._aliases,b;for(b in a)delete a[b];for(b in c)delete c[b]}};
...
"Windows";b.OS_MARMALADE="Marmalade";b.OS_LINUX="Linux";b.OS_BADA="Bada";b.OS_BLACKBERRY="Blackberry";b.OS_OSX="OS X";b.OS_WP8="WP8";b.OS_WINRT="WINRT";b.OS_UNKNOWN="Unknown";b.UNKNOWN=-1;b.WIN32=0;b.LINUX=1;b.MACOS=2;b.ANDROID=3;b.IPHONE=4;b.IPAD=5;b.BLACKBERRY=6;b.NACL=7;b.EMSCRIPTEN=8;b.TIZEN=9;b.WINRT=10;b.WP8=11;b.MOBILE_BROWSER=100;b.DESKTOP_BROWSER=101;b.BROWSER_TYPE_WECHAT="wechat";b.BROWSER_TYPE_ANDROID="androidbrowser";b.BROWSER_TYPE_IE="ie";b.BROWSER_TYPE_QQ="qqbrowser";b.BROWSER_TYPE_MOBILE_QQ=
"mqqbrowser";b.BROWSER_TYPE_UC="ucbrowser";b.BROWSER_TYPE_360="360browser";b.BROWSER_TYPE_BAIDU_APP="baiduboxapp";b.BROWSER_TYPE_BAIDU="baidubrowser";b.BROWSER_TYPE_MAXTHON="maxthon";b.BROWSER_TYPE_OPERA="opera";b.BROWSER_TYPE_OUPENG="oupeng";b.BROWSER_TYPE_MIUI="miuibrowser";b.BROWSER_TYPE_FIREFOX="firefox";b.BROWSER_TYPE_SAFARI="safari";b.BROWSER_TYPE_CHROME="chrome";b.BROWSER_TYPE_LIEBAO="liebao";b.BROWSER_TYPE_QZONE="qzone";b.BROWSER_TYPE_SOUGOU="sogou";b.BROWSER_TYPE_UNKNOWN="unknown";b.isNative=
!1;var d=window,e=d.navigator,f=document,g=f.documentElement,h=e.userAgent.toLowerCase();b.isMobile=-1!==h.indexOf("mobile")||-1!==h.indexOf("android");b.platform=b.isMobile?b.MOBILE_BROWSER:b.DESKTOP_BROWSER;var k=e.language,k=(k=k?k:e.browserLanguage)?k.split("-")[0]:b.LANGUAGE_ENGLISH;b.language=k;var k=b.BROWSER_TYPE_UNKNOWN,m=h.match(/sogou|qzone|liebao|micromessenger|qqbrowser|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i)||h.match(/chrome|safari/i);
m&&0<m.length?(k=m[0],"micromessenger"===k?k=b.BROWSER_TYPE_WECHAT:"safari"===k&&h.match(/android.*applewebkit/)?k=b.BROWSER_TYPE_ANDROID:"trident"===k?k=b.BROWSER_TYPE_IE:"360 aphone"===k&&(k=b.BROWSER_TYPE_360)):h.indexOf("iphone")&&h.indexOf("mobile")&&(k="safari");b.browserType=k;k=h.match(/(iPad|iPhone|iPod)/i)?!0:!1;h=h.match(/android/i)||e.platform.match(/android/i)?!0:!1;m=b.OS_UNKNOWN;-1!==e.appVersion.indexOf("Win")?m=b.OS_WINDOWS:k?m=b.OS_IOS:-1!==e.appVersion.indexOf("Mac")?m=b.OS_OSX:
-1!==e.appVersion.indexOf("X11")&&-1===e.appVersion.indexOf("Linux")?m=b.OS_UNIX:h?m=b.OS_ANDROID:-1!==e.appVersion.indexOf("Linux")&&(m=b.OS_LINUX);b.os=m;b._supportMultipleAudio=-1<[b.BROWSER_TYPE_BAIDU,b.BROWSER_TYPE_OPERA,b.BROWSER_TYPE_FIREFOX,b.BROWSER_TYPE_CHROME,b.BROWSER_TYPE_BAIDU_APP,b.BROWSER_TYPE_SAFARI,b.BROWSER_TYPE_UC,b.BROWSER_TYPE_QQ,b.BROWSER_TYPE_MOBILE_QQ,b.BROWSER_TYPE_IE].indexOf(b.browserType);(function(a,b){var e=b[c.renderMode]-0;if(isNaN(e)||2<e||0>e)e=0;var f=[a.OS_ANDROID],
g=[],h=cc.newElement("canvas");cc._renderType=cc._RENDER_TYPE_CANVAS;cc._supportRender=!1;var m=d.WebGLRenderingContext;if(2===e||0===e&&m&&-1===f.indexOf(a.os)&&-1===g.indexOf(a.browserType))try{cc.create3DContext(h,{stencil:!0,preserveDrawingBuffer:!0})&&(cc._renderType=cc._RENDER_TYPE_WEBGL,cc._supportRender=!0)}catch(k){}if(1===e||0===e&&!1===cc._supportRender)try{h.getContext("2d"),cc._renderType=cc._RENDER_TYPE_CANVAS,cc._supportRender=!0}catch(p){}})(b,a);b._canUseCanvasNewBlendModes=function(){var a=
document.createElement("canvas");a.width=1;a.height=1;a=a.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,1,1);a.globalCompositeOperation="multiply";var c=document.createElement("canvas");c.width=1;c.height=1;var b=c.getContext("2d");b.fillStyle="#fff";b.fillRect(0,0,1,1);a.drawImage(c,0,0,1,1);return 0===a.getImageData(0,0,1,1).data[0]};b._supportCanvasNewBlendModes=b._canUseCanvasNewBlendModes();try{b._supportWebAudio=!!(d.AudioContext||d.webkitAudioContext||d.mozAudioContext)}catch(p){b._supportWebAudio=
!1}try{var n=b.localStorage=d.localStorage;n.setItem("storage","");n.removeItem("storage");n=null}catch(s){n=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},b.localStorage={getItem:n,setItem:n,removeItem:n,clear:n}}n=b.capabilities={canvas:!0};cc._renderType===cc._RENDER_TYPE_WEBGL&&(n.opengl=!0);if(void 0!==g.ontouchstart||void 0!==f.ontouchstart||e.msPointerEnabled)n.touches=!0;void 0!==g.onmouseup&&(n.mouse=!0);void 0!==g.onkeyup&&(n.keyboard=
!0);if(d.DeviceMotionEvent||d.DeviceOrientationEvent)n.accelerometer=!0;b.garbageCollect=function(){};b.dumpRoot=function(){};b.restartVM=function(){};b.cleanScript=function(a){};b.isObjectValid=function(a){return a?!0:!1};b.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+="language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";a+="os : "+this.os+"\r\n";a+="platform : "+this.platform+"\r\n";cc.log(a)};
b.openURL=function(a){window.open(a)}};cc.ORIENTATION_PORTRAIT=0;cc.ORIENTATION_PORTRAIT_UPSIDE_DOWN=1;cc.ORIENTATION_LANDSCAPE_LEFT=2;cc.ORIENTATION_LANDSCAPE_RIGHT=3;cc._drawingUtil=null;cc._renderContext=null;cc._canvas=null;cc._gameDiv=null;cc._rendererInitialized=!1;cc._setupCalled=!1;
...
c=function(){a._paused||(b.mainLoop(),a._intervalId&&window.cancelAnimationFrame(a._intervalId),a._intervalId=window.requestAnimFrame(c))};window.requestAnimFrame(c);a._paused=!1},restart:function(){cc.director.popToSceneStackLevel(0);cc.audioEngine&&cc.audioEngine.end();cc.game.onStart()},run:function(a){var c=this,b=function(){a&&(c.config[c.CONFIG_KEY.id]=a);c._prepareCalled||c.prepare(function(){c._prepared=!0});cc._supportRender&&(c._checkPrepare=setInterval(function(){c._prepared&&(cc._setup(c.config[c.CONFIG_KEY.id]),
c._runMainLoop(),c._eventHide=c._eventHide||new cc.EventCustom(c.EVENT_HIDE),c._eventHide.setUserData(c),c._eventShow=c._eventShow||new cc.EventCustom(c.EVENT_SHOW),c._eventShow.setUserData(c),c.onStart(),clearInterval(c._checkPrepare))},10))};document.body?b():cc._addEventListener(window,"load",function(){this.removeEventListener("load",arguments.callee,!1);b()},!1)},_initConfig:function(){var a=this.CONFIG_KEY,c=function(c){c[a.engineDir]=c[a.engineDir]||"frameworks/cocos2d-html5";null==c[a.debugMode]&&
...
c(k||{})}catch(m){cc.log("Failed to read or parse project.json"),this.config=c({})}cc._initSys(this.config,a)},_jsAddedCache:{},_getJsListOfModule:function(a,c,b){var d=this._jsAddedCache;if(d[c])return null;b=b||"";var e=[],f=a[c];if(!f)throw Error("can not find module ["+c+"]");c=cc.path;for(var g=0,h=f.length;g<h;g++){var k=f[g];if(!d[k]){var m=c.extname(k);m?".js"===m.toLowerCase()&&e.push(c.join(b,k)):(m=this._getJsListOfModule(a,k,b))&&(e=e.concat(m));d[k]=1}}return e},prepare:function(a){var c=
this,b=c.config,d=c.CONFIG_KEY,e=b[d.engineDir],f=cc.loader;if(!cc._supportRender)throw Error("The renderer doesn't support the renderMode "+b[d.renderMode]);c._prepareCalled=!0;var g=b[d.jsList]||[];cc.Class?f.loadJsWithImg("",g,function(b){if(b)throw Error(b);c._prepared=!0;a&&a()}):(d=cc.path.join(e,"moduleConfig.json"),f.loadJson(d,function(d,f){if(d)throw Error(d);var m=b.modules||[],p=f.module,n=[];cc._renderType===cc._RENDER_TYPE_WEBGL?m.splice(0,0,"shaders"):0>m.indexOf("core")&&m.splice(0,
0,"core");for(var s=0,r=m.length;s<r;s++){var t=c._getJsListOfModule(p,m[s],e);t&&(n=n.concat(t))}n=n.concat(g);cc.loader.loadJsWithImg(n,function(b){if(b)throw Error(b);c._prepared=!0;a&&a()})}))}};cc.game._initConfig();
...
cc._logToWebPage=function(a){if(cc._canvas){var c=cc._logList,b=document;if(!c){var d=b.createElement("Div"),c=d.style;d.setAttribute("id","logInfoDiv");cc._canvas.parentNode.appendChild(d);d.setAttribute("width","200");d.setAttribute("height",cc._canvas.height);c.zIndex="99999";c.position="absolute";c.top="0";c.left="0";c=cc._logList=b.createElement("textarea");b=c.style;c.setAttribute("rows","20");c.setAttribute("cols","30");c.setAttribute("disabled",!0);d.appendChild(c);b.backgroundColor="transparent";
b.borderBottom="1px solid #cccccc";b.borderRightWidth="0px";b.borderLeftWidth="0px";b.borderTopWidth="0px";b.borderTopStyle="none";b.borderRightStyle="none";b.borderLeftStyle="none";b.padding="0px";b.margin=0}c.value=c.value+a+"\r\n";c.scrollTop=c.scrollHeight}};cc._formatString=function(a){if(cc.isObject(a))try{return JSON.stringify(a)}catch(c){return""}else return a};
cc._initDebugSetting=function(a){var c=cc.game;if(a!==c.DEBUG_MODE_NONE){var b;a>c.DEBUG_MODE_ERROR?(b=cc._logToWebPage.bind(cc),cc.error=function(){b("ERROR :  "+cc.formatStr.apply(cc,arguments))},cc.assert=function(a,c){if(!a&&c){for(var f=2;f<arguments.length;f++)c=c.replace(/(%s)|(%d)/,cc._formatString(arguments[f]));b("Assert: "+c)}},a!==c.DEBUG_MODE_ERROR_FOR_WEB_PAGE&&(cc.warn=function(){b("WARN :  "+cc.formatStr.apply(cc,arguments))}),a===c.DEBUG_MODE_INFO_FOR_WEB_PAGE&&(cc.log=function(){b(cc.formatStr.apply(cc,
arguments))})):console&&console.log.apply&&(cc.error=function(){return console.error.apply(console,arguments)},cc.assert=function(a,c){if(!a&&c){for(var b=2;b<arguments.length;b++)c=c.replace(/(%s)|(%d)/,cc._formatString(arguments[b]));throw Error(c);}},a!==c.DEBUG_MODE_ERROR&&(cc.warn=function(){return console.warn.apply(console,arguments)}),a===c.DEBUG_MODE_INFO&&(cc.log=function(){return console.log.apply(console,arguments)}))}};cc._initDebugSetting(cc.game.config[cc.game.CONFIG_KEY.debugMode]);cc.loader.loadBinary=function(a,c){var b=this,d=this.getXMLHttpRequest(),e="load "+a+" failed!";d.open("GET",a,!0);cc.loader.loadBinary._IEFilter?(d.setRequestHeader("Accept-Charset","x-user-defined"),d.onreadystatechange=function(){if(4===d.readyState&&200===d.status){var a=cc._convertResponseBodyToText(d.responseBody);c(null,b._str2Uint8Array(a))}else c(e)}):(d.overrideMimeType&&d.overrideMimeType("text/plain; charset\x3dx-user-defined"),d.onload=function(){4===d.readyState&&200===d.status?c(null,
b._str2Uint8Array(d.responseText)):c(e)});d.send(null)};cc.loader.loadBinary._IEFilter=/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)&&window.IEBinaryToArray_ByteStr&&window.IEBinaryToArray_ByteStr_Last;cc.loader._str2Uint8Array=function(a){if(!a)return null;for(var c=new Uint8Array(a.length),b=0;b<a.length;b++)c[b]=a.charCodeAt(b)&255;return c};
cc.loader.loadBinarySync=function(a){var c=this.getXMLHttpRequest(),b="load "+a+" failed!";c.open("GET",a,!1);a=null;if(cc.loader.loadBinary._IEFilter){c.setRequestHeader("Accept-Charset","x-user-defined");c.send(null);if(200!==c.status)return cc.log(b),null;(c=cc._convertResponseBodyToText(c.responseBody))&&(a=this._str2Uint8Array(c))}else{c.overrideMimeType&&c.overrideMimeType("text/plain; charset\x3dx-user-defined");c.send(null);if(200!==c.status)return cc.log(b),null;a=this._str2Uint8Array(c.responseText)}return a};
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var p=arguments[k],n;for(n in p){var s="function"===typeof p[n],r="function"===typeof e[n],t=a.test(p[n]);c&&s&&r&&t?(h.value=ClassManager.compileSuper(p[n],n,g),Object.defineProperty(f,n,h)):s&&r&&t?(h.value=function(a,c){return function(){var b=this._super;this._super=e[a];var d=c.apply(this,
arguments);this._super=b;return d}}(n,p[n]),Object.defineProperty(f,n,h)):s?(h.value=p[n],Object.defineProperty(f,n,h)):f[n]=p[n];if(s){var q,u;if(this.__getters__&&this.__getters__[n]){var s=this.__getters__[n],v;for(v in this.__setters__)if(this.__setters__[v]===s){u=v;break}cc.defineGetterSetter(f,s,p[n],p[u]?p[u]:f[u],n,u)}if(this.__setters__&&this.__setters__[n]){s=this.__setters__[n];for(v in this.__getters__)if(this.__getters__[v]===s){q=v;break}cc.defineGetterSetter(f,s,p[q]?p[q]:f[q],p[n],
q,n)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var c in a)f[c]=a[c]};return d}})();
cc.defineGetterSetter=function(a,c,b,d,e,f){if(a.__defineGetter__)b&&a.__defineGetter__(c,b),d&&a.__defineSetter__(c,d);else if(Object.defineProperty){var g={enumerable:!1,configurable:!0};b&&(g.get=b);d&&(g.set=d);Object.defineProperty(a,c,g)}else throw Error("browser does not support getters");if(!e&&!f)for(var g=null!=b,h=void 0!=d,k=Object.getOwnPropertyNames(a),m=0;m<k.length;m++){var p=k[m];if((a.__lookupGetter__?!a.__lookupGetter__(p):!Object.getOwnPropertyDescriptor(a,p))&&"function"===typeof a[p]){var n=
a[p];if(g&&n===b&&(e=p,!h||f))break;if(h&&n===d&&(f=p,!g||e))break}}a=a.constructor;e&&(a.__getters__||(a.__getters__={}),a.__getters__[e]=c);f&&(a.__setters__||(a.__setters__={}),a.__setters__[f]=c)};cc.clone=function(a){var c=a.constructor?new a.constructor:{},b;for(b in a){var d=a[b];c[b]="object"!==typeof d||!d||d instanceof cc.Node||d instanceof HTMLElement?d:cc.clone(d)}return c};cc.inject=function(a,c){for(var b in a)c[b]=a[b]};cc=cc||{};cc._tmp=cc._tmp||{};cc.associateWithNative=function(a,c){};
...
cc.base=function(a,c,b){var d=arguments.callee.caller;if(d.superClass_)return ret=d.superClass_.constructor.apply(a,Array.prototype.slice.call(arguments,1));for(var e=Array.prototype.slice.call(arguments,2),f=!1,g=a.constructor;g;g=g.superClass_&&g.superClass_.constructor)if(g.prototype[c]===d)f=!0;else if(f)return g.prototype[c].apply(a,e);if(a[c]===d)return a.constructor.prototype[c].apply(a,e);throw Error("cc.base called from a method of one name to a method of a different name");};cc.Point=function(a,c){this.x=a||0;this.y=c||0};cc.p=function(a,c){return void 0===a?{x:0,y:0}:void 0===c?{x:a.x,y:a.y}:{x:a,y:c}};cc.pointEqualToPoint=function(a,c){return a&&c&&a.x===c.x&&a.y===c.y};cc.Size=function(a,c){this.width=a||0;this.height=c||0};cc.size=function(a,c){return void 0===a?{width:0,height:0}:void 0===c?{width:a.width,height:a.height}:{width:a,height:c}};cc.sizeEqualToSize=function(a,c){return a&&c&&a.width===c.width&&a.height===c.height};
...
cc.PlistParser=cc.SAXParser.extend({parse:function(a){a=this._parseXML(a).documentElement;if("plist"!==a.tagName)throw Error("Not a plist file!");for(var c=null,b=0,d=a.childNodes.length;b<d&&(c=a.childNodes[b],1!==c.nodeType);b++);return this._parseNode(c)},_parseNode:function(a){var c=null,b=a.tagName;if("dict"===b)c=this._parseDict(a);else if("array"===b)c=this._parseArray(a);else if("string"===b)if(1===a.childNodes.length)c=a.firstChild.nodeValue;else for(c="",b=0;b<a.childNodes.length;b++)c+=
...
cc._fontLoader={TYPE:{".eot":"embedded-opentype",".ttf":"truetype",".ttc":"truetype",".woff":"woff",".svg":"svg"},_loadFont:function(a,c,b){var d=document,e=cc.path,f=this.TYPE,g=cc.newElement("style");g.type="text/css";d.body.appendChild(g);var h="",h=isNaN(a-0)?h+("@font-face { font-family:"+a+"; src:"):h+("@font-face { font-family:'"+a+"'; src:");if(c instanceof Array)for(var k=0,m=c.length;k<m;k++)b=e.extname(c[k]).toLowerCase(),h+="url('"+c[k]+"') format('"+f[b]+"')",h+=k===m-1?";":",";else b=
b.toLowerCase(),h+="url('"+c+"') format('"+f[b]+"');";g.textContent+=h+"}";c=cc.newElement("div");b=c.style;b.fontFamily=a;c.innerHTML=".";b.position="absolute";b.left="-100px";b.top="-100px";d.body.appendChild(c)},load:function(a,c,b,d){c=b.type;a=b.name;c=b.srcs;cc.isString(b)?(c=cc.path.extname(b),a=cc.path.basename(b,c),this._loadFont(a,b,c)):this._loadFont(a,c);d(null,!0)}};cc.loader.register("font eot ttf woff svg ttc".split(" "),cc._fontLoader);
cc._binaryLoader={load:function(a,c,b,d){cc.loader.loadBinary(a,d)}};cc._csbLoader={load:function(a,c,b,d){cc.loader.loadCsb(a,d)}};cc.loader.register(["csb"],cc._csbLoader);window.CocosEngine=cc.ENGINE_VERSION="Cocos2d-JS v3.7.1";cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL=0;cc.DIRECTOR_STATS_POSITION=cc.p(0,0);cc.DIRECTOR_FPS_INTERVAL=0.5;cc.COCOSNODE_RENDER_SUBPIXEL=1;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL=1;cc.OPTIMIZE_BLEND_FUNC_FOR_PREMULTIPLIED_ALPHA=1;cc.TEXTURE_ATLAS_USE_TRIANGLE_STRIP=0;cc.TEXTURE_ATLAS_USE_VAO=0;cc.TEXTURE_NPOT_SUPPORT=0;cc.RETINA_DISPLAY_SUPPORT=1;cc.RETINA_DISPLAY_FILENAME_SUFFIX="-hd";cc.USE_LA88_LABELS=1;cc.SPRITE_DEBUG_DRAW=0;
...
cc.FLT_EPSILON=1.192092896E-7;cc.contentScaleFactor=cc.IS_RETINA_DISPLAY_SUPPORTED?function(){return cc.director.getContentScaleFactor()}:function(){return 1};cc.pointPointsToPixels=function(a){var c=cc.contentScaleFactor();return cc.p(a.x*c,a.y*c)};cc.pointPixelsToPoints=function(a){var c=cc.contentScaleFactor();return cc.p(a.x/c,a.y/c)};cc._pointPixelsToPointsOut=function(a,c){var b=cc.contentScaleFactor();c.x=a.x/b;c.y=a.y/b};
...
cc.ITEM_SIZE=32;cc.CURRENT_ITEM=3233828865;cc.ZOOM_ACTION_TAG=3233828866;cc.NORMAL_TAG=8801;cc.SELECTED_TAG=8802;cc.DISABLE_TAG=8803;cc.arrayVerifyType=function(a,c){if(a&&0<a.length)for(var b=0;b<a.length;b++)if(!(a[b]instanceof c))return cc.log("element type is wrong!"),!1;return!0};cc.arrayRemoveObject=function(a,c){for(var b=0,d=a.length;b<d;b++)if(a[b]===c){a.splice(b,1);break}};cc.arrayRemoveArray=function(a,c){for(var b=0,d=c.length;b<d;b++)cc.arrayRemoveObject(a,c[b])};
cc.arrayAppendObjectsToIndex=function(a,c,b){a.splice.apply(a,[b,0].concat(c));return a};cc.copyArray=function(a){var c,b=a.length,d=Array(b);for(c=0;c<b;c+=1)d[c]=a[c];return d};cc=cc||{};cc._tmp=cc._tmp||{};
...
g+h,1);this._bU8=new Uint8Array(f,g+2*h,1);this._aU8=new Uint8Array(f,g+3*h,1);this._rU8[0]=a||0;this._gU8[0]=b||0;this._bU8[0]=d||0;this._aU8[0]=null==e?255:e;void 0===e&&(this.a_undefined=!0)};cc.Color.BYTES_PER_ELEMENT=4;var a=cc.Color.prototype;a._getR=function(){return this._rU8[0]};a._setR=function(a){this._rU8[0]=0>a?0:a};a._getG=function(){return this._gU8[0]};a._setG=function(a){this._gU8[0]=0>a?0:a};a._getB=function(){return this._bU8[0]};a._setB=function(a){this._bU8[0]=0>a?0:a};a._getA=
...
a||0;this._yF32[0]=b||0};cc.Vertex2F.BYTES_PER_ELEMENT=8;a=cc.Vertex2F.prototype;a._getX=function(){return this._xF32[0]};a._setX=function(a){this._xF32[0]=a};a._getY=function(){return this._yF32[0]};a._setY=function(a){this._yF32[0]=a};cc.defineGetterSetter(a,"x",a._getX,a._setX);cc.defineGetterSetter(a,"y",a._getY,a._setY);cc.Vertex3F=function(a,b,d,e,f){this._arrayBuffer=e||new ArrayBuffer(cc.Vertex3F.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;f=this._offset;this._xF32=new Float32Array(e,
...
"x",a._getX,a._setX);cc.defineGetterSetter(a,"y",a._getY,a._setY);cc.defineGetterSetter(a,"z",a._getZ,a._setZ);cc.Tex2F=function(a,b,d,e){this._arrayBuffer=d||new ArrayBuffer(cc.Tex2F.BYTES_PER_ELEMENT);this._offset=e||0;this._uF32=new Float32Array(this._arrayBuffer,this._offset,1);this._vF32=new Float32Array(this._arrayBuffer,this._offset+4,1);this._uF32[0]=a||0;this._vF32[0]=b||0};cc.Tex2F.BYTES_PER_ELEMENT=8;a=cc.Tex2F.prototype;a._getU=function(){return this._uF32[0]};a._setU=function(a){this._uF32[0]=
a};a._getV=function(){return this._vF32[0]};a._setV=function(a){this._vF32[0]=a};cc.defineGetterSetter(a,"u",a._getU,a._setU);cc.defineGetterSetter(a,"v",a._getV,a._setV);cc.Quad2=function(a,b,d,e,f,g){this._arrayBuffer=f||new ArrayBuffer(cc.Quad2.BYTES_PER_ELEMENT);this._offset=g||0;f=this._arrayBuffer;g=cc.Vertex2F.BYTES_PER_ELEMENT;this._tl=a?new cc.Vertex2F(a.x,a.y,f,0):new cc.Vertex2F(0,0,f,0);this._tr=b?new cc.Vertex2F(b.x,b.y,f,g):new cc.Vertex2F(0,0,f,g);this._bl=d?new cc.Vertex2F(d.x,d.y,
...
a.y};cc.defineGetterSetter(a,"tl",a._getTL,a._setTL);cc.defineGetterSetter(a,"tr",a._getTR,a._setTR);cc.defineGetterSetter(a,"bl",a._getBL,a._setBL);cc.defineGetterSetter(a,"br",a._getBR,a._setBR);cc.Quad3=function(a,b,d,e){this.bl=a||new cc.Vertex3F(0,0,0);this.br=b||new cc.Vertex3F(0,0,0);this.tl=d||new cc.Vertex3F(0,0,0);this.tr=e||new cc.Vertex3F(0,0,0)};cc.V3F_C4B_T2F=function(a,b,d,e,f){this._arrayBuffer=e||new ArrayBuffer(cc.V3F_C4B_T2F.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;
f=this._offset;var g=cc.Vertex3F.BYTES_PER_ELEMENT;this._vertices=a?new cc.Vertex3F(a.x,a.y,a.z,e,f):new cc.Vertex3F(0,0,0,e,f);this._colors=b?cc.color(b.r,b.g,b.b,b.a,e,f+g):cc.color(0,0,0,0,e,f+g);this._texCoords=d?new cc.Tex2F(d.u,d.v,e,f+g+cc.Color.BYTES_PER_ELEMENT):new cc.Tex2F(0,0,e,f+g+cc.Color.BYTES_PER_ELEMENT)};cc.V3F_C4B_T2F.BYTES_PER_ELEMENT=24;a=cc.V3F_C4B_T2F.prototype;a._getVertices=function(){return this._vertices};a._setVertices=function(a){var b=this._vertices;b.x=a.x;b.y=a.y;b.z=
a.z};a._getColor=function(){return this._colors};a._setColor=function(a){var b=this._colors;b.r=a.r;b.g=a.g;b.b=a.b;b.a=a.a};a._getTexCoords=function(){return this._texCoords};a._setTexCoords=function(a){this._texCoords.u=a.u;this._texCoords.v=a.v};cc.defineGetterSetter(a,"vertices",a._getVertices,a._setVertices);cc.defineGetterSetter(a,"colors",a._getColor,a._setColor);cc.defineGetterSetter(a,"texCoords",a._getTexCoords,a._setTexCoords);cc.V3F_C4B_T2F_Quad=function(a,b,d,e,f,g){this._arrayBuffer=
f||new ArrayBuffer(cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT);this._offset=g||0;f=this._arrayBuffer;g=this._offset;var h=cc.V3F_C4B_T2F.BYTES_PER_ELEMENT;this._tl=a?new cc.V3F_C4B_T2F(a.vertices,a.colors,a.texCoords,f,g):new cc.V3F_C4B_T2F(null,null,null,f,g);this._bl=b?new cc.V3F_C4B_T2F(b.vertices,b.colors,b.texCoords,f,g+h):new cc.V3F_C4B_T2F(null,null,null,f,g+h);this._tr=d?new cc.V3F_C4B_T2F(d.vertices,d.colors,d.texCoords,f,g+2*h):new cc.V3F_C4B_T2F(null,null,null,f,g+2*h);this._br=e?new cc.V3F_C4B_T2F(e.vertices,
e.colors,e.texCoords,f,g+3*h):new cc.V3F_C4B_T2F(null,null,null,f,g+3*h)};cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT=96;a=cc.V3F_C4B_T2F_Quad.prototype;a._getTL=function(){return this._tl};a._setTL=function(a){var b=this._tl;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords};a._getBL=function(){return this._bl};a._setBL=function(a){var b=this._bl;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords};a._getTR=function(){return this._tr};a._setTR=function(a){var b=this._tr;b.vertices=
a.vertices;b.colors=a.colors;b.texCoords=a.texCoords};a._getBR=function(){return this._br};a._setBR=function(a){var b=this._br;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords};a._getArrayBuffer=function(){return this._arrayBuffer};cc.defineGetterSetter(a,"tl",a._getTL,a._setTL);cc.defineGetterSetter(a,"tr",a._getTR,a._setTR);cc.defineGetterSetter(a,"bl",a._getBL,a._setBL);cc.defineGetterSetter(a,"br",a._getBR,a._setBR);cc.defineGetterSetter(a,"arrayBuffer",a._getArrayBuffer,null);
cc.V3F_C4B_T2F_QuadZero=function(){return new cc.V3F_C4B_T2F_Quad};cc.V3F_C4B_T2F_QuadCopy=function(a){if(!a)return cc.V3F_C4B_T2F_QuadZero();var b=a.tl,d=a.bl,e=a.tr;a=a.br;return{tl:{vertices:{x:b.vertices.x,y:b.vertices.y,z:b.vertices.z},colors:{r:b.colors.r,g:b.colors.g,b:b.colors.b,a:b.colors.a},texCoords:{u:b.texCoords.u,v:b.texCoords.v}},bl:{vertices:{x:d.vertices.x,y:d.vertices.y,z:d.vertices.z},colors:{r:d.colors.r,g:d.colors.g,b:d.colors.b,a:d.colors.a},texCoords:{u:d.texCoords.u,v:d.texCoords.v}},
tr:{vertices:{x:e.vertices.x,y:e.vertices.y,z:e.vertices.z},colors:{r:e.colors.r,g:e.colors.g,b:e.colors.b,a:e.colors.a},texCoords:{u:e.texCoords.u,v:e.texCoords.v}},br:{vertices:{x:a.vertices.x,y:a.vertices.y,z:a.vertices.z},colors:{r:a.colors.r,g:a.colors.g,b:a.colors.b,a:a.colors.a},texCoords:{u:a.texCoords.u,v:a.texCoords.v}}}};cc.V3F_C4B_T2F_QuadsCopy=function(a){if(!a)return[];for(var b=[],d=0;d<a.length;d++)b.push(cc.V3F_C4B_T2F_QuadCopy(a[d]));return b};cc.V2F_C4B_T2F=function(a,b,d,e,f){this._arrayBuffer=
e||new ArrayBuffer(cc.V2F_C4B_T2F.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;f=this._offset;var g=cc.Vertex2F.BYTES_PER_ELEMENT;this._vertices=a?new cc.Vertex2F(a.x,a.y,e,f):new cc.Vertex2F(0,0,e,f);this._colors=b?cc.color(b.r,b.g,b.b,b.a,e,f+g):cc.color(0,0,0,0,e,f+g);this._texCoords=d?new cc.Tex2F(d.u,d.v,e,f+g+cc.Color.BYTES_PER_ELEMENT):new cc.Tex2F(0,0,e,f+g+cc.Color.BYTES_PER_ELEMENT)};cc.V2F_C4B_T2F.BYTES_PER_ELEMENT=20;a=cc.V2F_C4B_T2F.prototype;a._getVertices=function(){return this._vertices};
...
a[c]};cc.FontDefinition.prototype._getCanvasFontStr=function(){return this.fontStyle+" "+this.fontWeight+" "+this.fontSize+"px/"+(this.lineHeight.charAt?this.lineHeight:this.lineHeight+"px")+" '"+this.fontName+"'"};cc._renderType===cc._RENDER_TYPE_WEBGL&&(cc.assert(cc.isFunction(cc._tmp.WebGLColor),cc._LogInfos.MissingFile,"CCTypesWebGL.js"),cc._tmp.WebGLColor(),delete cc._tmp.WebGLColor);cc.assert(cc.isFunction(cc._tmp.PrototypeColor),cc._LogInfos.MissingFile,"CCTypesPropertyDefine.js");cc._tmp.PrototypeColor();
...
_p._registerAccelerometerEvent=function(){var a=window;this._acceleration=new cc.Acceleration;this._accelDeviceEvent=a.DeviceMotionEvent||a.DeviceOrientationEvent;cc.sys.browserType===cc.sys.BROWSER_TYPE_MOBILE_QQ&&(this._accelDeviceEvent=window.DeviceOrientationEvent);var c=this._accelDeviceEvent===a.DeviceMotionEvent?"devicemotion":"deviceorientation",b=navigator.userAgent;if(/Android/.test(b)||/Adr/.test(b)&&cc.sys.browserType===cc.BROWSER_TYPE_UC)this._minus=-1;cc._addEventListener(a,c,this.didAccelerate.bind(this),
!1)};
_p.didAccelerate=function(a){var c=window;if(this._accelEnabled){var b=this._acceleration,d,e,f;this._accelDeviceEvent===window.DeviceMotionEvent?(f=a.accelerationIncludingGravity,d=this._accelMinus*f.x*0.1,e=this._accelMinus*f.y*0.1,f=0.1*f.z):(d=a.gamma/90*0.981,e=0.981*-(a.beta/90),f=a.alpha/90*0.981);cc.sys.os===cc.sys.OS_ANDROID?(b.x=-d,b.y=-e):(b.x=d,b.y=e);b.z=f;b.timestamp=a.timeStamp||Date.now();a=b.x;c.orientation===cc.UIInterfaceOrientationLandscapeRight?(b.x=-b.y,b.y=a):c.orientation===cc.UIInterfaceOrientationLandscapeLeft?
(b.x=b.y,b.y=-a):c.orientation===cc.UIInterfaceOrientationPortraitUpsideDown&&(b.x=-b.x,b.y=-b.y)}};delete _p;cc.AffineTransform=function(a,c,b,d,e,f){this.a=a;this.b=c;this.c=b;this.d=d;this.tx=e;this.ty=f};cc.affineTransformMake=function(a,c,b,d,e,f){return{a:a,b:c,c:b,d:d,tx:e,ty:f}};cc.pointApplyAffineTransform=function(a,c,b){var d;void 0===b?(b=c,d=a.x,a=a.y):(d=a,a=c);return{x:b.a*d+b.c*a+b.tx,y:b.b*d+b.d*a+b.ty}};cc._pointApplyAffineTransform=function(a,c,b){return cc.pointApplyAffineTransform(a,c,b)};
...
cc.pSubIn=function(a,c){a.x-=c.x;a.y-=c.y};cc.pAddIn=function(a,c){a.x+=c.x;a.y+=c.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,c,b,d,e){e+=d;if(!(1>=e)){c*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var p=cc.p(a[2*(h+1)],a[2*(h+1)+1]),n=cc.pNormalize(cc.pSub(p,k)),s=cc.pNormalize(cc.pSub(m,k)),r=Math.acos(cc.pDot(n,s));m=r<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(n,
s))):r<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(n,s)):cc.pPerp(cc.pNormalize(cc.pSub(p,m)))}m=cc.pMult(m,c);b[2*f]=k.x+m.x;b[2*f+1]=k.y+m.y;b[2*(f+1)]=k.x-m.x;b[2*(f+1)+1]=k.y-m.y}for(h=0===d?0:d-1;h<g;h++)f=2*h,a=f+2,c=cc.vertex2(b[2*f],b[2*f+1]),e=cc.vertex2(b[2*(f+1)],b[2*(f+1)+1]),f=cc.vertex2(b[2*a],b[2*a]),d=cc.vertex2(b[2*(a+1)],b[2*(a+1)+1]),c=!cc.vertexLineIntersect(c.x,c.y,d.x,d.y,e.x,e.y,f.x,f.y),!c.isSuccess&&(0>c.value||1<c.value)&&(c.isSuccess=!0),c.isSuccess&&(b[2*a]=d.x,
b[2*a+1]=d.y,b[2*(a+1)]=f.x,b[2*(a+1)+1]=f.y)}};cc.vertexLineIntersect=function(a,c,b,d,e,f,g,h){if(a===b&&c===d||e===g&&f===h)return{isSuccess:!1,value:0};b-=a;d-=c;e-=a;f-=c;g-=a;h-=c;a=Math.sqrt(b*b+d*d);b/=a;d/=a;c=e*b+f*d;f=f*b-e*d;e=c;c=g*b+h*d;h=h*b-g*d;g=c;return f===h?{isSuccess:!1,value:0}:{isSuccess:!0,value:(g+(e-g)*h/(h-f))/a}};cc.vertexListIsClockwise=function(a){for(var c=0,b=a.length;c<b;c++){var d=a[(c+1)%b],e=a[(c+2)%b];if(0<cc.pCross(cc.pSub(d,a[c]),cc.pSub(e,d)))return!1}return!0};cc.CGAffineToGL=function(a,c){c[2]=c[3]=c[6]=c[7]=c[8]=c[9]=c[11]=c[14]=0;c[10]=c[15]=1;c[0]=a.a;c[4]=a.c;c[12]=a.tx;c[1]=a.b;c[5]=a.d;c[13]=a.ty};cc.GLToCGAffine=function(a,c){c.a=a[0];c.c=a[4];c.tx=a[12];c.b=a[1];c.d=a[5];c.ty=a[13]};cc.Touch=cc.Class.extend({_point:null,_prevPoint:null,_id:0,_startPointCaptured:!1,_startPoint:null,ctor:function(a,c,b){this._point=cc.p(a||0,c||0);this._id=b||0},getLocation:function(){return{x:this._point.x,y:this._point.y}},getLocationX:function(){return this._point.x},getLocationY:function(){return this._point.y},getPreviousLocation:function(){return{x:this._prevPoint.x,y:this._prevPoint.y}},getStartLocation:function(){return{x:this._startPoint.x,y:this._startPoint.y}},getDelta:function(){return cc.pSub(this._point,
...
pauseTarget:function(a,c){var b=this._nodeListenersMap[a.__instanceId],d,e;if(b)for(d=0,e=b.length;d<e;d++)b[d]._setPaused(!0);if(!0===c)for(b=a.getChildren(),d=0,e=b.length;d<e;d++)this.pauseTarget(b[d],!0)},resumeTarget:function(a,c){var b=this._nodeListenersMap[a.__instanceId],d,e;if(b)for(d=0,e=b.length;d<e;d++)b[d]._setPaused(!1);this._setDirtyForNode(a);if(!0===c)for(b=a.getChildren(),d=0,e=b.length;d<e;d++)this.resumeTarget(b[d],!0)},_addListener:function(a){0===this._inDispatch?this._forceAddEventListener(a):
...
if(c){var b=[],k;for(k in f)b.push(k);b.sort(this._sortNumberAsc);k=b.length;h=this._nodePriorityMap;for(d=0;d<k;d++)for(e=f[b[d]],g=0;g<e.length;g++)h[e[g]]=++this._nodePriorityIndex;this._globalZOrderNodeMap={}}},_sortNumberAsc:function(a,c){return a-c},addListener:function(a,c){cc.assert(a&&c,cc._LogInfos.eventManager_addListener_2);if(!(a instanceof cc.EventListener))cc.assert(!cc.isNumber(c),cc._LogInfos.eventManager_addListener_3),a=cc.EventListener.create(a);else if(a._isRegistered()){cc.log(cc._LogInfos.eventManager_addListener_4);
return}if(a.checkAvailable()){if(cc.isNumber(c)){if(0===c){cc.log(cc._LogInfos.eventManager_addListener);return}a._setSceneGraphPriority(null);a._setFixedPriority(c);a._setRegistered(!0);a._setPaused(!1)}else a._setSceneGraphPriority(c),a._setFixedPriority(0),a._setRegistered(!0);this._addListener(a);return a}},addCustomListener:function(a,c){var b=new cc._EventListenerCustom(a,c);this.addListener(b,1);return b},removeListener:function(a){if(null!=a){var c,b=this._listenersMap,d;for(d in b){var e=
b[d],f=e.getFixedPriorityListeners();c=e.getSceneGraphPriorityListeners();(c=this._removeListenerInVector(c,a))?this._setDirty(a._getListenerID(),this.DIRTY_SCENE_GRAPH_PRIORITY):(c=this._removeListenerInVector(f,a))&&this._setDirty(a._getListenerID(),this.DIRTY_FIXED_PRIORITY);e.empty()&&(delete this._priorityDirtyFlagMap[a._getListenerID()],delete b[d]);if(c)break}if(!c)for(b=this._toAddedListeners,d=0,e=b.length;d<e;d++)if(f=b[d],f===a){cc.arrayRemoveObject(b,f);f._setRegistered(!1);break}}},_removeListenerInCallback:function(a,
c){if(null==a)return!1;for(var b=0,d=a.length;b<d;b++){var e=a[b];if(e._onCustomEvent===c||e._onEvent===c)return e._setRegistered(!1),null!=e._getSceneGraphPriority()&&(this._dissociateNodeAndEventListener(e._getSceneGraphPriority(),e),e._setSceneGraphPriority(null)),0===this._inDispatch&&cc.arrayRemoveObject(a,e),!0}return!1},_removeListenerInVector:function(a,c){if(null==a)return!1;for(var b=0,d=a.length;b<d;b++){var e=a[b];if(e===c)return e._setRegistered(!1),null!=e._getSceneGraphPriority()&&
(this._dissociateNodeAndEventListener(e._getSceneGraphPriority(),e),e._setSceneGraphPriority(null)),0===this._inDispatch&&cc.arrayRemoveObject(a,e),!0}return!1},removeListeners:function(a,c){if(a instanceof cc.Node){delete this._nodePriorityMap[a.__instanceId];cc.arrayRemoveObject(this._dirtyNodes,a);var b=this._nodeListenersMap[a.__instanceId];if(b){for(var d=cc.copyArray(b),b=0;b<d.length;b++)this.removeListener(d[b]);d.length=0}d=this._toAddedListeners;for(b=0;b<d.length;){var e=d[b];e._getSceneGraphPriority()===
a?(e._setSceneGraphPriority(null),e._setRegistered(!1),d.splice(b,1)):++b}if(!0===c)for(d=a.getChildren(),b=0,e=d.length;b<e;b++)this.removeListeners(d[b],!0)}else a===cc.EventListener.TOUCH_ONE_BY_ONE?this._removeListenersForListenerID(cc._EventListenerTouchOneByOne.LISTENER_ID):a===cc.EventListener.TOUCH_ALL_AT_ONCE?this._removeListenersForListenerID(cc._EventListenerTouchAllAtOnce.LISTENER_ID):a===cc.EventListener.MOUSE?this._removeListenersForListenerID(cc._EventListenerMouse.LISTENER_ID):a===
cc.EventListener.ACCELERATION?this._removeListenersForListenerID(cc._EventListenerAcceleration.LISTENER_ID):a===cc.EventListener.KEYBOARD?this._removeListenersForListenerID(cc._EventListenerKeyboard.LISTENER_ID):cc.log(cc._LogInfos.eventManager_removeListeners)},removeCustomListeners:function(a){this._removeListenersForListenerID(a)},removeAllListeners:function(){var a=this._listenersMap,c=this._internalCustomListenerIDs,b;for(b in a)-1===c.indexOf(b)&&this._removeListenersForListenerID(b)},setPriority:function(a,
c){if(null!=a){var b=this._listenersMap,d;for(d in b){var e=b[d].getFixedPriorityListeners();if(e&&-1!==e.indexOf(a)){null!=a._getSceneGraphPriority()&&cc.log(cc._LogInfos.eventManager_setPriority);a._getFixedPriority()!==c&&(a._setFixedPriority(c),this._setDirty(a._getListenerID(),this.DIRTY_FIXED_PRIORITY));break}}}},setEnabled:function(a){this._isEnabled=a},isEnabled:function(){return this._isEnabled},dispatchEvent:function(a){if(this._isEnabled){this._updateDirtyFlagForSceneGraph();this._inDispatch++;
if(!a||!a.getType)throw Error("event is undefined");if(a.getType()===cc.Event.TOUCH)this._dispatchTouchEvent(a);else{var c=cc.__getListenerID(a);this._sortEventListeners(c);c=this._listenersMap[c];null!=c&&this._dispatchEventToListeners(c,this._onListenerCallback,a);this._updateListeners(a)}this._inDispatch--}},_onListenerCallback:function(a,c){c._setCurrentTarget(a._getSceneGraphPriority());a._onEvent(c);return c.isStopped()},dispatchCustomEvent:function(a,c){var b=new cc.EventCustom(a);b.setUserData(c);
this.dispatchEvent(b)}};cc.EventHelper=function(){};
...
this._listeners){null==c&&(c=!0);var b=this._listeners[a];if(void 0!==b){for(var d=[],e=b.length,f=0;f<e;f++)d[f]=b[f];for(f=0;f<e;f++)d[f].callback.call(d[f].eventTarget,this);c&&(b.length=0)}}}};cc.EventAcceleration=cc.Event.extend({_acc:null,ctor:function(a){cc.Event.prototype.ctor.call(this,cc.Event.ACCELERATION);this._acc=a}});cc.EventKeyboard=cc.Event.extend({_keyCode:0,_isPressed:!1,ctor:function(a,c){cc.Event.prototype.ctor.call(this,cc.Event.KEYBOARD);this._keyCode=a;this._isPressed=c}});
...
this.onKeyPressed&&null===this.onKeyReleased?(cc.log(cc._LogInfos._EventListenerKeyboard_checkAvailable),!1):!0}});cc._EventListenerKeyboard.LISTENER_ID="__cc_keyboard";cc._EventListenerKeyboard.create=function(){return new cc._EventListenerKeyboard};cc.rendererCanvas={childrenOrderDirty:!0,_transformNodePool:[],_renderCmds:[],_isCacheToCanvasOn:!1,_cacheToCanvasCmds:{},_cacheInstanceIds:[],_currentID:0,_clearColor:cc.color(),_clearFillStyle:"rgb(0, 0, 0)",getRenderCmd:function(a){return a._createRenderCmd()},rendering:function(a){var c=this._renderCmds,b,d=cc.view.getScaleX(),e=cc.view.getScaleY(),f=a||cc._renderContext;f.computeRealOffsetY();a=0;for(b=c.length;a<b;a++)c[a].rendering(f,d,e)},_renderingToCacheCanvas:function(a,c,b,d){a||cc.log("The context of RenderTexture is invalid.");
b=cc.isUndefined(b)?1:b;d=cc.isUndefined(d)?1:d;c=c||this._currentID;var e=this._cacheToCanvasCmds[c],f,g;a.computeRealOffsetY();f=0;for(g=e.length;f<g;f++)e[f].rendering(a,b,d);e.length=0;a=this._cacheInstanceIds;delete this._cacheToCanvasCmds[c];cc.arrayRemoveObject(a,c);0===a.length?this._isCacheToCanvasOn=!1:this._currentID=a[a.length-1]},_turnToCacheMode:function(a){this._isCacheToCanvasOn=!0;a=a||0;this._cacheToCanvasCmds[a]=[];-1===this._cacheInstanceIds.indexOf(a)&&this._cacheInstanceIds.push(a);
...
clear:function(){var a=cc._canvas,c=cc._renderContext.getContext(),b=cc._renderContext;c.setTransform(1,0,0,1,0,0);255!==this._clearColor.a&&c.clearRect(0,0,a.width,a.height);b.setFillStyle(this._clearFillStyle);b.setGlobalAlpha(this._clearColor.a);c.fillRect(0,0,a.width,a.height)},clearRenderCommands:function(){this._renderCmds.length=0},pushRenderCommand:function(a){if(a._needDraw)if(this._isCacheToCanvasOn){var c=this._cacheToCanvasCmds[this._currentID];-1===c.indexOf(a)&&c.push(a)}else-1===this._renderCmds.indexOf(a)&&
...
this._context.setTransform(b.a,b.c,b.b,b.d,this._offsetX+b.tx*d,this._realOffsetY-b.ty*e),this.save()):(this._armatureMode--,this.restore())}})();cc.rendererWebGL={childrenOrderDirty:!0,_transformNodePool:[],_renderCmds:[],_isCacheToBufferOn:!1,_cacheToBufferCmds:{},_cacheInstanceIds:[],_currentID:0,_clearColor:cc.color(),getRenderCmd:function(a){return a._createRenderCmd()},rendering:function(a){var c=this._renderCmds,b,d=a||cc._renderContext;a=0;for(b=c.length;a<b;a++)c[a].rendering(d)},_turnToCacheMode:function(a){this._isCacheToBufferOn=!0;a=a||0;this._cacheToBufferCmds[a]=[];this._cacheInstanceIds.push(a);this._currentID=a},_turnToNormalMode:function(){this._isCacheToBufferOn=
...
a.blendFunc(a.SRC_ALPHA,a.DST_ALPHA)},pushRenderCommand:function(a){if(a._needDraw)if(this._isCacheToBufferOn){var c=this._cacheToBufferCmds[this._currentID];-1===c.indexOf(a)&&c.push(a)}else-1===this._renderCmds.indexOf(a)&&this._renderCmds.push(a)}};cc._renderType===cc._RENDER_TYPE_WEBGL&&(cc.renderer=cc.rendererWebGL);cc._tmp.PrototypeCCNode=function(){var a=cc.Node.prototype;cc.defineGetterSetter(a,"x",a.getPositionX,a.setPositionX);cc.defineGetterSetter(a,"y",a.getPositionY,a.setPositionY);cc.defineGetterSetter(a,"width",a._getWidth,a._setWidth);cc.defineGetterSetter(a,"height",a._getHeight,a._setHeight);cc.defineGetterSetter(a,"anchorX",a._getAnchorX,a._setAnchorX);cc.defineGetterSetter(a,"anchorY",a._getAnchorY,a._setAnchorY);cc.defineGetterSetter(a,"skewX",a.getSkewX,a.setSkewX);cc.defineGetterSetter(a,"skewY",
...
a&&(a=(a=c._parent)&&a._cascadeColorEnabled?a.getDisplayedColor():cc.color.WHITE),b.r=0|d.r*a.r/255,b.g=0|d.g*a.g/255,b.b=0|d.b*a.b/255,c._cascadeColorEnabled)for(a=c._children,c=0,d=a.length;c<d;c++)(e=a[c])&&e._renderCmd&&(e._renderCmd._updateDisplayColor(b),e._renderCmd._updateColor());this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.colorDirty},_updateDisplayOpacity:function(a){var c=this._node,b,d;if(this._cascadeOpacityEnabledDirty&&!c._cascadeOpacityEnabled){this._displayedOpacity=c._realOpacity;
b=c._children;a=0;for(c=b.length;a<c;a++)(d=b[a])&&d._renderCmd&&d._renderCmd._updateDisplayOpacity(255);this._cascadeOpacityEnabledDirty=!1}else if(void 0===a&&(b=c._parent,a=255,b&&b._cascadeOpacityEnabled&&(a=b.getDisplayedOpacity())),this._displayedOpacity=c._realOpacity*a/255,c._cascadeOpacityEnabled)for(b=c._children,a=0,c=b.length;a<c;a++)(d=b[a])&&d._renderCmd&&(d._renderCmd._updateDisplayOpacity(this._displayedOpacity),d._renderCmd._updateColor());this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.opacityDirty},
...
f.ty+f.b*d.tx}else e.a=d.a,e.b=d.b,e.c=d.c,e.d=d.d,e.tx=d.tx,e.ty=d.ty;if(b&&(d=this._node._children)&&0!==d.length)for(e=0,f=d.length;e<f;e++)d[e]._renderCmd.transform(this,b)};a.getNodeToParentTransform=function(){var a=this._node,b=!1;a._usingNormalizedPosition&&a._parent&&(b=a._parent._contentSize,a._position.x=a._normalizedPosition.x*b.width,a._position.y=a._normalizedPosition.y*b.height,a._normalizedPositionDirty=!1,b=!0);if(b||this._dirtyFlag&cc.Node._dirtyFlags.transformDirty){b=this._transform;
b.tx=a._position.x;b.ty=a._position.y;var d=1,e=0,f=0,g=1;a._rotationX&&(g=0.017453292519943295*a._rotationX,f=Math.sin(g),g=Math.cos(g));a._rotationY&&(e=0.017453292519943295*a._rotationY,d=Math.cos(e),e=-Math.sin(e));b.a=d;b.b=e;b.c=f;b.d=g;var h=a._scaleX,k=a._scaleY,m=this._anchorPointInPoints.x,p=this._anchorPointInPoints.y,n=1E-6>h&&-1E-6<h?1E-6:h,s=1E-6>k&&-1E-6<k?1E-6:k;if(1!==h||1!==k)d=b.a*=n,e=b.b*=n,f=b.c*=s,g=b.d*=s;if(a._skewX||a._skewY)h=Math.tan(-a._skewX*Math.PI/180),k=Math.tan(-a._skewY*
Math.PI/180),Infinity===h&&(h=99999999),Infinity===k&&(k=99999999),n=p*h,s=m*k,b.a=d-f*k,b.b=e-g*k,b.c=f-d*h,b.d=g-e*h,b.tx+=d*n+f*s,b.ty+=e*n+g*s;b.tx-=d*m+f*p;b.ty-=e*m+g*p;a._ignoreAnchorPointForPosition&&(b.tx+=m,b.ty+=p);a._additionalTransformDirty&&(this._transform=cc.affineTransformConcat(b,a._additionalTransform))}return this._transform};a.visit=function(a){var b=this._node;if(b._visible){if(a=a||this.getParentRenderCmd())this._curLevel=a._curLevel+1;var d=b._children,e;this._syncStatus(a);
...
function(a){return a?a.src===cc.SRC_ALPHA&&a.dst===cc.ONE||a.src===cc.ONE&&a.dst===cc.ONE?"lighter":a.src===cc.ZERO&&a.dst===cc.SRC_ALPHA?"destination-in":a.src===cc.ZERO&&a.dst===cc.ONE_MINUS_SRC_ALPHA?"destination-out":"source-over":"source-over"}})();(function(){cc.Node.WebGLRenderCmd=function(a){cc.Node.RenderCmd.call(this,a);a=new cc.math.Matrix4;var b=a.mat;b[2]=b[3]=b[6]=b[7]=b[8]=b[9]=b[11]=b[14]=0;b[10]=b[15]=1;this._transform4x4=a;this._stackMatrix=new cc.math.Matrix4;this._camera=this._shaderProgram=null};var a=cc.Node.WebGLRenderCmd.prototype=Object.create(cc.Node.RenderCmd.prototype);a.constructor=cc.Node.WebGLRenderCmd;a.getNodeToParentTransform=function(){var a=this._node;if(a._usingNormalizedPosition&&a._parent){var b=a._parent._contentSize;
a._position.x=a._normalizedPosition.x*b.width;a._position.y=a._normalizedPosition.y*b.height;a._normalizedPositionDirty=!1}if(this._dirtyFlag&cc.Node._dirtyFlags.transformDirty){var b=a._position.x,d=a._position.y,e=this._anchorPointInPoints.x,f=-e,g=this._anchorPointInPoints.y,h=-g,k=a._scaleX,m=a._scaleY,p=0.017453292519943295*a._rotationX,n=0.017453292519943295*a._rotationY;a._ignoreAnchorPointForPosition&&(b+=e,d+=g);var s=1,r=0,t=1,q=0;if(0!==a._rotationX||0!==a._rotationY)s=Math.cos(-p),r=Math.sin(-p),
t=Math.cos(-n),q=Math.sin(-n);p=a._skewX||a._skewY;p||0===e&&0===g||(b+=t*f*k+-r*h*m,d+=q*f*k+s*h*m);n=this._transform;n.a=t*k;n.b=q*k;n.c=-r*m;n.d=s*m;n.tx=b;n.ty=d;p&&(n=cc.affineTransformConcat({a:1,b:Math.tan(cc.degreesToRadians(a._skewY)),c:Math.tan(cc.degreesToRadians(a._skewX)),d:1,tx:0,ty:0},n),0!==e||0!==g)&&(n=cc.affineTransformTranslate(n,f,h));a._additionalTransformDirty&&(n=cc.affineTransformConcat(n,a._additionalTransform),a._additionalTransformDirty=!1);this._transform=n}return this._transform};
a._syncStatus=function(a){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,e=a?a._node:null;e&&e._cascadeColorEnabled&&a._dirtyFlag&b.colorDirty&&(d|=b.colorDirty);e&&e._cascadeOpacityEnabled&&a._dirtyFlag&b.opacityDirty&&(d|=b.opacityDirty);a&&a._dirtyFlag&b.transformDirty&&(d|=b.transformDirty);e=d&b.colorDirty;b=d&b.opacityDirty;this._dirtyFlag=d;e&&this._syncDisplayColor();b&&this._syncDisplayOpacity();(e||b)&&this._updateColor();this.transform(a)};a._updateColor=function(){};a.visit=function(a){var b=
this._node;if(b._visible){a=a||this.getParentRenderCmd();b._parent&&b._parent._renderCmd&&(this._curLevel=b._parent._renderCmd._curLevel+1);var d=cc.current_stack;d.stack.push(d.top);this._syncStatus(a);d.top=this._stackMatrix;if((a=b._children)&&0<a.length){var e=a.length;b.sortAllChildren();for(b=0;b<e;b++)if(a[b]&&0>a[b]._localZOrder)a[b]._renderCmd.visit(this);else break;for(cc.renderer.pushRenderCommand(this);b<e;b++)a[b]&&a[b]._renderCmd.visit(this)}else cc.renderer.pushRenderCommand(this);
this._dirtyFlag=0;d.top=d.stack.pop()}};a.transform=function(a,b){var d=this._transform4x4,e=this._stackMatrix,f=this._node,g=(a=a||this.getParentRenderCmd())?a._stackMatrix:cc.current_stack.top,h=this.getNodeToParentTransform();this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.transformDirty;var k=d.mat;k[0]=h.a;k[4]=h.c;k[12]=h.tx;k[1]=h.b;k[5]=h.d;k[13]=h.ty;k[14]=f._vertexZ;cc.kmMat4Multiply(e,g,d);null===f._camera||null!==f.grid&&f.grid.isActive()||(g=this._anchorPointInPoints.x,h=this._anchorPointInPoints.y,
0!==g||0!==h?(cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(g|=0,h|=0),k=cc.math.Matrix4.createByTranslation(g,h,0,d),e.multiply(k),f._camera._locateForRenderer(e),k=cc.math.Matrix4.createByTranslation(-g,-h,0,k),e.multiply(k),d.identity()):f._camera._locateForRenderer(e));if(b&&f._children&&0!==f._children.length)for(f=f._children,d=0,e=f.length;d<e;d++)f[d]._renderCmd.transform(this,b)};a.setShaderProgram=function(a){this._shaderProgram=a};a.getShaderProgram=function(){return this._shaderProgram}})();cc.AtlasNode=cc.Node.extend({textureAtlas:null,quadsToDraw:0,_itemsPerRow:0,_itemsPerColumn:0,_itemWidth:0,_itemHeight:0,_opacityModifyRGB:!1,_blendFunc:null,_ignoreContentScaleFactor:!1,_className:"AtlasNode",_textureForCanvas:null,ctor:function(a,c,b,d){cc.Node.prototype.ctor.call(this);this._blendFunc={src:cc.BLEND_SRC,dst:cc.BLEND_DST};this._ignoreContentScaleFactor=!1;void 0!==d&&this.initWithTileFile(a,c,b,d)},_createRenderCmd:function(){this._renderCmd=cc._renderType===cc._RENDER_TYPE_CANVAS?
...
cc.EventHelper.prototype.apply(_p);cc.AtlasNode.create=function(a,c,b,d){return new cc.AtlasNode(a,c,b,d)};(function(){cc.AtlasNode.CanvasRenderCmd=function(a){cc.Node.CanvasRenderCmd.call(this,a);this._needDraw=!1;this._colorUnmodified=cc.color.WHITE;this._texture=this._originalTexture=null};var a=cc.AtlasNode.CanvasRenderCmd.prototype=Object.create(cc.Node.CanvasRenderCmd.prototype);a.constructor=cc.AtlasNode.CanvasRenderCmd;a.initWithTexture=function(a,b,d,e){var f=this._node;f._itemWidth=b;f._itemHeight=d;f._opacityModifyRGB=!0;this._originalTexture=a;if(!this._originalTexture)return cc.log(cc._LogInfos.AtlasNode__initWithTexture),
!1;this._texture=this._originalTexture;this._calculateMaxItems();f.quadsToDraw=e;return!0};a.setColor=function(a){var b=this._node._realColor;if(b.r!==a.r||b.g!==a.g||b.b!==a.b)this._colorUnmodified=a,this._changeTextureColor()};a._changeTextureColor=cc.sys._supportCanvasNewBlendModes?function(){var a=this._node,b=a.getTexture();if(b&&this._originalTexture){var d=this._originalTexture.getHtmlElementObj();if(d){var e=b.getHtmlElementObj(),b=cc.rect(0,0,d.width,d.height);e instanceof HTMLCanvasElement?
cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply(d,this._colorUnmodified,b,e):(e=cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply(d,this._colorUnmodified,b),b=new cc.Texture2D,b.initWithElement(e),b.handleLoadedTexture(),a.setTexture(b))}}}:function(){var a=this._node,b,d=a.getTexture();if(d&&this._originalTexture&&(b=d.getHtmlElementObj())){var e=this._originalTexture.getHtmlElementObj();if(d=cc.textureCache.getTextureColors(e))e=cc.rect(0,0,e.width,e.height),b instanceof HTMLCanvasElement?
cc.Sprite.CanvasRenderCmd._generateTintImage(b,d,this._displayedColor,e,b):(b=cc.Sprite.CanvasRenderCmd._generateTintImage(b,d,this._displayedColor,e),d=new cc.Texture2D,d.initWithElement(b),d.handleLoadedTexture(),a.setTexture(d))}};a.setOpacity=function(a){cc.Node.prototype.setOpacity.call(this._node,a)};a.getTexture=function(){return this._texture};a.setTexture=function(a){this._texture=a};a._calculateMaxItems=function(){var a=this._node,b=this._texture.getContentSize();a._itemsPerColumn=0|b.height/
a._itemHeight;a._itemsPerRow=0|b.width/a._itemWidth}})();(function(){cc.AtlasNode.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a);this._needDraw=!0;this._textureAtlas=null;this._colorUnmodified=cc.color.WHITE;this._uniformColor=this._colorF32Array=null;this._shaderProgram=cc.shaderCache.programForKey(cc.SHADER_POSITION_TEXTURE_UCOLOR);this._uniformColor=cc._renderContext.getUniformLocation(this._shaderProgram.getProgram(),"u_color")};var a=cc.AtlasNode.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);a.constructor=
...
b._blendFunc.dst);this._uniformColor&&this._colorF32Array&&(a.uniform4fv(this._uniformColor,this._colorF32Array),this._textureAtlas.drawNumberOfQuads(b.quadsToDraw,0))};a.initWithTexture=function(a,b,d,e){var f=this._node;f._itemWidth=b;f._itemHeight=d;this._colorUnmodified=cc.color.WHITE;f._opacityModifyRGB=!0;f._blendFunc.src=cc.BLEND_SRC;f._blendFunc.dst=cc.BLEND_DST;b=f._realColor;this._colorF32Array=new Float32Array([b.r/255,b.g/255,b.b/255,f._realOpacity/255]);this._textureAtlas=new cc.TextureAtlas;
this._textureAtlas.initWithTexture(a,e);if(!this._textureAtlas)return cc.log(cc._LogInfos.AtlasNode__initWithTexture),!1;this._updateBlendFunc();this._updateOpacityModifyRGB();this._calculateMaxItems();f.quadsToDraw=e;return!0};a.setColor=function(a){var b=cc.color(a.r,a.g,a.b),d=this._node;this._colorUnmodified=a;a=this._displayedOpacity;d._opacityModifyRGB&&(b.r=b.r*a/255,b.g=b.g*a/255,b.b=b.b*a/255);cc.Node.prototype.setColor.call(d,b)};a.setOpacity=function(a){var b=this._node;cc.Node.prototype.setOpacity.call(b,
a);b._opacityModifyRGB&&(b.color=this._colorUnmodified)};a._updateColor=function(){var a=this._displayedColor;this._colorF32Array=new Float32Array([a.r/255,a.g/255,a.b/255,this._displayedOpacity/255])};a.getTexture=function(){return this._textureAtlas.texture};a.setTexture=function(a){this._textureAtlas.texture=a;this._updateBlendFunc();this._updateOpacityModifyRGB()};a._calculateMaxItems=function(){var a=this._node,b=this._textureAtlas.texture,d=b.getContentSize();a._ignoreContentScaleFactor&&(d=
b.getContentSizeInPixels());a._itemsPerColumn=0|d.height/a._itemHeight;a._itemsPerRow=0|d.width/a._itemWidth}})();cc._tmp.WebGLTexture2D=function(){cc.Texture2D=cc.Class.extend({_pVRHaveAlphaPremultiplied:!0,_pixelFormat:null,_pixelsWide:0,_pixelsHigh:0,_name:"",_contentSize:null,maxS:0,maxT:0,_hasPremultipliedAlpha:!1,_hasMipmaps:!1,shaderProgram:null,_textureLoaded:!1,_htmlElementObj:null,_webTextureObj:null,url:null,ctor:function(){this._contentSize=cc.size(0,0);this._pixelFormat=cc.Texture2D.defaultPixelFormat},releaseTexture:function(){this._webTextureObj&&cc._renderContext.deleteTexture(this._webTextureObj);
...
this._contentSize.width=this._htmlElementObj.width,this._pixelsHigh=this._contentSize.height=c,this._pixelFormat=cc.Texture2D.PIXEL_FORMAT_RGBA8888,this.maxT=this.maxS=1,this._hasPremultipliedAlpha=a,this._hasMipmaps=!1,this.dispatchEvent("load"))}},initWithString:function(a,c,b,d,e,f){cc.log(cc._LogInfos.Texture2D_initWithString);return null},initWithETCFile:function(a){cc.log(cc._LogInfos.Texture2D_initWithETCFile_2);return!1},initWithPVRFile:function(a){cc.log(cc._LogInfos.Texture2D_initWithPVRFile_2);
return!1},initWithPVRTCData:function(a,c,b,d,e,f){cc.log(cc._LogInfos.Texture2D_initWithPVRTCData_2);return!1},setTexParameters:function(a,c,b,d){var e=cc._renderContext;void 0!==c&&(a={minFilter:a,magFilter:c,wrapS:b,wrapT:d});cc.assert(this._pixelsWide===cc.NextPOT(this._pixelsWide)&&this._pixelsHigh===cc.NextPOT(this._pixelsHigh)||a.wrapS===e.CLAMP_TO_EDGE&&a.wrapT===e.CLAMP_TO_EDGE,"WebGLRenderingContext.CLAMP_TO_EDGE should be used in NPOT textures");cc.glBindTexture2D(this);e.texParameteri(e.TEXTURE_2D,
...
cc._renderContext.generateMipmap(cc._renderContext.TEXTURE_2D);this._hasMipmaps=!0},stringForFormat:function(){return cc.Texture2D._M[this._pixelFormat]},bitsPerPixelForFormat:function(a){a=a||this._pixelFormat;var c=cc.Texture2D._B[a];if(null!=c)return c;cc.log(cc._LogInfos.Texture2D_bitsPerPixelForFormat,a);return-1},_initPremultipliedATextureWithImage:function(a,c,b){var d=cc.Texture2D,e=a.getData(),f=null,f=null,g=a.hasAlpha(),h=cc.size(a.getWidth(),a.getHeight()),k=d.defaultPixelFormat,m=a.getBitsPerComponent();
g||(8<=m?k=d.PIXEL_FORMAT_RGB888:(cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),k=d.PIXEL_FORMAT_RGB565));var p=c*b;if(k===d.PIXEL_FORMAT_RGB565)if(g)for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>2<<5|(f[m]>>16&255)>>3<<0;else for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]&255)>>3<<11|(f[m]&255)>>2<<5|(f[m]&255)>>3<<0;else if(k===d.PIXEL_FORMAT_RGBA4444)for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]>>
0&255)>>4<<12|(f[m]>>8&255)>>4<<8|(f[m]>>16&255)>>4<<4|(f[m]>>24&255)>>4<<0;else if(k===d.PIXEL_FORMAT_RGB5A1)for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>3<<6|(f[m]>>16&255)>>3<<1|(f[m]>>24&255)>>7<<0;else if(k===d.PIXEL_FORMAT_A8)for(e=new Uint8Array(c*b),f=a.getData(),m=0;m<p;++m)e[m]=f>>24&255;if(g&&k===d.PIXEL_FORMAT_RGB888)for(f=a.getData(),e=new Uint8Array(c*b*3),m=0;m<p;++m)e[3*m]=f>>0&255,e[3*m+1]=f>>8&255,e[3*m+2]=f>>16&255;this.initWithData(e,
k,c,b,h);a.getData();this._hasPremultipliedAlpha=a.isPremultipliedAlpha();return!0},addLoadedEventListener:function(a,c){this.addEventListener("load",a,c)},removeLoadedEventListener:function(a){this.removeEventListener("load",a)}})};
...
cc._tmp.WebGLTextureCache=function(){var a=cc.textureCache;a.handleLoadedTexture=function(a){var b=this._textures,d;cc._rendererInitialized||(b=this._loadedTexturesBefore);d=b[a];d||(d=b[a]=new cc.Texture2D,d.url=a);".png"===cc.path.extname(a)?d.handleLoadedTexture(!0):d.handleLoadedTexture()};a.addImage=function(a,b,d){cc.assert(a,cc._LogInfos.Texture2D_addImage_2);var e=this._textures;cc._rendererInitialized||(e=this._loadedTexturesBefore);var f=e[a]||e[cc.loader._aliases[a]];if(f)return f.isLoaded()?
b&&b.call(d,f):f.addEventListener("load",function(){b&&b.call(d,f)},d),f;f=e[a]=new cc.Texture2D;f.url=a;(cc.loader._checkIsImageURL(a)?cc.loader.load:cc.loader.loadImg).call(cc.loader,a,function(f,h){if(f)return b&&b.call(d,f);cc.textureCache.handleLoadedTexture(a);var k=e[a];b&&b.call(d,k)});return f};a.addImageAsync=a.addImage;a=null};cc._tmp.PrototypeTexture2D=function(){var a=cc.Texture2D;a.PVRImagesHavePremultipliedAlpha=function(a){cc.PVRHaveAlphaPremultiplied_=a};a.PIXEL_FORMAT_RGBA8888=2;a.PIXEL_FORMAT_RGB888=3;a.PIXEL_FORMAT_RGB565=4;a.PIXEL_FORMAT_A8=5;a.PIXEL_FORMAT_I8=6;a.PIXEL_FORMAT_AI88=7;a.PIXEL_FORMAT_RGBA4444=8;a.PIXEL_FORMAT_RGB5A1=7;a.PIXEL_FORMAT_PVRTC4=9;a.PIXEL_FORMAT_PVRTC2=10;a.PIXEL_FORMAT_DEFAULT=a.PIXEL_FORMAT_RGBA8888;a.defaultPixelFormat=a.PIXEL_FORMAT_DEFAULT;var c=cc.Texture2D._M={};c[a.PIXEL_FORMAT_RGBA8888]=
...
0,c=0,b=this._textures,d;for(d in b){var e=b[d];a++;e.getHtmlElementObj()instanceof HTMLImageElement?cc.log(cc._LogInfos.textureCache_dumpCachedTextureInfo,d,e.getHtmlElementObj().src,e.pixelsWidth,e.pixelsHeight):cc.log(cc._LogInfos.textureCache_dumpCachedTextureInfo_2,d,e.pixelsWidth,e.pixelsHeight);c+=e.pixelsWidth*e.pixelsHeight*4}b=this._textureColorsCache;for(d in b){var e=b[d],f;for(f in e){var g=e[f];a++;cc.log(cc._LogInfos.textureCache_dumpCachedTextureInfo_2,d,g.width,g.height);c+=g.width*
g.height*4}}cc.log(cc._LogInfos.textureCache_dumpCachedTextureInfo_3,a,c/1024,(c/1048576).toFixed(2))},_clear:function(){this._textures={};this._textureColorsCache={};this._textureKeySeq=0|1E3*Math.random();this._loadedTexturesBefore={}}};
cc._renderType===cc._RENDER_TYPE_CANVAS?(_p=cc.textureCache,_p.handleLoadedTexture=function(a){var c=this._textures,b=c[a];b||(b=c[a]=new cc.Texture2D,b.url=a);b.handleLoadedTexture()},_p.addImage=function(a,c,b){cc.assert(a,cc._LogInfos.Texture2D_addImage);var d=this._textures,e=d[a]||d[cc.loader._aliases[a]];if(e)return e.isLoaded()?c&&c.call(b,e):e.addEventListener("load",function(){c&&c.call(b,e)},b),e;e=d[a]=new cc.Texture2D;e.url=a;(cc.loader._checkIsImageURL(a)?cc.loader.load:cc.loader.loadImg).call(cc.loader,
a,function(e,g){if(e)return c&&c.call(b,e);cc.textureCache.handleLoadedTexture(a);var h=d[a];c&&c.call(b,h)});return e},_p.addImageAsync=_p.addImage,_p=null):(cc.assert(cc.isFunction(cc._tmp.WebGLTextureCache),cc._LogInfos.MissingFile,"TexturesWebGL.js"),cc._tmp.WebGLTextureCache(),delete cc._tmp.WebGLTextureCache);cc.TextureAtlas=cc.Class.extend({dirty:!1,texture:null,_indices:null,_buffersVBO:null,_capacity:0,_quads:null,_quadsArrayBuffer:null,_quadsWebBuffer:null,_quadsReader:null,ctor:function(a,c){this._buffersVBO=[];cc.isString(a)?this.initWithFile(a,c):a instanceof cc.Texture2D&&this.initWithTexture(a,c)},getTotalQuads:function(){return this._totalQuads},getCapacity:function(){return this._capacity},getTexture:function(){return this.texture},setTexture:function(a){this.texture=a},setDirty:function(a){this.dirty=
a},isDirty:function(){return this.dirty},getQuads:function(){return this._quads},setQuads:function(a){this._quads=a},_copyQuadsToTextureAtlas:function(a,c){if(a)for(var b=0;b<a.length;b++)this._setQuadToArray(a[b],c+b)},_setQuadToArray:function(a,c){var b=this._quads;b[c]?(b[c].bl=a.bl,b[c].br=a.br,b[c].tl=a.tl,b[c].tr=a.tr):b[c]=new cc.V3F_C4B_T2F_Quad(a.tl,a.bl,a.tr,a.br,this._quadsArrayBuffer,c*cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT)},description:function(){return"\x3ccc.TextureAtlas | totalQuads \x3d"+
this._totalQuads+"\x3e"},_setupIndices:function(){if(0!==this._capacity)for(var a=this._indices,c=this._capacity,b=0;b<c;b++)cc.TEXTURE_ATLAS_USE_TRIANGLE_STRIP?(a[6*b+0]=4*b+0,a[6*b+1]=4*b+0,a[6*b+2]=4*b+2,a[6*b+3]=4*b+1,a[6*b+4]=4*b+3,a[6*b+5]=4*b+3):(a[6*b+0]=4*b+0,a[6*b+1]=4*b+1,a[6*b+2]=4*b+2,a[6*b+3]=4*b+3,a[6*b+4]=4*b+2,a[6*b+5]=4*b+1)},_setupVBO:function(){var a=cc._renderContext;this._buffersVBO[0]=a.createBuffer();this._buffersVBO[1]=a.createBuffer();this._quadsWebBuffer=a.createBuffer();
this._mapBuffers()},_mapBuffers:function(){var a=cc._renderContext;a.bindBuffer(a.ARRAY_BUFFER,this._quadsWebBuffer);a.bufferData(a.ARRAY_BUFFER,this._quadsArrayBuffer,a.DYNAMIC_DRAW);a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,this._buffersVBO[1]);a.bufferData(a.ELEMENT_ARRAY_BUFFER,this._indices,a.STATIC_DRAW)},initWithFile:function(a,c){var b=cc.textureCache.addImage(a);if(b)return this.initWithTexture(b,c);cc.log(cc._LogInfos.TextureAtlas_initWithFile,a);return!1},initWithTexture:function(a,c){cc.assert(a,
cc._LogInfos.TextureAtlas_initWithTexture);this._capacity=c|=0;this._totalQuads=0;this.texture=a;this._quads=[];this._indices=new Uint16Array(6*c);var b=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT;this._quadsArrayBuffer=new ArrayBuffer(b*c);this._quadsReader=new Uint8Array(this._quadsArrayBuffer);if((!this._quads||!this._indices)&&0<c)return!1;for(var d=this._quads,e=0;e<c;e++)d[e]=new cc.V3F_C4B_T2F_Quad(null,null,null,null,this._quadsArrayBuffer,e*b);this._setupIndices();this._setupVBO();return this.dirty=
!0},updateQuad:function(a,c){cc.assert(a,cc._LogInfos.TextureAtlas_updateQuad);cc.assert(0<=c&&c<this._capacity,cc._LogInfos.TextureAtlas_updateQuad_2);this._totalQuads=Math.max(c+1,this._totalQuads);this._setQuadToArray(a,c);this.dirty=!0},insertQuad:function(a,c){cc.assert(c<this._capacity,cc._LogInfos.TextureAtlas_insertQuad_2);this._totalQuads++;if(this._totalQuads>this._capacity)cc.log(cc._LogInfos.TextureAtlas_insertQuad);else{var b=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,d=c*b,e=(this._totalQuads-
1-c)*b;this._quads[this._totalQuads-1]=new cc.V3F_C4B_T2F_Quad(null,null,null,null,this._quadsArrayBuffer,(this._totalQuads-1)*b);this._quadsReader.set(this._quadsReader.subarray(d,d+e),d+b);this._setQuadToArray(a,c);this.dirty=!0}},insertQuads:function(a,c,b){b=b||a.length;cc.assert(c+b<=this._capacity,cc._LogInfos.TextureAtlas_insertQuads);var d=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT;this._totalQuads+=b;if(this._totalQuads>this._capacity)cc.log(cc._LogInfos.TextureAtlas_insertQuad);else{var e=c*
d,f=(this._totalQuads-1-c-b)*d,g=this._totalQuads-1-b,h;for(h=0;h<b;h++)this._quads[g+h]=new cc.V3F_C4B_T2F_Quad(null,null,null,null,this._quadsArrayBuffer,(this._totalQuads-1)*d);this._quadsReader.set(this._quadsReader.subarray(e,e+f),e+d*b);for(h=0;h<b;h++)this._setQuadToArray(a[h],c+h);this.dirty=!0}},insertQuadFromIndex:function(a,c){if(a!==c){cc.assert(0<=c||c<this._totalQuads,cc._LogInfos.TextureAtlas_insertQuadFromIndex);cc.assert(0<=a||a<this._totalQuads,cc._LogInfos.TextureAtlas_insertQuadFromIndex_2);
var b=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,d=this._quadsReader,e=d.subarray(a*b,b),f;a>c?(f=c*b,d.set(d.subarray(f,f+(a-c)*b),f+b),d.set(e,f)):(f=(a+1)*b,d.set(d.subarray(f,f+(c-a)*b),f-b),d.set(e,c*b));this.dirty=!0}},removeQuadAtIndex:function(a){cc.assert(a<this._totalQuads,cc._LogInfos.TextureAtlas_removeQuadAtIndex);var c=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT;this._totalQuads--;this._quads.length=this._totalQuads;if(a!==this._totalQuads){var b=(a+1)*c;this._quadsReader.set(this._quadsReader.subarray(b,
b+(this._totalQuads-a)*c),b-c)}this.dirty=!0},removeQuadsAtIndex:function(a,c){cc.assert(a+c<=this._totalQuads,cc._LogInfos.TextureAtlas_removeQuadsAtIndex);this._totalQuads-=c;if(a!==this._totalQuads){var b=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,d=(a+c)*b,e=a*b;this._quadsReader.set(this._quadsReader.subarray(d,d+(this._totalQuads-a)*b),e)}this.dirty=!0},removeAllQuads:function(){this._totalQuads=this._quads.length=0},_setDirty:function(a){this.dirty=a},resizeCapacity:function(a){if(a===this._capacity)return!0;
var c=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,b=this._capacity;this._totalQuads=Math.min(this._totalQuads,a);var d=this._capacity=0|a,e=this._totalQuads;if(null===this._quads)for(this._quads=[],this._quadsArrayBuffer=new ArrayBuffer(c*d),this._quadsReader=new Uint8Array(this._quadsArrayBuffer),a=0;a<d;a++)this._quads=new cc.V3F_C4B_T2F_Quad(null,null,null,null,this._quadsArrayBuffer,a*c);else{var f,g,h=this._quads;if(d>b){f=[];g=new ArrayBuffer(c*d);for(a=0;a<e;a++)f[a]=new cc.V3F_C4B_T2F_Quad(h[a].tl,
h[a].bl,h[a].tr,h[a].br,g,a*c);for(;a<d;a++)f[a]=new cc.V3F_C4B_T2F_Quad(null,null,null,null,g,a*c)}else for(e=Math.max(e,d),f=[],g=new ArrayBuffer(c*d),a=0;a<e;a++)f[a]=new cc.V3F_C4B_T2F_Quad(h[a].tl,h[a].bl,h[a].tr,h[a].br,g,a*c);this._quadsReader=new Uint8Array(g);this._quads=f;this._quadsArrayBuffer=g}null===this._indices?this._indices=new Uint16Array(6*d):d>b?(c=new Uint16Array(6*d),c.set(this._indices,0),this._indices=c):this._indices=this._indices.subarray(0,6*d);this._setupIndices();this._mapBuffers();
return this.dirty=!0},increaseTotalQuadsWith:function(a){this._totalQuads+=a},moveQuadsFromIndex:function(a,c,b){if(void 0===b){if(b=c,c=this._totalQuads-a,cc.assert(b+(this._totalQuads-a)<=this._capacity,cc._LogInfos.TextureAtlas_moveQuadsFromIndex),0===c)return}else if(cc.assert(b+c<=this._totalQuads,cc._LogInfos.TextureAtlas_moveQuadsFromIndex_2),cc.assert(a<this._totalQuads,cc._LogInfos.TextureAtlas_moveQuadsFromIndex_3),a===b)return;var d=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,e=a*d,f=c*d,g=this._quadsReader,
h=g.subarray(e,e+f),k=b*d;b<a?(c=b*d,g.set(g.subarray(c,c+(a-b)*d),c+f)):(c=(a+c)*d,g.set(g.subarray(c,c+(b-a)*d),e));g.set(h,k);this.dirty=!0},fillWithEmptyQuadsFromIndex:function(a,c){for(var b=c*cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,d=new Uint8Array(this._quadsArrayBuffer,a*cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,b),e=0;e<b;e++)d[e]=0},drawQuads:function(){this.drawNumberOfQuads(this._totalQuads,0)},_releaseBuffer:function(){var a=cc._renderContext;this._buffersVBO&&(this._buffersVBO[0]&&a.deleteBuffer(this._buffersVBO[0]),
this._buffersVBO[1]&&a.deleteBuffer(this._buffersVBO[1]));this._quadsWebBuffer&&a.deleteBuffer(this._quadsWebBuffer)}});_p=cc.TextureAtlas.prototype;cc.defineGetterSetter(_p,"totalQuads",_p.getTotalQuads);cc.defineGetterSetter(_p,"capacity",_p.getCapacity);cc.defineGetterSetter(_p,"quads",_p.getQuads,_p.setQuads);cc.TextureAtlas.create=function(a,c){return new cc.TextureAtlas(a,c)};cc.TextureAtlas.createWithTexture=cc.TextureAtlas.create;
cc._renderType===cc._RENDER_TYPE_WEBGL&&(cc.assert(cc.isFunction(cc._tmp.WebGLTextureAtlas),cc._LogInfos.MissingFile,"TexturesWebGL.js"),cc._tmp.WebGLTextureAtlas(),delete cc._tmp.WebGLTextureAtlas);cc.assert(cc.isFunction(cc._tmp.PrototypeTextureAtlas),cc._LogInfos.MissingFile,"TexturesPropertyDefine.js");cc._tmp.PrototypeTextureAtlas();delete cc._tmp.PrototypeTextureAtlas;cc.Scene=cc.Node.extend({_className:"Scene",ctor:function(){cc.Node.prototype.ctor.call(this);this._ignoreAnchorPointForPosition=!0;this.setAnchorPoint(0.5,0.5);this.setContentSize(cc.director.getWinSize())}});cc.Scene.create=function(){return new cc.Scene};cc.LoaderScene=cc.Scene.extend({_interval:null,_label:null,_className:"LoaderScene",cb:null,target:null,init:function(){var a=this,c=200,b=a._bgLayer=new cc.LayerColor(cc.color(32,32,32,255));a.addChild(b,0);var d=24,e=-c/2+100;cc._loaderImage&&(cc.loader.loadImg(cc._loaderImage,{isCrossOrigin:!1},function(b,d){c=d.height;a._initStage(d,cc.visibleRect.center)}),d=14,e=-c/2-10);d=a._label=new cc.LabelTTF("Loading... 0%","Arial",d);d.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,e)));d.setColor(cc.color(180,
...
b){var d=this._worldTransform,e=d.a,f=d.b,g=d.c,h=d.d;cc.Node.CanvasRenderCmd.prototype.transform.call(this,a,b);d.a===e&&d.b===f&&d.c===g&&d.d===h||0!==this._updateCache||(this._updateCache=2)};a.bake=function(){if(!this._isBaked){this._needDraw=!0;this._isBaked=this._cacheDirty=cc.renderer.childrenOrderDirty=!0;0===this._updateCache&&(this._updateCache=2);for(var a=this._node._children,b=0,d=a.length;b<d;b++)a[b]._renderCmd._setCachedParent(this);this._bakeSprite||(this._bakeSprite=new cc.BakeSprite,
this._bakeSprite.setAnchorPoint(0,0))}};a.unbake=function(){if(this._isBaked){cc.renderer.childrenOrderDirty=!0;this._isBaked=this._needDraw=!1;this._cacheDirty=!0;0===this._updateCache&&(this._updateCache=2);for(var a=this._node._children,b=0,d=a.length;b<d;b++)a[b]._renderCmd._setCachedParent(null)}};a.isBaked=function(){return this._isBaked};a.rendering=function(){if(this._cacheDirty){var a=this._node,b=a._children,d=this._bakeSprite;this.transform(this.getParentRenderCmd(),!0);var e=this._getBoundingBoxForBake();
e.width=0|e.width+0.5;e.height=0|e.height+0.5;var f=d.getCacheContext(),g=f.getContext();d.setPosition(e.x,e.y);if(0<this._updateCache){d.resetCanvasSize(e.width,e.height);f.setOffset(0-e.x,g.canvas.height-e.height+e.y);a.sortAllChildren();cc.renderer._turnToCacheMode(this.__instanceId);a=0;for(e=b.length;a<e;a++)b[a].visit(this);cc.renderer._renderingToCacheCanvas(f,this.__instanceId);d.transform();this._updateCache--}this._cacheDirty=!1}};a.visit=function(a){if(this._isBaked){var b=this._node,d=
b._children.length;b._visible&&0!==d&&(this._syncStatus(a),cc.renderer.pushRenderCommand(this),this._cacheDirty=!0,0===this._updateCache&&(this._updateCache=2),this._bakeSprite.visit(this),this._dirtyFlag=0)}else cc.Node.CanvasRenderCmd.prototype.visit.call(this,a)};a._bakeForAddChild=function(a){a._parent===this._node&&this._isBaked&&a._renderCmd._setCachedParent(this)};a._getBoundingBoxForBake=function(){var a=null,b=this._node;if(!b._children||0===b._children.length)return cc.rect(0,0,10,10);for(var d=
b.getNodeToWorldTransform(),b=b._children,e=0,f=b.length;e<f;e++){var g=b[e];g&&g._visible&&(a?(g=g._getBoundingBoxToCurrentNode(d))&&(a=cc.rectUnion(a,g)):a=g._getBoundingBoxToCurrentNode(d))}return a}})();
...
a._updateSquareVerticesHeight=function(){};a._bakeRendering=function(){if(this._cacheDirty){var a=this._node,b=this._bakeSprite,d=a._children,e=d.length;this.transform(this.getParentRenderCmd(),!0);var f=this._getBoundingBoxForBake();f.width=0|f.width+0.5;f.height=0|f.height+0.5;var g=b.getCacheContext(),h=g.getContext();b.setPosition(f.x,f.y);if(0<this._updateCache){h.fillStyle=g._currentFillStyle;b.resetCanvasSize(f.width,f.height);g.setOffset(0-f.x,h.canvas.height-f.height+f.y);cc.renderer._turnToCacheMode(this.__instanceId);
if(0<e){a.sortAllChildren();for(a=0;a<e;a++)if(f=d[a],0>f._localZOrder)f._renderCmd.visit(this);else break;for(cc.renderer.pushRenderCommand(this);a<e;a++)d[a]._renderCmd.visit(this)}else cc.renderer.pushRenderCommand(this);cc.renderer._renderingToCacheCanvas(g,this.__instanceId);b.transform();this._updateCache--}this._cacheDirty=!1}};a.visit=function(a){this._isBaked?this._node._visible&&(this._syncStatus(a),cc.renderer.pushRenderCommand(this._bakeRenderCmd),this._bakeSprite._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty),
...
(function(){cc.LayerGradient.RenderCmd={updateStatus:function(){var a=cc.Node._dirtyFlags,c=this._dirtyFlag,b=c&a.colorDirty,d=c&a.opacityDirty;b&&this._updateDisplayColor();d&&this._updateDisplayOpacity();(b||d||c&a.gradientDirty)&&this._updateColor();c&a.transformDirty&&this.transform(this.getParentRenderCmd(),!0);this._dirtyFlag=0}}})();
...
255;this._startStopStr="rgba("+Math.round(d.r)+","+Math.round(d.g)+","+Math.round(d.b)+","+e.toFixed(4)+")";this._endStopStr="rgba("+Math.round(b.r)+","+Math.round(b.g)+","+Math.round(b.b)+","+f.toFixed(4)+")";if(a._colorStops)for(this._endOpacity=this._startOpacity=0,this._colorStopsStr=[],d=0;d<a._colorStops.length;d++)b=a._colorStops[d].color,e=null==b.a?1:b.a/255,this._colorStopsStr.push("rgba("+Math.round(b.r)+","+Math.round(b.g)+","+Math.round(b.b)+","+e.toFixed(4)+")")}})();(function(){cc.Layer.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a)};var a=cc.Layer.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);a.constructor=cc.Layer.WebGLRenderCmd;a.bake=function(){};a.unbake=function(){};a._bakeForAddChild=function(){}})();
(function(){cc.LayerColor.WebGLRenderCmd=function(a){cc.Layer.WebGLRenderCmd.call(this,a);this._needDraw=!0;this._squareVerticesAB=new ArrayBuffer(32);this._squareColorsAB=new ArrayBuffer(16);a=this._squareVerticesAB;var b=this._squareColorsAB,d=cc.Vertex2F.BYTES_PER_ELEMENT,e=cc.Color.BYTES_PER_ELEMENT;this._squareVertices=[new cc.Vertex2F(0,0,a,0),new cc.Vertex2F(0,0,a,d),new cc.Vertex2F(0,0,a,2*d),new cc.Vertex2F(0,0,a,3*d)];this._squareColors=[cc.color(0,0,0,255,b,0),cc.color(0,0,0,255,b,e),cc.color(0,
0,0,255,b,2*e),cc.color(0,0,0,255,b,3*e)];this._verticesFloat32Buffer=cc._renderContext.createBuffer();this._colorsUint8Buffer=cc._renderContext.createBuffer()};var a=cc.LayerColor.WebGLRenderCmd.prototype=Object.create(cc.Layer.WebGLRenderCmd.prototype);a.constructor=cc.LayerColor.WebGLRenderCmd;a.rendering=function(a){a=a||cc._renderContext;var b=this._node;this._shaderProgram.use();this._shaderProgram._setUniformForMVPMatrixWithMat4(this._stackMatrix);cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION|
cc.VERTEX_ATTRIB_FLAG_COLOR);cc.glBlendFunc(b._blendFunc.src,b._blendFunc.dst);a.bindBuffer(a.ARRAY_BUFFER,this._verticesFloat32Buffer);a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,a.FLOAT,!1,0,0);a.bindBuffer(a.ARRAY_BUFFER,this._colorsUint8Buffer);a.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,a.UNSIGNED_BYTE,!0,0,0);a.drawArrays(a.TRIANGLE_STRIP,0,this._squareVertices.length)};a._updateSquareVertices=function(a,b){var d=this._squareVertices;void 0===b?(d[1].x=a.width,d[2].y=a.height,d[3].x=
a.width,d[3].y=a.height):(d[1].x=a,d[2].y=b,d[3].x=a,d[3].y=b);this._bindLayerVerticesBufferData()};a._updateSquareVerticesWidth=function(a){var b=this._squareVertices;b[1].x=a;b[3].x=a;this._bindLayerVerticesBufferData()};a._updateSquareVerticesHeight=function(a){var b=this._squareVertices;b[2].y=a;b[3].y=a;this._bindLayerVerticesBufferData()};a._updateColor=function(){for(var a=this._displayedColor,b=this._displayedOpacity,d=this._squareColors,e=0;4>e;e++)d[e].r=a.r,d[e].g=a.g,d[e].b=a.b,d[e].a=
...
(function(){cc.LayerGradient.WebGLRenderCmd=function(a){cc.LayerColor.WebGLRenderCmd.call(this,a);this._needDraw=!0;this._clipRect=new cc.Rect;this._clippingRectDirty=!1};var a=cc.LayerGradient.WebGLRenderCmd.prototype=Object.create(cc.LayerColor.WebGLRenderCmd.prototype);cc.inject(cc.LayerGradient.RenderCmd,a);a.constructor=cc.LayerGradient.WebGLRenderCmd;a._syncStatus=function(a){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,e=a?a._node:null;e&&e._cascadeColorEnabled&&a._dirtyFlag&b.colorDirty&&(d|=
b.colorDirty);e&&e._cascadeOpacityEnabled&&a._dirtyFlag&b.opacityDirty&&(d|=b.opacityDirty);a&&a._dirtyFlag&b.transformDirty&&(d|=b.transformDirty);var e=d&b.colorDirty,f=d&b.opacityDirty;this._dirtyFlag=d;e&&this._syncDisplayColor();f&&this._syncDisplayOpacity();this.transform(a);(e||f||d&b.gradientDirty)&&this._updateColor()};a._updateColor=function(){this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.gradientDirty;var a=this._node,b=a._colorStops;if(b&&!(2>b.length)){this._clippingRectDirty=
!0;var d=b.length,e=2*d,f,g=a._contentSize;this._squareVerticesAB=new ArrayBuffer(8*e);this._squareColorsAB=new ArrayBuffer(4*e);var h=this._squareVertices,k=this._squareColors;h.length=0;k.length=0;var m=this._squareVerticesAB,p=this._squareColorsAB,n=cc.Vertex2F.BYTES_PER_ELEMENT,s=cc.Color.BYTES_PER_ELEMENT;for(f=0;f<e;f++)h.push(new cc.Vertex2F(0,0,m,n*f)),k.push(cc.color(0,0,0,255,p,s*f));p=Math.PI+cc.pAngleSigned(cc.p(0,-1),a._alongVector);a=cc.p(g.width/2,g.height/2);f=Math.round(cc.radiansToDegrees(p));
e=cc.affineTransformMake(1,0,0,1,a.x,a.y);e=cc.affineTransformRotate(e,p);90>f?(n=cc.p(-a.x,a.y),f=cc.p(a.x,a.y)):180>f?(n=cc.p(a.x,a.y),f=cc.p(a.x,-a.y)):270>f?(n=cc.p(a.x,-a.y),f=cc.p(-a.x,-a.y)):(n=cc.p(-a.x,-a.y),f=cc.p(-a.x,a.y));m=Math.sin(p);p=Math.cos(p);n=Math.abs((n.x*p-n.y*m)/a.x);f=Math.abs((f.x*m+f.y*p)/a.y);e=cc.affineTransformScale(e,n,f);for(f=0;f<d;f++)m=b[f].p*g.height,p=cc.pointApplyAffineTransform(-a.x,m-a.y,e),h[2*f].x=p.x,h[2*f].y=p.y,m=cc.pointApplyAffineTransform(g.width-a.x,
m-a.y,e),h[2*f+1].x=m.x,h[2*f+1].y=m.y;g=this._displayedOpacity/255;for(f=0;f<d;f++)h=b[f].color,a=k[2*f],e=k[2*f+1],a.r=h.r,a.g=h.g,a.b=h.b,a.a=h.a*g,e.r=h.r,e.g=h.g,e.b=h.b,e.a=h.a*g;this._bindLayerVerticesBufferData();this._bindLayerColorsBufferData()}};a.rendering=function(a){a=a||cc._renderContext;var b=this._node,d=this._getClippingRect();a.enable(a.SCISSOR_TEST);cc.view.setScissorInPoints(d.x,d.y,d.width,d.height);this._shaderProgram.use();this._shaderProgram._setUniformForMVPMatrixWithMat4(this._stackMatrix);
...
this._node,b=cc.rect(0,0,a._contentSize.width,a._contentSize.height),a=a.getNodeToWorldTransform();this._clipRect=cc._rectApplyAffineTransformIn(b,a)}return this._clipRect}})();cc._tmp.PrototypeSprite=function(){var a=cc.Sprite.prototype;cc.defineGetterSetter(a,"opacityModifyRGB",a.isOpacityModifyRGB,a.setOpacityModifyRGB);cc.defineGetterSetter(a,"opacity",a.getOpacity,a.setOpacity);cc.defineGetterSetter(a,"color",a.getColor,a.setColor);cc.defineGetterSetter(a,"flippedX",a.isFlippedX,a.setFlippedX);cc.defineGetterSetter(a,"flippedY",a.isFlippedY,a.setFlippedY);cc.defineGetterSetter(a,"offsetX",a._getOffsetX);cc.defineGetterSetter(a,"offsetY",a._getOffsetY);cc.defineGetterSetter(a,
...
cc.affineTransformIdentity(),this.textureAtlas=this._batchNode.getTextureAtlas()):(this.atlasIndex=cc.Sprite.INDEX_NOT_INITIALIZED,this.textureAtlas=null,this.dirty=this._recursiveDirty=!1,this._renderCmd._resetForBatchNode())},setTexture:function(a){if(!a)return this._renderCmd._setTexture(null);var c=this._texture;cc.isString(a)?(a=cc.textureCache.addImage(a),a._textureLoaded?(this._renderCmd._setTexture(a),this._changeRectWithTexture(a,c),this.setColor(this._realColor),this._textureLoaded=!0):
a.addEventListener("load",function(){this._renderCmd._setTexture(a);this._changeRectWithTexture(a,c);this.setColor(this._realColor);this._textureLoaded=!0},this)):(cc.assert(a instanceof cc.Texture2D,cc._LogInfos.Sprite_setTexture_2),this._changeRectWithTexture(a,c),this._renderCmd._setTexture(a))},_changeRectWithTexture:function(a,c){var b=cc.rect(0,0,a._contentSize.width,a._contentSize.height),d=c?c._contentSize:cc.size(),e=this._contentSize,f=b.width,g=b.height,h=d.width,d=d.height,k=e.width,e=
e.height;if(b&&(f||g)){var m=this._rect;if(0===k||0===e||k===h||e===d||h!==f||d!==g||0===m.height&&0===m.width)b.x=b.x||0,b.y=b.y||0,b.width=b.width||0,b.height=b.height||0,this.setTextureRect(b)}},_createRenderCmd:function(){return cc._renderType===cc._RENDER_TYPE_CANVAS?new cc.Sprite.CanvasRenderCmd(this):new cc.Sprite.WebGLRenderCmd(this)}});cc.Sprite.create=function(a,c,b){return new cc.Sprite(a,c,b)};cc.Sprite.createWithTexture=cc.Sprite.create;cc.Sprite.createWithSpriteFrameName=cc.Sprite.create;
...
a.url));this._node._originalTexture=a};a.rendering=function(a,b,d){var e=this._node,f=this._textureCoord,g=this._displayedOpacity/255;if((!e._texture||0!==f.width&&0!==f.height&&e._texture._textureLoaded)&&0!==g){a=a||cc._renderContext;var h=a.getContext(),k=e._offsetPosition.x,m=e._rect.height,p=e._rect.width,n=-e._offsetPosition.y-m;a.setTransform(this._worldTransform,b,d);a.setCompositeOperation(this._blendFuncStr);a.setGlobalAlpha(g);(e._flippedX||e._flippedY)&&a.save();e._flippedX&&(k=-k-p,h.scale(-1,
1));e._flippedY&&(n=e._offsetPosition.y,h.scale(1,-1));e._texture?(g=e._texture._htmlElementObj,""!==e._texture._pattern?(a.setFillStyle(h.createPattern(g,e._texture._pattern)),h.fillRect(k*b,n*d,p*b,m*d)):this._colorized?h.drawImage(g,0,0,f.width,f.height,k*b,n*d,p*b,m*d):h.drawImage(g,f.renderX,f.renderY,f.width,f.height,k*b,n*d,p*b,m*d)):(g=e._contentSize,f.validRect&&(f=this._displayedColor,a.setFillStyle("rgba("+f.r+","+f.g+","+f.b+",1)"),h.fillRect(k*b,n*d,g.width*b,g.height*d)));(e._flippedX||
...
b,f,d):(d=cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply(this._originalTexture._htmlElementObj,b,f),e=new cc.Texture2D,e.initWithElement(d),e.handleLoadedTexture(),a.setTexture(e)))}}:function(){var a=this._node,b=this._displayedColor;if(255===b.r&&255===b.g&&255===b.b)this._setOriginalTexture();else{var d,e=a._texture,f=this._textureCoord;e&&f.validRect&&this._originalTexture&&(d=e.getHtmlElementObj())&&(e=cc.textureCache.getTextureColors(this._originalTexture.getHtmlElementObj()))&&(this._colorized=
!0,d instanceof HTMLCanvasElement&&!this._rectRotated&&!this._newTextureWhenChangeColor?cc.Sprite.CanvasRenderCmd._generateTintImage(d,e,b,f,d):(d=cc.Sprite.CanvasRenderCmd._generateTintImage(d,e,b,f),e=new cc.Texture2D,e.initWithElement(d),e.handleLoadedTexture(),a.texture=e))}};a._setOriginalTexture=function(){if(this._colorized){this._colorized=!1;var a=this._node,b=cc.rect(a._rect),d=cc.size(a._contentSize),e=a._rectRotated;a.setTexture(this._originalTexture);a.setTextureRect(b,e,d)}};a.getQuad=
function(){return null};a._updateForSetSpriteFrame=function(a,b){this._originalTexture=a;this._colorized=!1;this._textureCoord.renderX=this._textureCoord.x;this._textureCoord.renderY=this._textureCoord.y;if(b=b||a._textureLoaded){var d=this._node.getColor();255===d.r&&255===d.g&&255===d.b||this._updateColor()}};a.updateTransform=function(){var a=this._node;if(a.dirty){var b=a._parent;!a._visible||b&&b!==a._batchNode&&b._shouldBeHidden?a._shouldBeHidden=!0:(a._shouldBeHidden=!1,a._transformToBatch=
b&&b!==a._batchNode?cc.affineTransformConcat(this.getNodeToParentTransform(),b._transformToBatch):this.getNodeToParentTransform());a._recursiveDirty=!1;a.dirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,cc.Node._stateCallbackType.updateTransform)};a._updateDisplayColor=function(a){cc.Node.CanvasRenderCmd.prototype._updateDisplayColor.call(this,a)};a._spriteFrameLoadedCallback=function(a){this.setTextureRect(a.getRect(),a.isRotated(),a.getOriginalSize());this._renderCmd._updateColor();
this.dispatchEvent("load")};a._textureLoadedCallback=function(a){if(!this._textureLoaded){this._textureLoaded=!0;var b=this._rect,d=this._renderCmd;b?cc._rectEqualToZero(b)&&(b.width=a.width,b.height=a.height):b=cc.rect(0,0,a.width,a.height);this.texture=d._originalTexture=a;this.setTextureRect(b,this._rectRotated);a=d._displayedColor;255===a.r&&255===a.g&&255===a.b||d._updateColor();this.setBatchNode(this._batchNode);this.dispatchEvent("load")}};a._setTextureCoords=function(a,b){void 0===b&&(b=!0);
var d=this._textureCoord,e=b?cc.contentScaleFactor():1;d.renderX=d.x=0|a.x*e;d.renderY=d.y=0|a.y*e;d.width=0|a.width*e;d.height=0|a.height*e;d.validRect=!(0===d.width||0===d.height||0>d.x||0>d.y)};cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply=function(a,b,d,e){e=e||cc.newElement("canvas");d=d||cc.rect(0,0,a.width,a.height);var f=e.getContext("2d");e.width!==d.width||e.height!==d.height?(e.width=d.width,e.height=d.height):f.globalCompositeOperation="source-over";f.fillStyle="rgb("+(0|b.r)+
","+(0|b.g)+","+(0|b.b)+")";f.fillRect(0,0,d.width,d.height);f.globalCompositeOperation="multiply";f.drawImage(a,d.x,d.y,d.width,d.height,0,0,d.width,d.height);f.globalCompositeOperation="destination-atop";f.drawImage(a,d.x,d.y,d.width,d.height,0,0,d.width,d.height);return e};cc.Sprite.CanvasRenderCmd._generateTintImage=function(a,b,d,e,f){e||(e=cc.rect(0,0,a.width,a.height));a=d.r/255;var g=d.g/255;d=d.b/255;var h=Math.min(e.width,b[0].width),k=Math.min(e.height,b[0].height),m;f?(m=f.getContext("2d"),
m.clearRect(0,0,h,k)):(f=cc.newElement("canvas"),f.width=h,f.height=k,m=f.getContext("2d"));m.save();m.globalCompositeOperation="lighter";var p=m.globalAlpha;0<a&&(m.globalAlpha=a*p,m.drawImage(b[0],e.x,e.y,h,k,0,0,h,k));0<g&&(m.globalAlpha=g*p,m.drawImage(b[1],e.x,e.y,h,k,0,0,h,k));0<d&&(m.globalAlpha=d*p,m.drawImage(b[2],e.x,e.y,h,k,0,0,h,k));1>a+g+d&&(m.globalAlpha=p,m.drawImage(b[3],e.x,e.y,h,k,0,0,h,k));m.restore();return f};cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor=function(a){function b(){var b=
cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor,e=a.width,h=a.height;d[0].width=e;d[0].height=h;d[1].width=e;d[1].height=h;d[2].width=e;d[2].height=h;d[3].width=e;d[3].height=h;b.canvas.width=e;b.canvas.height=h;var k=b.canvas.getContext("2d");k.drawImage(a,0,0);b.tempCanvas.width=e;b.tempCanvas.height=h;for(var k=k.getImageData(0,0,e,h).data,m=0;4>m;m++){var p=d[m].getContext("2d");p.getImageData(0,0,e,h).data;b.tempCtx.drawImage(a,0,0);for(var n=b.tempCtx.getImageData(0,0,e,h),s=n.data,
r=0;r<k.length;r+=4)s[r]=0===m?k[r]:0,s[r+1]=1===m?k[r+1]:0,s[r+2]=2===m?k[r+2]:0,s[r+3]=k[r+3];p.putImageData(n,0,0)}a.onload=null}if(a.channelCache)return a.channelCache;var d=[cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas")];try{b()}catch(e){a.onload=b}return a.channelCache=d};cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.canvas=cc.newElement("canvas");cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.tempCanvas=cc.newElement("canvas");
...
2,b.height,b.width);return e}})();(function(){cc.Sprite.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a);this._needDraw=!0;this._quad=new cc.V3F_C4B_T2F_Quad;this._quadWebBuffer=cc._renderContext.createBuffer();this._quadDirty=!0;this._recursiveDirty=this._dirty=!1};var a=cc.Sprite.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);a.constructor=cc.Sprite.WebGLRenderCmd;a.updateBlendFunc=function(a){};a.setDirtyFlag=function(a){cc.Node.WebGLRenderCmd.prototype.setDirtyFlag.call(this,a);this._dirty=
!0};a.setDirtyRecursively=function(a){this._dirty=this._recursiveDirty=a;for(var b=this._node._children,d,e=b?b.length:0,f=0;f<e;f++)d=b[f],d instanceof cc.Sprite&&d._renderCmd.setDirtyRecursively(a)};a._setBatchNodeForAddChild=function(a){var b=this._node;if(b._batchNode){if(!(a instanceof cc.Sprite))return cc.log(cc._LogInfos.Sprite_addChild),!1;a.texture._webTextureObj!==b.textureAtlas.texture._webTextureObj&&cc.log(cc._LogInfos.Sprite_addChild_2);b._batchNode.appendChild(a);b._reorderChildDirty||
b._setReorderChildDirtyRecursively()}return!0};a._handleTextureForRotatedTexture=function(a){return a};a.isFrameDisplayed=function(a){var b=this._node;return cc.rectEqualToRect(a.getRect(),b._rect)&&a.getTexture().getName()===b._texture.getName()&&cc.pointEqualToPoint(a.getOffset(),b._unflippedOffsetPositionFromCenter)};a._init=function(){var a={r:255,g:255,b:255,a:255},b=this._quad;b.bl.colors=a;b.br.colors=a;b.tl.colors=a;b.tr.colors=a;this._quadDirty=!0};a._resetForBatchNode=function(){var a=this._node,
b=a._offsetPosition.x,d=a._offsetPosition.y,e=b+a._rect.width,a=d+a._rect.height,f=this._quad;f.bl.vertices={x:b,y:d,z:0};f.br.vertices={x:e,y:d,z:0};f.tl.vertices={x:b,y:a,z:0};f.tr.vertices={x:e,y:a,z:0};this._quadDirty=!0};a.getQuad=function(){return this._quad};a._updateForSetSpriteFrame=function(){};a._spriteFrameLoadedCallback=function(a){this.setTextureRect(a.getRect(),a.isRotated(),a.getOriginalSize());this.dispatchEvent("load")};a._textureLoadedCallback=function(a){var b=this._renderCmd;
if(!this._textureLoaded){this._textureLoaded=!0;var d=this._rect;d?cc._rectEqualToZero(d)&&(d.width=a.width,d.height=a.height):d=cc.rect(0,0,a.width,a.height);this.texture=a;this.setTextureRect(d,this._rectRotated);this.setBatchNode(this._batchNode);b._quadDirty=!0;this.dispatchEvent("load")}};a._setTextureCoords=function(a,b){void 0===b&&(b=!0);b&&(a=cc.rectPointsToPixels(a));var d=this._node,e=d._batchNode?d.textureAtlas.texture:d._texture;if(e){var f=e.pixelsWidth,g=e.pixelsHeight,h,k,m=this._quad;
...
h+(2*a.height-2)/(2*g)):(e=a.x/f,f=(a.x+a.width)/f,h=a.y/g,g=(a.y+a.height)/g),d._flippedX&&(k=e,e=f,f=k),d._flippedY&&(k=h,h=g,g=k),m.bl.texCoords.u=e,m.bl.texCoords.v=g,m.br.texCoords.u=f,m.br.texCoords.v=g,m.tl.texCoords.u=e,m.tl.texCoords.v=h,m.tr.texCoords.u=f,m.tr.texCoords.v=h);this._quadDirty=!0}};a.transform=function(a,b){cc.Node.WebGLRenderCmd.prototype.transform.call(this,a,b);this._dirty=!0};a._setColorDirty=function(){};a._updateColor=function(){var a=this._displayedColor,b=this._displayedOpacity,
d=this._node,a={r:a.r,g:a.g,b:a.b,a:b};d._opacityModifyRGB&&(a.r*=b/255,a.g*=b/255,a.b*=b/255);b=this._quad;b.bl.colors=a;b.br.colors=a;b.tl.colors=a;b.tr.colors=a;d._batchNode&&(d.atlasIndex!==cc.Sprite.INDEX_NOT_INITIALIZED?d.textureAtlas.updateQuad(b,d.atlasIndex):this._dirty=!0);this._quadDirty=!0};a._updateBlendFunc=function(){if(this._batchNode)cc.log(cc._LogInfos.Sprite__updateBlendFunc);else{var a=this._node;a._texture&&a._texture.hasPremultipliedAlpha()?(a._blendFunc.src=cc.BLEND_SRC,a._blendFunc.dst=
cc.BLEND_DST,a.opacityModifyRGB=!0):(a._blendFunc.src=cc.SRC_ALPHA,a._blendFunc.dst=cc.ONE_MINUS_SRC_ALPHA,a.opacityModifyRGB=!1)}};a._setTexture=function(a){var b=this._node;if(b._batchNode){if(b._batchNode.texture!==a){cc.log(cc._LogInfos.Sprite_setTexture);return}}else b._texture!==a&&(b._textureLoaded=a?a._textureLoaded:!1,b._texture=a,this._updateBlendFunc());this._shaderProgram=a?cc.shaderCache.programForKey(cc.SHADER_POSITION_TEXTURECOLOR):cc.shaderCache.programForKey(cc.SHADER_POSITION_COLOR)};
a.updateTransform=function(){var a=this._node;if(this._dirty){var b=this._quad,d=a._parent;if(!a._visible||d&&d!==a._batchNode&&d._shouldBeHidden)b.br.vertices=b.tl.vertices=b.tr.vertices=b.bl.vertices={x:0,y:0,z:0},a._shouldBeHidden=!0;else{a._shouldBeHidden=!1;0!==this._dirtyFlag&&(this.updateStatus(),this._dirtyFlag=0);a._transformToBatch=d&&d!==a._batchNode?cc.affineTransformConcat(this.getNodeToParentTransform(),d._transformToBatch):this.getNodeToParentTransform();var e=a._transformToBatch,f=
a._rect,d=a._offsetPosition.x,g=a._offsetPosition.y,h=d+f.width,k=g+f.height,m=e.tx,p=e.ty,n=e.a,s=e.b,r=e.d,t=-e.c,e=d*n-g*t+m,f=d*s+g*r+p,q=h*n-g*t+m,g=h*s+g*r+p,u=h*n-k*t+m,h=h*s+k*r+p,m=d*n-k*t+m,d=d*s+k*r+p,k=a._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(e|=0,f|=0,q|=0,g|=0,u|=0,h|=0,m|=0,d|=0);b.bl.vertices={x:e,y:f,z:k};b.br.vertices={x:q,y:g,z:k};b.tl.vertices={x:m,y:d,z:k};b.tr.vertices={x:u,y:h,z:k}}a.textureAtlas.updateQuad(b,a.atlasIndex);this._dirty=a._recursiveDirty=!1}a._hasChildren&&
a._arrayMakeObjectsPerformSelector(a._children,cc.Node._stateCallbackType.updateTransform)};a._checkTextureBoundary=function(a,b,d){a&&a.url&&(d?(d=b.x+b.height,b=b.y+b.width):(d=b.x+b.width,b=b.y+b.height),d>a.width&&cc.error(cc._LogInfos.RectWidth,a.url),b>a.height&&cc.error(cc._LogInfos.RectHeight,a.url))};a.rendering=function(a){var b=this._node,d=b._texture;d&&!d._textureLoaded||0===this._displayedOpacity||(a=a||cc._renderContext,d?d._textureLoaded&&(this._shaderProgram.use(),this._shaderProgram._setUniformForMVPMatrixWithMat4(this._stackMatrix),
...
d.width,b.y),cc.p(b.x+d.width,b.y+d.height),cc.p(b.x,b.y+d.height)],cc._drawingUtil.drawPoly(b,4,!0)),cc.current_stack.top=cc.current_stack.stack.pop())}})();cc.SpriteBatchNode=cc.Node.extend({_blendFunc:null,_descendants:null,_className:"SpriteBatchNode",ctor:function(a,c){cc.Node.prototype.ctor.call(this);this._descendants=[];this._blendFunc=new cc.BlendFunc(cc.BLEND_SRC,cc.BLEND_DST);var b;c=c||cc.SpriteBatchNode.DEFAULT_CAPACITY;cc.isString(a)?(b=cc.textureCache.getTextureForKey(a))||(b=cc.textureCache.addImage(a)):a instanceof cc.Texture2D&&(b=a);b&&this.initWithTexture(b,c)},addSpriteWithoutQuad:function(a,c,b){cc.assert(a,cc._LogInfos.SpriteBatchNode_addSpriteWithoutQuad_2);
if(!(a instanceof cc.Sprite))return cc.log(cc._LogInfos.SpriteBatchNode_addSpriteWithoutQuad),null;a.atlasIndex=c;var d=0,e,f=this._descendants;if(f&&0<f.length)for(d=0,e=f.length;d<e;d++){var g=f[d];if(g&&g.atlasIndex>=c)break}f.splice(d,0,a);cc.Node.prototype.addChild.call(this,a,c,b);this.reorderBatch(!1);return this},getTextureAtlas:function(){return this._renderCmd.getTextureAtlas()},setTextureAtlas:function(a){this._renderCmd.getTextureAtlas(a)},getDescendants:function(){return this._descendants},
initWithFile:function(a,c){var b=cc.textureCache.getTextureForKey(a);b||(b=cc.textureCache.addImage(a));return this.initWithTexture(b,c)},_setNodeDirtyForCache:function(){this._renderCmd&&this._renderCmd._setNodeDirtyForCache&&this._renderCmd._setNodeDirtyForCache()},init:function(a,c){var b=cc.textureCache.getTextureForKey(a);b||(b=cc.textureCache.addImage(a));return this.initWithTexture(b,c)},increaseAtlasCapacity:function(){this._renderCmd.increaseAtlasCapacity()},removeChildAtIndex:function(a,
c){this.removeChild(this._children[a],c)},rebuildIndexInOrder:function(a,c){var b=a.children;if(b&&0<b.length)for(var d=0;d<b.length;d++){var e=b[d];e&&0>e.zIndex&&(c=this.rebuildIndexInOrder(e,c))}!a===this&&(a.atlasIndex=c,c++);if(b&&0<b.length)for(d=0;d<b.length;d++)(e=b[d])&&0<=e.zIndex&&(c=this.rebuildIndexInOrder(e,c));return c},highestAtlasIndexInChild:function(a){var c=a.children;return c&&0!==c.length?this.highestAtlasIndexInChild(c[c.length-1]):a.atlasIndex},lowestAtlasIndexInChild:function(a){var c=
a.children;return c&&0!==c.length?this.lowestAtlasIndexInChild(c[c.length-1]):a.atlasIndex},atlasIndexForChild:function(a,c){var b=a.parent,d=b.children,e=d.indexOf(a),f=null;0<e&&e<cc.UINT_MAX&&(f=d[e-1]);return b===this?0===e?0:this.highestAtlasIndexInChild(f)+1:0===e?0>c?b.atlasIndex:b.atlasIndex+1:0>f.zIndex&&0>c||0<=f.zIndex&&0<=c?this.highestAtlasIndexInChild(f)+1:b.atlasIndex+1},reorderBatch:function(a){this._reorderChildDirty=a},setBlendFunc:function(a,c){this._blendFunc=void 0===c?a:{src:a,
dst:c}},getBlendFunc:function(){return new cc.BlendFunc(this._blendFunc.src,this._blendFunc.dst)},reorderChild:function(a,c){cc.assert(a,cc._LogInfos.SpriteBatchNode_reorderChild_2);-1===this._children.indexOf(a)?cc.log(cc._LogInfos.SpriteBatchNode_reorderChild):c!==a.zIndex&&cc.Node.prototype.reorderChild.call(this,a,c)},removeChild:function(a,c){null!=a&&(-1===this._children.indexOf(a)?cc.log(cc._LogInfos.SpriteBatchNode_removeChild):(this.removeSpriteFromAtlas(a),cc.Node.prototype.removeChild.call(this,
a,c)))},updateQuadFromSprite:function(a,c){cc.assert(a,cc._LogInfos.CCSpriteBatchNode_updateQuadFromSprite_2);a instanceof cc.Sprite?(this._renderCmd.checkAtlasCapacity(),a.batchNode=this,a.atlasIndex=c,a.dirty=!0,a.updateTransform()):cc.log(cc._LogInfos.CCSpriteBatchNode_updateQuadFromSprite)},insertQuadFromSprite:function(a,c){cc.assert(a,cc._LogInfos.CCSpriteBatchNode_insertQuadFromSprite_2);a instanceof cc.Sprite?(this._renderCmd.insertQuad(a,c),a.batchNode=this,a.atlasIndex=c,a.dirty=!0,a.updateTransform(),
this._renderCmd.cutting(a,c)):cc.log(cc._LogInfos.CCSpriteBatchNode_insertQuadFromSprite)},initWithTexture:function(a,c){this._children.length=0;this._descendants.length=0;c=c||cc.SpriteBatchNode.DEFAULT_CAPACITY;this._renderCmd.initWithTexture(a,c);return!0},insertChild:function(a,c){a.batchNode=this;a.atlasIndex=c;a.dirty=!0;this._renderCmd.insertQuad(a,c);this._descendants.splice(c,0,a);var b=c+1,d=this._descendants;if(d&&0<d.length)for(;b<d.length;b++)d[b].atlasIndex++;var d=a.children,e,f;if(d)for(b=
0,f=d.length||0;b<f;b++)if(e=d[b]){var g=this.atlasIndexForChild(e,e.zIndex);this.insertChild(e,g)}},appendChild:function(a){this._reorderChildDirty=!0;a.batchNode=this;a.dirty=!0;this._descendants.push(a);var c=this._descendants.length-1;a.atlasIndex=c;this._renderCmd.insertQuad(a,c);a=a.children;for(var c=0,b=a.length||0;c<b;c++)this.appendChild(a[c])},removeSpriteFromAtlas:function(a){this._renderCmd.removeQuadAtIndex(a.atlasIndex);a.batchNode=null;var c=this._descendants,b=c.indexOf(a);if(-1!==
b){c.splice(b,1);for(var d=c.length;b<d;++b)c[b].atlasIndex--}if(a=a.children)for(c=0,b=a.length||0;c<b;c++)a[c]&&this.removeSpriteFromAtlas(a[c])},getTexture:function(){return this._renderCmd.getTexture()},setTexture:function(a){this._renderCmd.setTexture(a)},addChild:function(a,c,b){cc.assert(null!=a,cc._LogInfos.CCSpriteBatchNode_addChild_3);this._renderCmd.isValidChild(a)&&(c=null==c?a.zIndex:c,b=null==b?a.tag:b,cc.Node.prototype.addChild.call(this,a,c,b),this.appendChild(a))},removeAllChildren:function(a){var c=
this._descendants;if(c&&0<c.length)for(var b=0,d=c.length;b<d;b++)c[b]&&(c[b].batchNode=null);cc.Node.prototype.removeAllChildren.call(this,a);this._descendants.length=0;this._renderCmd.removeAllQuads()},sortAllChildren:function(){if(this._reorderChildDirty){var a=this._children,c,b=0,d=a.length,e;for(c=1;c<d;c++){var f=a[c],b=c-1;for(e=a[b];0<=b&&(f._localZOrder<e._localZOrder||f._localZOrder===e._localZOrder&&f.arrivalOrder<e.arrivalOrder);)a[b+1]=e,b-=1,e=a[b];a[b+1]=f}0<a.length&&(this._arrayMakeObjectsPerformSelector(a,
...
cc.spriteFrameCache,b;for(b in a){var d=a[b],e=d.loop,f=parseInt(d.loops),e=e?cc.REPEAT_FOREVER:isNaN(f)?1:f,f=d.restoreOriginalFrame&&!0==d.restoreOriginalFrame?!0:!1,g=d.frames;if(g){for(var h=[],k=0;k<g.length;k++){var m=g[k],p=m.spriteframe,n=c.getSpriteFrame(p);if(n){var p=parseFloat(m.delayUnits)||0,m=m.notification,s=new cc.AnimationFrame;s.initWithSpriteFrame(n,p,m);h.push(s)}else cc.log(cc._LogInfos.animationCache__parseVersion2_2,b,p)}d=parseFloat(d.delayPerUnit)||0;g=new cc.Animation;g.initWithAnimationFrames(h,
...
cc.SpriteFrame._frameWithTextureForCanvas=function(a,c,b,d,e){var f=new cc.SpriteFrame;f._texture=a;f._rectInPixels=c;f._rect=cc.rectPixelsToPoints(c);f._offsetInPixels.x=d.x;f._offsetInPixels.y=d.y;cc._pointPixelsToPointsOut(f._offsetInPixels,f._offset);f._originalSizeInPixels.width=e.width;f._originalSizeInPixels.height=e.height;cc._sizePixelsToPointsOut(f._originalSizeInPixels,f._originalSize);f._rotated=b;return f};cc.spriteFrameCache={_CCNS_REG1:/^\s*\{\s*([\-]?\d+[.]?\d*)\s*,\s*([\-]?\d+[.]?\d*)\s*\}\s*$/,_CCNS_REG2:/^\s*\{\s*\{\s*([\-]?\d+[.]?\d*)\s*,\s*([\-]?\d+[.]?\d*)\s*\}\s*,\s*\{\s*([\-]?\d+[.]?\d*)\s*,\s*([\-]?\d+[.]?\d*)\s*\}\s*\}\s*$/,_spriteFrames:{},_spriteFramesAliases:{},_frameConfigCache:{},_rectFromString:function(a){return(a=this._CCNS_REG2.exec(a))?cc.rect(parseFloat(a[1]),parseFloat(a[2]),parseFloat(a[3]),parseFloat(a[4])):cc.rect(0,0,0,0)},_pointFromString:function(a){return(a=this._CCNS_REG1.exec(a))?
...
supportsShareableVAO:function(){return this._supportsShareableVAO},checkForGLExtension:function(a){return-1<this._GlExtensions.indexOf(a)},getValue:function(a,c){this._inited||this._init();var b=this._valueDict;return b[a]?b[a]:c},setValue:function(a,c){this._valueDict[a]=c},dumpInfo:function(){0===cc.ENABLE_GL_STATE_CACHE&&(cc.log(""),cc.log(cc._LogInfos.configuration_dumpInfo),cc.log(""))},gatherGPUInfo:function(){if(cc._renderType!==cc._RENDER_TYPE_CANVAS){this._inited||this._init();var a=cc._renderContext,
c=this._valueDict;c["gl.vendor"]=a.getParameter(a.VENDOR);c["gl.renderer"]=a.getParameter(a.RENDERER);c["gl.version"]=a.getParameter(a.VERSION);this._GlExtensions="";for(var b=a.getSupportedExtensions(),d=0;d<b.length;d++)this._GlExtensions+=b[d]+" ";this._maxTextureSize=a.getParameter(a.MAX_TEXTURE_SIZE);c["gl.max_texture_size"]=this._maxTextureSize;this._maxTextureUnits=a.getParameter(a.MAX_COMBINED_TEXTURE_IMAGE_UNITS);c["gl.max_texture_units"]=this._maxTextureUnits;this._supportsPVRTC=this.checkForGLExtension("GL_IMG_texture_compression_pvrtc");
c["gl.supports_PVRTC"]=this._supportsPVRTC;this._supportsNPOT=!1;c["gl.supports_NPOT"]=this._supportsNPOT;this._supportsBGRA8888=this.checkForGLExtension("GL_IMG_texture_format_BGRA888");c["gl.supports_BGRA8888"]=this._supportsBGRA8888;this._supportsDiscardFramebuffer=this.checkForGLExtension("GL_EXT_discard_framebuffer");c["gl.supports_discard_framebuffer"]=this._supportsDiscardFramebuffer;this._supportsShareableVAO=this.checkForGLExtension("vertex_array_object");c["gl.supports_vertex_array_object"]=
this._supportsShareableVAO;cc.checkGLErrorDebug()}},loadConfigFile:function(a){this._inited||this._init();var c=cc.loader.getRes(a);if(!c)throw Error("Please load the resource first : "+a);cc.assert(c,cc._LogInfos.configuration_loadConfigFile_2,a);if(c=c.data)for(var b in c)this._valueDict[b]=c[b];else cc.log(cc._LogInfos.configuration_loadConfigFile,a)}};cc.g_NumberOfDraws=0;cc.GLToClipTransform=function(a){cc.kmGLGetMatrix(cc.KM_GL_PROJECTION,a);var c=new cc.math.Matrix4;cc.kmGLGetMatrix(cc.KM_GL_MODELVIEW,c);a.multiply(c)};
...
this._SPFLabel.height/2+a.y);this._FPSLabel.setPosition(this._FPSLabel.width/2+a.x,this._FPSLabel.height/2+a.y)},_p.getVisibleSize=function(){return this.getWinSize()},_p.getVisibleOrigin=function(){return cc.p(0,0)}):(cc.Director._fpsImage=new Image,cc._addEventListener(cc.Director._fpsImage,"load",function(){cc.Director._fpsImageLoaded=!0}),cc._fpsImage&&(cc.Director._fpsImage.src=cc._fpsImage));cc._renderType===cc._RENDER_TYPE_WEBGL&&function(){cc.DirectorDelegate=cc.Class.extend({updateProjection:function(){}});var a=cc.Director.prototype;a.setProjection=function(a){var b=this._winSizeInPoints;this.setViewport();var d=this._openGLView,e=d._viewPortRect.x/d._scaleX,f=d._viewPortRect.y/d._scaleY;switch(a){case cc.Director.PROJECTION_2D:cc.kmGLMatrixMode(cc.KM_GL_PROJECTION);cc.kmGLLoadIdentity();d=cc.math.Matrix4.createOrthographicProjection(-e,b.width-e,-f,b.height-f,-1024,1024);cc.kmGLMultMatrix(d);
cc.kmGLMatrixMode(cc.KM_GL_MODELVIEW);cc.kmGLLoadIdentity();break;case cc.Director.PROJECTION_3D:var g=this.getZEye(),h=new cc.math.Matrix4,d=new cc.math.Matrix4;cc.kmGLMatrixMode(cc.KM_GL_PROJECTION);cc.kmGLLoadIdentity();h=cc.math.Matrix4.createPerspectiveProjection(60,b.width/b.height,0.1,2*g);cc.kmGLMultMatrix(h);cc.kmGLMatrixMode(cc.KM_GL_MODELVIEW);cc.kmGLLoadIdentity();g=new cc.math.Vec3(-e+b.width/2,-f+b.height/2,g);b=new cc.math.Vec3(-e+b.width/2,-f+b.height/2,0);e=new cc.math.Vec3(0,1,0);
d.lookAt(g,b,e);cc.kmGLMultMatrix(d);break;case cc.Director.PROJECTION_CUSTOM:this._projectionDelegate&&this._projectionDelegate.updateProjection();break;default:cc.log(cc._LogInfos.Director_setProjection)}this._projection=a;cc.eventManager.dispatchEvent(this._eventProjectionChanged);cc.setProjectionMatrixDirty();cc.renderer.childrenOrderDirty=!0};a.setDepthTest=function(a){var b=cc._renderContext;a?(b.clearDepth(1),b.enable(b.DEPTH_TEST),b.depthFunc(b.LEQUAL)):b.disable(b.DEPTH_TEST)};a.setClearColor=
function(a){cc.renderer._clearColor=a};a.setOpenGLView=function(a){this._winSizeInPoints.width=cc._canvas.width;this._winSizeInPoints.height=cc._canvas.height;this._openGLView=a||cc.view;a=cc.configuration;a.gatherGPUInfo();a.dumpInfo();this._createStatsLabel();this.setGLDefaultValues();cc.eventManager&&cc.eventManager.setEnabled(!0)};a._clear=function(){var a=cc._renderContext;a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT)};a._beforeVisitScene=function(){cc.kmGLPushMatrix()};a._afterVisitScene=function(){cc.kmGLPopMatrix()};
a._createStatsLabel=function(){if(!cc.LabelAtlas)this._createStatsLabelForCanvas();else if(null!=cc.Director._fpsImageLoaded&&!1!==cc.Director._fpsImageLoaded){var a=new cc.Texture2D;a.initWithElement(cc.Director._fpsImage);a.handleLoadedTexture();var b=cc.view.getDesignResolutionSize().height/320;0===b&&(b=this._winSizeInPoints.height/320);var d=new cc.LabelAtlas;d._setIgnoreContentScaleFactor(!0);d.initWithString("00.0",a,12,32,".");d.scale=b;this._FPSLabel=d;d=new cc.LabelAtlas;d._setIgnoreContentScaleFactor(!0);
d.initWithString("0.000",a,12,32,".");d.scale=b;this._SPFLabel=d;d=new cc.LabelAtlas;d._setIgnoreContentScaleFactor(!0);d.initWithString("000",a,12,32,".");d.scale=b;this._drawsLabel=d;a=cc.DIRECTOR_STATS_POSITION;this._drawsLabel.setPosition(a.x,34*b+a.y);this._SPFLabel.setPosition(a.x,17*b+a.y);this._FPSLabel.setPosition(a)}};a._createStatsLabelForCanvas=function(){var a=0,a=this._winSizeInPoints.width>this._winSizeInPoints.height?0|this._winSizeInPoints.height/320*24:0|this._winSizeInPoints.width/
320*24;this._FPSLabel=new cc.LabelTTF("000.0","Arial",a);this._SPFLabel=new cc.LabelTTF("0.000","Arial",a);this._drawsLabel=new cc.LabelTTF("0000","Arial",a);a=cc.DIRECTOR_STATS_POSITION;this._drawsLabel.setPosition(this._drawsLabel.width/2+a.x,5*this._drawsLabel.height/2+a.y);this._SPFLabel.setPosition(this._SPFLabel.width/2+a.x,3*this._SPFLabel.height/2+a.y);this._FPSLabel.setPosition(this._FPSLabel.width/2+a.x,this._FPSLabel.height/2+a.y)};a.convertToGL=function(a){var b=new cc.math.Matrix4;cc.GLToClipTransform(b);
var d=b.inverse(),b=b.mat[14]/b.mat[15],e=this._openGLView.getDesignResolutionSize();a=new cc.math.Vec3(2*a.x/e.width-1,1-2*a.y/e.height,b);a.transformCoord(d);return cc.p(a.x,a.y)};a.convertToUI=function(a){var b=new cc.math.Matrix4;cc.GLToClipTransform(b);a=new cc.math.Vec3(a.x,a.y,0);a.transformCoord(b);b=this._openGLView.getDesignResolutionSize();return cc.p(b.width*(0.5*a.x+0.5),b.height*(0.5*-a.y+0.5))};a.getVisibleSize=function(){return this._openGLView.getVisibleSize()};a.getVisibleOrigin=
function(){return this._openGLView.getVisibleOrigin()};a.getZEye=function(){return this._winSizeInPoints.height/1.1566};a.setViewport=function(){var a=this._openGLView;if(a){var b=this._winSizeInPoints;a.setViewPortInPoints(-a._viewPortRect.x/a._scaleX,-a._viewPortRect.y/a._scaleY,b.width,b.height)}};a.getOpenGLView=function(){return this._openGLView};a.getProjection=function(){return this._projection};a.setAlphaBlending=function(a){a?cc.glBlendFunc(cc.BLEND_SRC,cc.BLEND_DST):cc.glBlendFunc(cc._renderContext.ONE,
...
schedule:function(a,c,b,d,e,f,g){var h=!1;if("function"!==typeof a)var k=a,h=!0;!1===h?5===arguments.length&&(g=e,f=d,e=0,d=cc.REPEAT_FOREVER):4===arguments.length&&(f=d,d=cc.REPEAT_FOREVER,e=0);cc.assert(c,cc._LogInfos.Scheduler_scheduleCallbackForTarget_3);!1===h&&cc.assert(g,"key should not be empty!");var m=this._hashForTimers[c.__instanceId];m?cc.assert(m.paused===f,""):(m=new cc.HashTimerEntry(null,c,0,null,null,f,null),this._arrayForTimers.push(m),this._hashForTimers[c.__instanceId]=m);var p,
n;if(null==m.timers)m.timers=[];else if(!1===h)for(n=0;n<m.timers.length;n++){if(p=m.timers[n],a===p._callback){cc.log(cc._LogInfos.Scheduler_scheduleCallbackForTarget,p.getInterval().toFixed(4),b.toFixed(4));p._interval=b;return}}else for(n=0;n<m.timers.length;++n)if((p=m.timers[n])&&k===p.getSelector()){cc.log("CCScheduler#scheduleSelector. Selector already scheduled. Updating interval from: %.4f to %.4f",p.getInterval(),b);p.setInterval(b);return}!1===h?(p=new cc.TimerTargetCallback,p.initWithCallback(this,
a,c,g,b,d,e)):(p=new cc.TimerTargetSelector,p.initWithSelector(this,k,c,b,d,e));m.timers.push(p)},scheduleUpdate:function(a,c,b){this._schedulePerFrame(function(b){a.update(b)},a,c,b)},_getUnscheduleMark:function(a,c){switch(typeof a){case "number":case "string":return a===c.getKey();case "function":return a===c._callback;default:return a===c.getSelector()}},unschedule:function(a,c){if(c&&a){var b=this._hashForTimers[c.__instanceId];if(b)for(var d=b.timers,e=0,f=d.length;e<f;e++){var g=d[e];if(this._getUnscheduleMark(a,
g)){g!==b.currentTimer||b.currentTimerSalvaged||(b.currentTimerSalvaged=!0);d.splice(e,1);b.timerIndex>=e&&b.timerIndex--;0===d.length&&(this._currentTarget===b?this._currentTargetSalvaged=!0:this._removeHashElement(b));break}}}},unscheduleUpdate:function(a){null!=a&&(a=this._hashForUpdates[a.__instanceId])&&(this._updateHashLocked?a.entry.markedForDeletion=!0:this._removeUpdateFromHash(a.entry))},unscheduleAllForTarget:function(a){if(null!=a){var c=this._hashForTimers[a.__instanceId];c&&(-1<c.timers.indexOf(c.currentTimer)&&
!c.currentTimerSalvaged&&(c.currentTimerSalvaged=!0),c.timers.length=0,this._currentTarget===c?this._currentTargetSalvaged=!0:this._removeHashElement(c));this.unscheduleUpdate(a)}},unscheduleAll:function(){this.unscheduleAllWithMinPriority(cc.Scheduler.PRIORITY_SYSTEM)},unscheduleAllWithMinPriority:function(a){var c,b,d=this._arrayForTimers;for(c=d.length-1;0<=c;c--)b=d[c],this.unscheduleAllForTarget(b.target);d=0;if(0>a)for(c=0;c<this._updatesNegList.length;)d=this._updatesNegList.length,(b=this._updatesNegList[c])&&
...
cc.assert(c,"Argument target must be non-nullptr");var b=this._hashForUpdates[c.__instanceId];if(!b)return!1;if(null!=b.timers)for(var b=b.timers,d=0;d<b.length;++d)if(a===b[d].getKey())return!0;return!1},pauseAllTargets:function(){return this.pauseAllTargetsWithMinPriority(cc.Scheduler.PRIORITY_SYSTEM)},pauseAllTargetsWithMinPriority:function(a){var c=[],b,d=this._arrayForTimers,e,f;e=0;for(f=d.length;e<f;e++)if(b=d[e])b.paused=!0,c.push(b.target);if(0>a)for(e=0;e<this._updatesNegList.length;e++)(b=
this._updatesNegList[e])&&b.priority>=a&&(b.paused=!0,c.push(b.target));if(0>=a)for(e=0;e<this._updates0List.length;e++)if(b=this._updates0List[e])b.paused=!0,c.push(b.target);for(e=0;e<this._updatesPosList.length;e++)(b=this._updatesPosList[e])&&b.priority>=a&&(b.paused=!0,c.push(b.target));return c},resumeTargets:function(a){if(a)for(var c=0;c<a.length;c++)this.resumeTarget(a[c])},pauseTarget:function(a){cc.assert(a,cc._LogInfos.Scheduler_pauseTarget);var c=this._hashForTimers[a.__instanceId];c&&
(c.paused=!0);if(a=this._hashForUpdates[a.__instanceId])a.entry.paused=!0},resumeTarget:function(a){cc.assert(a,cc._LogInfos.Scheduler_resumeTarget);var c=this._hashForTimers[a.__instanceId];c&&(c.paused=!1);if(a=this._hashForUpdates[a.__instanceId])a.entry.paused=!1},isTargetPaused:function(a){cc.assert(a,cc._LogInfos.Scheduler_isTargetPaused);var c=this._hashForTimers[a.__instanceId];return c?c.paused:(a=this._hashForUpdates[a.__instanceId])?a.entry.paused:!1},scheduleUpdateForTarget:function(a,
...
this._colorArray);this._shader.setUniformLocationWith1f(this._pointSizeLocation,this._pointSize);var b=c.createBuffer();c.bindBuffer(c.ARRAY_BUFFER,b);c.bufferData(c.ARRAY_BUFFER,new Float32Array([a.x,a.y]),c.STATIC_DRAW);c.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,c.FLOAT,!1,0,0);c.drawArrays(c.POINTS,0,1);c.deleteBuffer(b);cc.incrementGLDraws(1)},drawPoints:function(a,c){if(a&&0!==a.length){this.lazy_init();var b=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();
cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);b.uniform4fv(this._colorLocation,this._colorArray);this._shader.setUniformLocationWith1f(this._pointSizeLocation,this._pointSize);var d=b.createBuffer();b.bindBuffer(b.ARRAY_BUFFER,d);b.bufferData(b.ARRAY_BUFFER,this._pointsToTypeArray(a),b.STATIC_DRAW);b.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,b.FLOAT,!1,0,0);b.drawArrays(b.POINTS,0,a.length);b.deleteBuffer(d);cc.incrementGLDraws(1)}},_pointsToTypeArray:function(a){for(var c=new Float32Array(2*
a.length),b=0;b<a.length;b++)c[2*b]=a[b].x,c[2*b+1]=a[b].y;return c},drawLine:function(a,c){this.lazy_init();var b=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);b.uniform4fv(this._colorLocation,this._colorArray);var d=b.createBuffer();b.bindBuffer(b.ARRAY_BUFFER,d);b.bufferData(b.ARRAY_BUFFER,this._pointsToTypeArray([a,c]),b.STATIC_DRAW);b.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,
2,b.FLOAT,!1,0,0);b.drawArrays(b.LINES,0,2);b.deleteBuffer(d);cc.incrementGLDraws(1)},drawRect:function(a,c){this.drawLine(cc.p(a.x,a.y),cc.p(c.x,a.y));this.drawLine(cc.p(c.x,a.y),cc.p(c.x,c.y));this.drawLine(cc.p(c.x,c.y),cc.p(a.x,c.y));this.drawLine(cc.p(a.x,c.y),cc.p(a.x,a.y))},drawSolidRect:function(a,c,b){a=[a,cc.p(c.x,a.y),c,cc.p(a.x,c.y)];this.drawSolidPoly(a,4,b)},drawPoly:function(a,c,b){this.lazy_init();c=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();
cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);c.uniform4fv(this._colorLocation,this._colorArray);var d=c.createBuffer();c.bindBuffer(c.ARRAY_BUFFER,d);c.bufferData(c.ARRAY_BUFFER,this._pointsToTypeArray(a),c.STATIC_DRAW);c.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,c.FLOAT,!1,0,0);b?c.drawArrays(c.LINE_LOOP,0,a.length):c.drawArrays(c.LINE_STRIP,0,a.length);c.deleteBuffer(d);cc.incrementGLDraws(1)},drawSolidPoly:function(a,c,b){this.lazy_init();b&&this.setDrawColor(b.r,b.g,b.b,b.a);
c=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);c.uniform4fv(this._colorLocation,this._colorArray);b=c.createBuffer();c.bindBuffer(c.ARRAY_BUFFER,b);c.bufferData(c.ARRAY_BUFFER,this._pointsToTypeArray(a),c.STATIC_DRAW);c.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,c.FLOAT,!1,0,0);c.drawArrays(c.TRIANGLE_FAN,0,a.length);c.deleteBuffer(b);cc.incrementGLDraws(1)},drawCircle:function(a,
c,b,d,e){this.lazy_init();var f=1;e&&f++;var g=2*Math.PI/d;if(e=new Float32Array(2*(d+2))){for(var h=0;h<=d;h++){var k=h*g,m=c*Math.cos(k+b)+a.x,k=c*Math.sin(k+b)+a.y;e[2*h]=m;e[2*h+1]=k}e[2*(d+1)]=a.x;e[2*(d+1)+1]=a.y;a=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);a.uniform4fv(this._colorLocation,this._colorArray);c=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,c);a.bufferData(a.ARRAY_BUFFER,
e,a.STATIC_DRAW);a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,a.FLOAT,!1,0,0);a.drawArrays(a.LINE_STRIP,0,d+f);a.deleteBuffer(c);cc.incrementGLDraws(1)}},drawQuadBezier:function(a,c,b,d){this.lazy_init();for(var e=new Float32Array(2*(d+1)),f=0,g=0;g<d;g++)e[2*g]=Math.pow(1-f,2)*a.x+2*(1-f)*f*c.x+f*f*b.x,e[2*g+1]=Math.pow(1-f,2)*a.y+2*(1-f)*f*c.y+f*f*b.y,f+=1/d;e[2*d]=b.x;e[2*d+1]=b.y;a=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);
a.uniform4fv(this._colorLocation,this._colorArray);c=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,c);a.bufferData(a.ARRAY_BUFFER,e,a.STATIC_DRAW);a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,a.FLOAT,!1,0,0);a.drawArrays(a.LINE_STRIP,0,d+1);a.deleteBuffer(c);cc.incrementGLDraws(1)},drawCubicBezier:function(a,c,b,d,e){this.lazy_init();for(var f=new Float32Array(2*(e+1)),g=0,h=0;h<e;h++)f[2*h]=Math.pow(1-g,3)*a.x+3*Math.pow(1-g,2)*g*c.x+3*(1-g)*g*g*b.x+g*g*g*d.x,f[2*h+1]=Math.pow(1-g,3)*a.y+3*Math.pow(1-
g,2)*g*c.y+3*(1-g)*g*g*b.y+g*g*g*d.y,g+=1/e;f[2*e]=d.x;f[2*e+1]=d.y;a=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);a.uniform4fv(this._colorLocation,this._colorArray);c=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,c);a.bufferData(a.ARRAY_BUFFER,f,a.STATIC_DRAW);a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,a.FLOAT,!1,0,0);a.drawArrays(a.LINE_STRIP,0,e+1);a.deleteBuffer(c);cc.incrementGLDraws(1)},
drawCatmullRom:function(a,c){this.drawCardinalSpline(a,0.5,c)},drawCardinalSpline:function(a,c,b){this.lazy_init();for(var d=new Float32Array(2*(b+1)),e,f,g=1/a.length,h=0;h<b+1;h++)f=h/b,1===f?(e=a.length-1,f=1):(e=0|f/g,f=(f-g*e)/g),e=cc.cardinalSplineAt(cc.getControlPointAt(a,e-1),cc.getControlPointAt(a,e),cc.getControlPointAt(a,e+1),cc.getControlPointAt(a,e+2),c,f),d[2*h]=e.x,d[2*h+1]=e.y;a=this._renderContext;this._shader.use();this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();
cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION);a.uniform4fv(this._colorLocation,this._colorArray);c=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,c);a.bufferData(a.ARRAY_BUFFER,d,a.STATIC_DRAW);a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,a.FLOAT,!1,0,0);a.drawArrays(a.LINE_STRIP,0,b+1);a.deleteBuffer(c);cc.incrementGLDraws(1)},setDrawColor:function(a,c,b,d){this._colorArray[0]=a/255;this._colorArray[1]=c/255;this._colorArray[2]=b/255;this._colorArray[3]=d/255},setPointSize:function(a){this._pointSize=
...
function(a){if(a){var b=this._node,d=b._strokeShadowOffsetX,e=b._strokeShadowOffsetY,f=b._contentSize.height-e,g=b._vAlignment,h=b._hAlignment,k=b._strokeSize;a.setTransform(1,0,0,1,0.5*d,f+0.5*e);a.font!==this._fontStyleStr&&(a.font=this._fontStyleStr);a.fillStyle=this._fillColorStr;var m=e=0,p=b._strokeEnabled;p&&(a.lineWidth=2*k,a.strokeStyle=this._strokeColorStr);b._shadowEnabled&&(k=b._shadowOffset,a.shadowColor=this._shadowColorStr,a.shadowOffsetX=k.x,a.shadowOffsetY=-k.y,a.shadowBlur=b._shadowBlur);
a.textBaseline=cc.LabelTTF._textBaseline[g];a.textAlign=cc.LabelTTF._textAlign[h];var n=b._contentSize.width-d,d=b.getLineHeight(),k=(d-this._fontClientHeight)/2,e=h===cc.TEXT_ALIGNMENT_RIGHT?e+n:h===cc.TEXT_ALIGNMENT_CENTER?e+n/2:e+0;if(this._isMultiLine)for(b=this._strings.length,g===cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM?m=d-2*k+f-d*b:g===cc.VERTICAL_TEXT_ALIGNMENT_CENTER&&(m=(d-2*k)/2+(f-d*b)/2),g=0;g<b;g++)h=this._strings[g],n=-f+(d*g+k)+m,p&&a.strokeText(h,e,n),a.fillText(h,e,n);else g!==cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM&&
(m=g===cc.VERTICAL_TEXT_ALIGNMENT_TOP?m-f:m-0.5*f),p&&a.strokeText(b._string,e,m),a.fillText(b._string,e,m)}};a._checkWarp=function(a,b,d){var e=a[b],f=this._measure(e);if(f>d&&1<e.length){for(var g=d/f*e.length|0,h=e.substr(g),k=f-this._measure(h),m,p=0,n=0;k>d&&100>n++;)g*=d/k,g|=0,h=e.substr(g),k=f-this._measure(h);for(n=0;k<d&&100>n++;)h&&(p=(m=cc.LabelTTF._wordRex.exec(h))?m[0].length:1,m=h),g+=p,h=e.substr(g),k=f-this._measure(h);g-=p;0===g&&(g=1,m=m.substr(1));d=e.substr(0,g);cc.LabelTTF.wrapInspection&&
cc.LabelTTF._symbolRex.test(m||h)&&(f=cc.LabelTTF._lastWordRex.exec(d),g-=f?f[0].length:0,m=e.substr(g),d=e.substr(0,g));cc.LabelTTF._firsrEnglish.test(m)&&(f=cc.LabelTTF._lastEnglish.exec(d))&&d!==f[0]&&(g-=f[0].length,m=e.substr(g),d=e.substr(0,g));a[b]=m||h;a.splice(b,0,d)}}})();
...
this._fillColorStr="rgba("+(0|g*f.r)+","+(0|h*f.g)+","+(0|a*f.b)+", 1)";this._strokeColorStr="rgba("+(0|g*e.r)+","+(0|h*e.g)+","+(0|a*e.b)+", 1)"};a._updateColor=function(){this._setColorsString();this._updateTexture()}})();(function(){cc.LabelTTF.WebGLRenderCmd=function(a){cc.Sprite.WebGLRenderCmd.call(this,a);cc.LabelTTF.RenderCmd.call(this);this.setShaderProgram(cc.shaderCache.programForKey(cc.LabelTTF._SHADER_PROGRAM))};var a=cc.LabelTTF.WebGLRenderCmd.prototype=Object.create(cc.Sprite.WebGLRenderCmd.prototype);cc.inject(cc.LabelTTF.RenderCmd.prototype,a);a.constructor=cc.LabelTTF.WebGLRenderCmd;a._setColorsString=function(){this.setDirtyFlag(cc.Node._dirtyFlags.textDirty);var a=this._node,b=a._strokeColor,d=a._textFillColor,
e=a._shadowColor||this._displayedColor;this._shadowColorStr="rgba("+(0|e.r)+","+(0|e.g)+","+(0|e.b)+","+a._shadowOpacity+")";this._fillColorStr="rgba("+(0|d.r)+","+(0|d.g)+","+(0|d.b)+", 1)";this._strokeColorStr="rgba("+(0|b.r)+","+(0|b.g)+","+(0|b.b)+", 1)"};a.updateStatus=function(){var a=cc.Node._dirtyFlags,b=this._dirtyFlag,d=b&a.colorDirty,e=b&a.opacityDirty;d&&this._updateDisplayColor();e&&this._updateDisplayOpacity();d||e?(this._setColorsString(),this._updateColor(),this._updateTexture()):
b&a.textDirty&&this._updateTexture();this._dirtyFlag&a.transformDirty&&(this.transform(this.getParentRenderCmd(),!0),this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.transformDirty)};a._syncStatus=function(a){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,e=a?a._node:null;e&&e._cascadeColorEnabled&&a._dirtyFlag&b.colorDirty&&(d|=b.colorDirty);e&&e._cascadeOpacityEnabled&&a._dirtyFlag&b.opacityDirty&&(d|=b.opacityDirty);a&&a._dirtyFlag&b.transformDirty&&(d|=b.transformDirty);var e=d&b.colorDirty,
f=d&b.opacityDirty;this._dirtyFlag=d;e&&this._syncDisplayColor();f&&this._syncDisplayOpacity();e||f?(this._setColorsString(),this._updateColor(),this._updateTexture()):d&b.textDirty&&this._updateTexture();this.transform(a)}})();cc.HashElement=cc.Class.extend({actions:null,target:null,actionIndex:0,currentAction:null,currentActionSalvaged:!1,paused:!1,hh:null,ctor:function(){this.actions=[];this.target=null;this.actionIndex=0;this.currentAction=null;this.paused=this.currentActionSalvaged=!1;this.hh=null}});
cc.ActionManager=cc.Class.extend({_hashTargets:null,_arrayTargets:null,_currentTarget:null,_currentTargetSalvaged:!1,_searchElementByTarget:function(a,c){for(var b=0;b<a.length;b++)if(c===a[b].target)return a[b];return null},ctor:function(){this._hashTargets={};this._arrayTargets=[];this._currentTarget=null;this._currentTargetSalvaged=!1},addAction:function(a,c,b){if(!a)throw Error("cc.ActionManager.addAction(): action must be non-null");if(!c)throw Error("cc.ActionManager.addAction(): action must be non-null");
var d=this._hashTargets[c.__instanceId];d||(d=new cc.HashElement,d.paused=b,d.target=c,this._hashTargets[c.__instanceId]=d,this._arrayTargets.push(d));this._actionAllocWithHashElement(d);d.actions.push(a);a.startWithTarget(c)},removeAllActions:function(){for(var a=this._arrayTargets,c=0;c<a.length;c++){var b=a[c];b&&this.removeAllActionsFromTarget(b.target,!0)}},removeAllActionsFromTarget:function(a,c){if(null!=a){var b=this._hashTargets[a.__instanceId];b&&(-1===b.actions.indexOf(b.currentAction)||
b.currentActionSalvaged||(b.currentActionSalvaged=!0),b.actions.length=0,this._currentTarget!==b||c?this._deleteHashElement(b):this._currentTargetSalvaged=!0)}},removeAction:function(a){if(null!=a){var c=a.getOriginalTarget();if(c=this._hashTargets[c.__instanceId])for(var b=0;b<c.actions.length;b++){if(c.actions[b]===a){c.actions.splice(b,1);break}}else cc.log(cc._LogInfos.ActionManager_removeAction)}},removeActionByTag:function(a,c){a===cc.ACTION_TAG_INVALID&&cc.log(cc._LogInfos.ActionManager_addAction);
cc.assert(c,cc._LogInfos.ActionManager_addAction);var b=this._hashTargets[c.__instanceId];if(b)for(var d=b.actions.length,e=0;e<d;++e){var f=b.actions[e];if(f&&f.getTag()===a&&f.getOriginalTarget()===c){this._removeActionAtIndex(e,b);break}}},getActionByTag:function(a,c){a===cc.ACTION_TAG_INVALID&&cc.log(cc._LogInfos.ActionManager_getActionByTag);var b=this._hashTargets[c.__instanceId];if(b){if(null!=b.actions)for(var d=0;d<b.actions.length;++d){var e=b.actions[d];if(e&&e.getTag()===a)return e}cc.log(cc._LogInfos.ActionManager_getActionByTag_2,
a)}return null},numberOfRunningActionsInTarget:function(a){return(a=this._hashTargets[a.__instanceId])?a.actions?a.actions.length:0:0},pauseTarget:function(a){if(a=this._hashTargets[a.__instanceId])a.paused=!0},resumeTarget:function(a){if(a=this._hashTargets[a.__instanceId])a.paused=!1},pauseAllRunningActions:function(){for(var a=[],c=this._arrayTargets,b=0;b<c.length;b++){var d=c[b];d&&!d.paused&&(d.paused=!0,a.push(d.target))}return a},resumeTargets:function(a){if(a)for(var c=0;c<a.length;c++)a[c]&&
...
cc.arrayRemoveObject(this._arrayTargets,a),c=!0),a.actions=null,a.target=null);return c},_actionAllocWithHashElement:function(a){null==a.actions&&(a.actions=[])},update:function(a){for(var c=this._arrayTargets,b,d=0;d<c.length;d++){b=this._currentTarget=c[d];if(!b.paused)for(b.actionIndex=0;b.actionIndex<(b.actions?b.actions.length:0);b.actionIndex++)if(b.currentAction=b.actions[b.actionIndex],b.currentAction){b.currentActionSalvaged=!1;b.currentAction.step(a*(b.currentAction._speedMethod?b.currentAction._speed:
1));if(b.currentActionSalvaged)b.currentAction=null;else if(b.currentAction.isDone()){b.currentAction.stop();var e=b.currentAction;b.currentAction=null;this.removeAction(e)}b.currentAction=null}this._currentTargetSalvaged&&0===b.actions.length&&this._deleteHashElement(b)&&d--}}});(function(){var a=cc.sys,c={common:{multichannel:!0,webAudio:cc.sys._supportWebAudio,auto:!0}};c[a.BROWSER_TYPE_IE]={multichannel:!0,webAudio:cc.sys._supportWebAudio,auto:!0,emptied:!0};c[a.BROWSER_TYPE_ANDROID]={multichannel:!1,webAudio:!1,auto:!1};c[a.BROWSER_TYPE_CHROME]={multichannel:!0,webAudio:!0,auto:!1};c[a.BROWSER_TYPE_FIREFOX]={multichannel:!0,webAudio:!0,auto:!0,delay:!0};c[a.BROWSER_TYPE_UC]={multichannel:!0,webAudio:!1,auto:!1};c[a.BROWSER_TYPE_QQ]={multichannel:!1,webAudio:!1,auto:!0};
c[a.BROWSER_TYPE_OUPENG]={multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_WECHAT]={multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_360]={multichannel:!1,webAudio:!1,auto:!0};c[a.BROWSER_TYPE_MIUI]={multichannel:!1,webAudio:!1,auto:!0};c[a.BROWSER_TYPE_LIEBAO]={multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_SOUGOU]={multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_BAIDU]={multichannel:!1,webAudio:!1,
auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_BAIDU_APP]={multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_SAFARI]={multichannel:!0,webAudio:!0,auto:!1,webAudioCallback:function(a){document.createElement("audio").src=a}};var b,d;try{var e=navigator.userAgent.toLowerCase();switch(a.browserType){case a.BROWSER_TYPE_IE:d=e.match(/(msie |rv:)([\d.]+)/);break;case a.BROWSER_TYPE_FIREFOX:d=e.match(/(firefox\/|rv:)([\d.]+)/);break;case a.BROWSER_TYPE_CHROME:d=e.match(/chrome\/([\d.]+)/);
break;case a.BROWSER_TYPE_BAIDU:d=e.match(/baidubrowser\/([\d.]+)/);break;case a.BROWSER_TYPE_UC:d=e.match(/ucbrowser\/([\d.]+)/);break;case a.BROWSER_TYPE_QQ:d=e.match(/qqbrowser\/([\d.]+)/);break;case a.BROWSER_TYPE_OUPENG:d=e.match(/oupeng\/([\d.]+)/);break;case a.BROWSER_TYPE_WECHAT:d=e.match(/micromessenger\/([\d.]+)/);break;case a.BROWSER_TYPE_SAFARI:d=e.match(/safari\/([\d.]+)/);break;case a.BROWSER_TYPE_MIUI:d=e.match(/miuibrowser\/([\d.]+)/)}b=d?d[1]:""}catch(f){console.log(f)}if(cc.sys.isMobile)cc.__audioSupport=
cc.sys.os!==cc.sys.OS_IOS?c[a.browserType]||c.common:c[a.BROWSER_TYPE_SAFARI];else switch(a.browserType){case a.BROWSER_TYPE_IE:cc.__audioSupport=c[a.BROWSER_TYPE_IE];break;case a.BROWSER_TYPE_FIREFOX:cc.__audioSupport=c[a.BROWSER_TYPE_FIREFOX];break;default:cc.__audioSupport=c.common}if(b)switch(a.browserType){case a.BROWSER_TYPE_CHROME:b=parseInt(b);30>b?cc.__audioSupport={multichannel:!1,webAudio:!0,auto:!1}:42===b&&(cc.__audioSupport.manualLoop=!0);break;case a.BROWSER_TYPE_MIUI:cc.sys.isMobile&&
(b=b.match(/\d+/g),2>b[0]||2===b[0]&&0===b[1]&&1>=b[2])&&(cc.__audioSupport.auto=!1)}})();
cc.Audio=cc.Class.extend({volume:1,loop:!1,src:null,_touch:!1,_playing:!1,_AUDIO_TYPE:"AUDIO",_pause:!1,_buffer:null,_currentSource:null,_startTime:null,_currentTime:null,_context:null,_volume:null,_ignoreEnded:!1,_manualLoop:!1,_element:null,ctor:function(a,c,b){a&&(this._context=a);c&&(this._volume=c);a&&c&&(this._AUDIO_TYPE="WEBAUDIO");this.src=b},_setBufferCallback:null,setBuffer:function(a){if(a){var c=this._playing;this._AUDIO_TYPE="WEBAUDIO";this._buffer&&this._buffer!==a&&this.getPlaying()&&
this.stop();this._buffer=a;c&&this.play();this._volume.gain.value=this.volume;this._setBufferCallback&&this._setBufferCallback(a)}},_setElementCallback:null,setElement:function(a){if(a){var c=this._playing;this._AUDIO_TYPE="AUDIO";this._element&&this._element!==a&&this.getPlaying()&&this.stop();this._element=a;c&&this.play();a.volume=this.volume;a.loop=this.loop;this._setElementCallback&&this._setElementCallback(a)}},play:function(a,c){this._playing=!0;this.loop=void 0===c?this.loop:c;"AUDIO"===this._AUDIO_TYPE?
this._playOfAudio(a):this._playOfWebAudio(a)},getPlaying:function(){if(!this._playing)return!1;if("AUDIO"===this._AUDIO_TYPE){var a=this._element;return!a||this._pause||a.ended?this._playing=!1:!0}return(a=this._currentSource)&&a.playbackState?this._currentTime+this._context.currentTime-this._startTime<a.buffer.duration:!0},_playOfWebAudio:function(a){var c=this._currentSource;if(this._buffer){if(!this._pause&&c)if(0===this._context.currentTime||this._currentTime+this._context.currentTime-this._startTime>
c.buffer.duration)this._stopOfWebAudio();else return;c=this._context.createBufferSource();c.buffer=this._buffer;c.connect(this._volume);c.loop=this._manualLoop?!1:this.loop;this._startTime=this._context.currentTime;this._currentTime=a||0;this._ignoreEnded=!1;if(c.start)c.start(0,a||0);else if(c.noteGrainOn){var b=c.buffer.duration;this.loop?c.noteGrainOn(0,a,b):c.noteGrainOn(0,a,b-a)}else c.noteOn(0);this._currentSource=c;var d=this;c.onended=function(){d._manualLoop&&d._playing&&d.loop?(d.stop(),
...
a&&(this._startTime=this._context.currentTime,this._playOfWebAudio(this._currentTime%a.buffer.duration))},_resumeOfAudio:function(){var a=this._element;a&&a.play()},setVolume:function(a){1<a&&(a=1);0>a&&(a=0);this.volume=a;"AUDIO"===this._AUDIO_TYPE?this._element&&(this._element.volume=a):this._volume&&(this._volume.gain.value=a)},getVolume:function(){return this.volume},cloneNode:function(){var a,c;if("AUDIO"===this._AUDIO_TYPE){a=new cc.Audio;var b=document.createElement("audio");b.src=this.src;
a.setElement(b)}else b=this._context.createGain(),b.gain.value=1,b.connect(this._context.destination),a=new cc.Audio(this._context,b,this.src),this._buffer?a.setBuffer(this._buffer):(c=this,this._setBufferCallback=function(b){a.setBuffer(b);c._setBufferCallback=null}),a._manualLoop=this._manualLoop;a._AUDIO_TYPE=this._AUDIO_TYPE;return a}});
(function(a){var c=a.webAudio,b=a.multichannel,d=a.auto,e=[];(function(){var a=document.createElement("audio");if(a.canPlayType){var b=a.canPlayType('audio/ogg; codecs\x3d"vorbis"');b&&""!==b&&e.push(".ogg");(b=a.canPlayType("audio/mpeg"))&&""!==b&&e.push(".mp3");(b=a.canPlayType('audio/wav; codecs\x3d"1"'))&&""!==b&&e.push(".wav");(b=a.canPlayType("audio/mp4"))&&""!==b&&e.push(".mp4");(a=a.canPlayType("audio/x-m4a"))&&""!==a&&e.push(".m4a")}})();try{if(c){var f=new (window.AudioContext||window.webkitAudioContext||
window.mozAudioContext);a.delay&&setTimeout(function(){f=new (window.AudioContext||window.webkitAudioContext||window.mozAudioContext)},0)}}catch(g){c=!1,cc.log("browser don't support webAudio")}var h={cache:{},load:function(b,d,g,k){if(0===e.length)return k("can not support audio!");cc.loader.audioPath&&(b=cc.path.join(cc.loader.audioPath,b));var r=cc.path.extname(b),t=[r];for(g=0;g<e.length;g++)r!==e[g]&&t.push(e[g]);var q;if(h.cache[d])return k(null,h.cache[d]);if(c)try{var u=f.createGain();u.gain.value=
1;u.connect(f.destination);q=new cc.Audio(f,u,b);a.manualLoop&&(q._manualLoop=!0)}catch(v){c=!1,cc.log("browser don't support webAudio"),q=new cc.Audio(null,null,b)}else q=new cc.Audio(null,null,b);this.loadAudioFromExtList(b,t,q,k);h.cache[d]=q},loadAudioFromExtList:function(b,d,g,k){if(0===d.length){var r="can not found the resource of audio! Last match url is : ",r=r+b.replace(/\.(.*)?$/,"(");e.forEach(function(a){r+=a+"|"});r=r.replace(/\|$/,")");return k({status:520,errorMessage:r},null)}b=cc.path.changeExtname(b,
d.splice(0,1));if(c){a.webAudioCallback&&a.webAudioCallback(b);var t=new XMLHttpRequest;t.open("GET",b,!0);t.responseType="arraybuffer";t.onload=function(){f.decodeAudioData(t.response,function(a){g.setBuffer(a);k(null,g)},function(){h.loadAudioFromExtList(b,d,g,k)})};t.onerror=function(){k({status:520,errorMessage:r},null)};t.send()}else{var q=document.createElement("audio"),u=!1,v=!1,z=setTimeout(function(){0===q.readyState?x():(v=!0,q.pause(),document.body.removeChild(q),k("audio load timeout : "+
b,g))},1E4),w=function(){if(!u){q.pause();try{q.currentTime=0,q.volume=1}catch(a){}document.body.removeChild(q);g.setElement(q);q.removeEventListener("canplaythrough",w,!1);q.removeEventListener("error",y,!1);q.removeEventListener("emptied",x,!1);!v&&k(null,g);u=!0;clearTimeout(z)}},y=function(){u&&(q.pause(),document.body.removeChild(q),q.removeEventListener("canplaythrough",w,!1),q.removeEventListener("error",y,!1),q.removeEventListener("emptied",x,!1),!v&&h.loadAudioFromExtList(b,d,g,k),u=!0,clearTimeout(z))},
x=function(){v=!0;w();k(null,g)};cc._addEventListener(q,"canplaythrough",w,!1);cc._addEventListener(q,"error",y,!1);a.emptied&&cc._addEventListener(q,"emptied",x,!1);q.src=b;document.body.appendChild(q);q.volume=0;q.play()}}};cc.loader.register(["mp3","ogg","wav","mp4","m4a"],h);cc.audioEngine={_currMusic:null,_musicVolume:1,willPlayMusic:function(){return!1},playMusic:function(a,b){var c=this._currMusic;c&&c.src!==a&&c.getPlaying()&&c.stop();c=h.cache[a];c||(cc.loader.load(a),c=h.cache[a]);c.play(0,
b);c.setVolume(this._musicVolume);this._currMusic=c},stopMusic:function(a){var b=this._currMusic;b&&(b.stop(),a&&cc.loader.release(b.src))},pauseMusic:function(){var a=this._currMusic;a&&a.pause()},resumeMusic:function(){var a=this._currMusic;a&&a.resume()},rewindMusic:function(){var a=this._currMusic;a&&(a.stop(),a.play())},getMusicVolume:function(){return this._musicVolume},setMusicVolume:function(a){a-=0;isNaN(a)&&(a=1);1<a&&(a=1);0>a&&(a=0);this._musicVolume=a;var b=this._currMusic;b&&b.setVolume(a)},
isMusicPlaying:function(){var a=this._currMusic;return a?a.getPlaying():!1},_audioPool:{},_maxAudioInstance:5,_effectVolume:1,playEffect:function(a,d){if(!b)return null;var e=this._audioPool[a];e||(e=this._audioPool[a]=[]);var f;for(f=0;f<e.length&&e[f].getPlaying();f++);if(e[f])g=e[f],g.setVolume(this._effectVolume),g.play(0,d);else if(!c&&f>this._maxAudioInstance)cc.log("Error: %s greater than %d",a,this._maxAudioInstance);else{var g=h.cache[a];g||(cc.loader.load(a),g=h.cache[a]);g=g.cloneNode();
...
resumeEffect:function(a){a&&a.resume()},resumeAllEffects:function(){var a=this._audioPool,b;for(b in a)for(var c=a[b],d=0;d<a[b].length;d++)c[d].resume()},stopEffect:function(a){a&&a.stop()},stopAllEffects:function(){var a=this._audioPool,b;for(b in a)for(var c=a[b],d=0;d<a[b].length;d++)c[d].stop()},unloadEffect:function(a){if(a){cc.loader.release(a);var b=this._audioPool[a];b&&(b.length=0);delete this._audioPool[a];delete h.cache[a]}},end:function(){this.stopMusic();this.stopAllEffects()},_pauseCache:[],
_pausePlaying:function(){var a=this._currMusic;a&&a.getPlaying()&&(a.pause(),this._pauseCache.push(a));var a=this._audioPool,b;for(b in a)for(var c=a[b],d=0;d<a[b].length;d++)c[d].getPlaying()&&(c[d].pause(),this._pauseCache.push(c[d]))},_resumePlaying:function(){for(var a=this._pauseCache,b=0;b<a.length;b++)a[b].resume();a.length=0}};if(!d){var k=function(){var b=cc.audioEngine._currMusic;b&&!1===b._touch&&b._playing&&b.getPlaying()&&(b._touch=!0,b.play(0,b.loop),!a.replay&&cc._canvas.removeEventListener("touchstart",
k))};setTimeout(function(){cc._canvas&&cc._canvas.addEventListener("touchstart",k,!1)},150)}cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()})})(cc.__audioSupport);var res={image:{background_1:"res/image/background_1.png",background_2:"res/image/background_2.png",hero_fly_1:"res/image/hero_fly_1.png",hero_fly_2:"res/image/hero_fly_2.png",hero_blowup_1:"res/image/hero_blowup_1.png",hero_blowup_2:"res/image/hero_blowup_2.png",hero_blowup_3:"res/image/hero_blowup_3.png",hero_blowup_4:"res/image/hero_blowup_4.png",bullet1:"res/image/bullet1.png",bullet2:"res/image/bullet2.png",enemy1_fly_1:"res/image/enemy1_fly_1.png",enemy1_blowup_1:"res/image/enemy1_blowup_1.png",
enemy1_blowup_2:"res/image/enemy1_blowup_2.png",enemy1_blowup_3:"res/image/enemy1_blowup_3.png",enemy1_blowup_4:"res/image/enemy1_blowup_4.png",enemy2_fly_1:"res/image/enemy2_fly_1.png",enemy2_fly_2:"res/image/enemy2_fly_2.png",enemy2_hit_1:"res/image/enemy2_hit_1.png",enemy2_blowup_1:"res/image/enemy2_blowup_1.png",enemy2_blowup_2:"res/image/enemy2_blowup_2.png",enemy2_blowup_3:"res/image/enemy2_blowup_3.png",enemy2_blowup_4:"res/image/enemy2_blowup_4.png",enemy2_blowup_5:"res/image/enemy2_blowup_5.png",
enemy2_blowup_6:"res/image/enemy2_blowup_6.png",enemy2_blowup_7:"res/image/enemy2_blowup_7.png",enemy3_fly_1:"res/image/enemy3_fly_1.png",enemy3_hit_1:"res/image/enemy3_hit_1.png",enemy3_blowup_1:"res/image/enemy3_blowup_1.png",enemy3_blowup_2:"res/image/enemy3_blowup_2.png",enemy3_blowup_3:"res/image/enemy3_blowup_3.png",enemy3_blowup_4:"res/image/enemy3_blowup_4.png",enemy4_fly_1:"res/image/enemy4_fly_1.png",enemy5_fly_1:"res/image/enemy5_fly_1.png",game_pause:"res/image/game_pause.png",game_pause_hl:"res/image/game_pause_hl.png",
gray:"res/image/gray.png",bomb:"res/image/bomb.png"},sound:{game_music:"res/sound/game_music.mp3",bullet:"res/sound/bullet.mp3",enemy1_down:"res/sound/enemy1_down.mp3",enemy2_down:"res/sound/enemy2_down.mp3",enemy2_out:"res/sound/enemy2_out.mp3",enemy3_down:"res/sound/enemy3_down.mp3",game_over:"res/sound/game_over.mp3",achievement:"res/sound/achievement.mp3",out_porp:"res/sound/out_porp.mp3",button:"res/sound/button.mp3",use_bomb:"res/sound/use_bomb.mp3"},font:{type:"font",name:"MarkerFelt",srcs:["res/MarkerFelt.ttf"]}},
g_resources=[],i;for(i in res)if("font"===i)g_resources.push(res[i]);else for(var j in res[i])g_resources.push(res[i][j]),"image"===i&&(res[i][j]=cc.textureCache.addImage(res[i][j]));window.randrange=function(a,c){return Math.floor(Math.random()*(c-a))+a};window.bomb=0;window.bombDone=0;var Background=cc.Sprite.extend({image:null,ctor:function(){this._super();var a=new cc.Sprite,c=cc.Sprite.create(res.image.background_2),b=cc.Sprite.create(res.image.background_2);a.addChild(c,0);a.addChild(b,0);this.addChild(a,0);this.image=a;c.setAnchorPoint(0,0);b.attr({y:568,anchorX:0,anchorY:0});return!0}}),BackgroundLayer=cc.Layer.extend({background:null,ctor:function(){this._super();var a=new Background;this.addChild(a,0);this.background=a;a.setAnchorPoint(0,0);this.scheduleUpdate();return!0},
update:function(){this.background.y--; -568===this.background.y&&(this.background.y=0)}});var Bullet=cc.Sprite.extend({images:null,type:!1,ctor:function(){this._super();var a=cc.Sprite.create(res.image.bullet1);this.addChild(a,0);a.anchorY=0;var c=cc.Sprite.create(res.image.bullet2);this.addChild(c,0);c.attr({anchorY:0,visible:!1});this.images=[a,c];return!0},changeType:function(){this.images[0].visible=!this.images[0].visible;this.images[1].visible=!this.images[1].visible;this.type=!this.type}});var Hero=cc.Sprite.extend({clock:null,flyImages:null,dyingImages:null,died:!1,dyingIndex:0,ctor:function(){this._super();var a=cc.Sprite.create(res.image.hero_fly_1),c=cc.Sprite.create(res.image.hero_fly_2),b=cc.Sprite.create(res.image.hero_blowup_1);this.addChild(b,0);b.attr({anchorY:1,visible:!1});var d=cc.Sprite.create(res.image.hero_blowup_2);this.addChild(d,0);d.attr({anchorY:1,visible:!1});var e=cc.Sprite.create(res.image.hero_blowup_3);this.addChild(e,0);e.attr({anchorY:1,visible:!1});var f=
cc.Sprite.create(res.image.hero_blowup_4);this.addChild(f,0);f.attr({anchorY:1,visible:!1});this.dyingImages=[b,d,e,f];this.addChild(a,0);this.addChild(c,0);a.anchorY=1;c.attr({anchorY:1,visible:!1});this.flyImages=[a,c];this.clock=Date.now();this.scheduleUpdate();return!0},blowup:function(){window.game_over||(this.died=!0,window.mainScene.clock=Date.now(),window.mainScene.scheduleUpdate(),cc.audioEngine.playEffect(res.sound.game_over,!1),window.game_over=!0)},update:function(){if(100<=Date.now()-
this.clock){if(this.died)this.setted?4===this.dyingIndex?this.removeFromParent(!0):(this.dyingImages[this.dyingIndex].visible=!0,this.dyingIndex&&(this.dyingImages[this.dyingIndex-1].visible=!1),this.dyingIndex++):(this.flyImages[0].removeFromParent(!0),this.flyImages[1].removeFromParent(!0),this.setted=!0,this.update());else for(var a in this.flyImages)this.flyImages[a].visible=!this.flyImages[a].visible;this.clock=Date.now()}}}),HeroLayer=cc.Layer.extend({clock:null,pos:cc.p(160,100),ctor:function(){this._super();
var a=new Hero;this.addChild(a,0);window.hero=a;a.setPosition(this.pos);var c=this,a=new Bullet;this.addChild(a,1);window.bullet=a;a.setPosition(this.pos);a.anchorY=0;cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.MOUSE,onMouseMove:function(a){if(!window.paused){a=a.getLocation();var d=cc.p(a.x,a.y+32);window.hero.setPosition(d);c.pos=cc.p(a.x,a.y+32)}}}),this);this.clock=Date.now();this.scheduleUpdate();return!0},update:function(){568<=window.bullet.y?window.bullet.visible=
!1:window.bullet.y+=20;!window.game_over&&!window.bullet.visible&&Date.now()-this.clock>=(5E4<=window.score?125:150)&&(cc.audioEngine.playEffect(res.sound.bullet,!1),window.bullet.visible=!0,window.bullet.type?window.bullet.setPosition(this.pos.x,this.pos.y-28):window.bullet.setPosition(this.pos),this.clock=Date.now())}});var Enemy1=cc.Sprite.extend({dead:!1,dyingImages:null,dyingIndex:0,image:null,clock:0,speed:0,ctor:function(){this._super();var a=cc.Sprite.create(res.image.enemy1_fly_1);this.addChild(a,0);this.image=a;a.setAnchorPoint(0,1);this.speed=window.randrange(5E3,7001)/1E3;this.dyingImages=[cc.Sprite.create(res.image.enemy1_blowup_1),cc.Sprite.create(res.image.enemy1_blowup_2),cc.Sprite.create(res.image.enemy1_blowup_3),cc.Sprite.create(res.image.enemy1_blowup_4)];for(var c in this.dyingImages)this.addChild(this.dyingImages[c],
0),this.dyingImages[c].attr({anchorX:0,anchorY:1,visible:!1});return!0},blowup:function(){window.score+=1E3;cc.audioEngine.playEffect(res.sound.enemy1_down,!1);this.image.visible=!1;this.dead=this.dyingImages[0].visible=!0;this.clock=Date.now();this.scheduleUpdate()},update:function(){100<=Date.now()-this.clock&&(this.dyingIndex++,4===this.dyingIndex?this.removeFromParent(!0):(this.dyingImages[this.dyingIndex].visible=!0,this.dyingIndex&&(this.dyingImages[this.dyingIndex-1].visible=!1)),this.clock=
Date.now())}});var Enemy1Layer=cc.Layer.extend({interval:null,clock:null,enemy1s:[],ctor:function(){this._super();this.interval=window.randrange(300,1E3);var a=this;cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.MOUSE,onMouseDown:function(c){if(c.getButton()===cc.EventMouse.BUTTON_LEFT&&!window.paused&&window.bomb){window.bombDone++;for(var b in a.enemy1s)a.enemy1s[b].blowup();a.enemy1s=[]}}}),this);this.clock=Date.now();this.scheduleUpdate();return!0},update:function(){var a=[],c;for(c in this.enemy1s){var b=
this.enemy1s[c];if(0>=b.y)b.removeFromParent(!0);else{b.anchorY=0;b.y-=24;var d=b.getBoundingBox();d.width=34;d.height=24;b.anchorY=1;b.y+=24;window.bullet.setAnchorPoint(0,0);window.bullet.x-=window.bullet.type?24:3;window.bullet.y-=14;var e=window.bullet.getBoundingBox();e.width=window.bullet.type?48:6;e.height=14;window.bullet.setAnchorPoint(0.5,0);window.bullet.x+=window.bullet.type?24:3;window.bullet.y+=14;window.hero.setAnchorPoint(0,0);window.hero.x-=33;window.hero.y-=82;var f=window.hero.getBoundingBox();
f.x+=24;f.y+=21;f.width=17;f.height=61;window.heroBoundingBox1=f;var g=window.hero.getBoundingBox();g.x+=7;g.y+=25;g.width=49;g.height=25;window.heroBoundingBox2=g;window.hero.setAnchorPoint(0.5,1);window.hero.x+=33;window.hero.y+=82;(cc.rectIntersectsRect(d,f)||cc.rectIntersectsRect(d,g))&&window.hero.blowup();cc.rectIntersectsRect(d,e)&&!b.dead&&(b.blowup(),window.bullet.visible=!1);b.dead||(b.y-=b.speed,a.push(this.enemy1s[c]))}}this.enemy1s=a;!window.game_over&&Date.now()-this.clock>=this.interval&&
(a=new Enemy1,a.setPosition(window.randrange(0,286),592),this.addChild(a,1),this.enemy1s.push(a),this.interval=5E4<=window.score?window.randrange(0,351):window.randrange(0,1001),this.clock=Date.now())}});var Enemy2=cc.Sprite.extend({dead:!1,dyingImages:null,dyingIndex:0,hitimage:null,images:null,clock:0,speed:0,hit:!1,hitImage:null,life:20,delay:0,status:!1,flyingSound:null,ctor:function(){this._super();this.flyingSound=cc.audioEngine.playEffect(res.sound.enemy2_out,!0);var a=cc.Sprite.create(res.image.enemy2_fly_1);this.addChild(a,0);a.setAnchorPoint(0,1);var c=cc.Sprite.create(res.image.enemy2_fly_2);this.addChild(c,0);c.attr({anchorX:0,anchorY:1,visible:!1});this.images=[a,c];a=cc.Sprite.create(res.image.enemy2_hit_1);
this.addChild(a,0);this.hitImage=a;a.setAnchorPoint(0,1);a.visible=!1;this.speed=window.randrange(1400,1901)/1E3;this.dyingImages=[cc.Sprite.create(res.image.enemy2blowup_1),cc.Sprite.create(res.image.enemy2_blowup_2),cc.Sprite.create(res.image.enemy2_blowup_3),cc.Sprite.create(res.image.enemy2_blowup_4),cc.Sprite.create(res.image.enemy2_blowup_5),cc.Sprite.create(res.image.enemy2_blowup_6),cc.Sprite.create(res.image.enemy2_blowup_7)];for(var b in this.dyingImages)this.addChild(this.dyingImages[b],
0),this.dyingImages[b].attr({anchorX:0,anchorY:1,visible:!1});this.clock=Date.now();this.delay=Date.now();this.scheduleUpdate();return!0},blowup:function(){window.score+=1E4;cc.audioEngine.stopEffect(this.flyingSound);cc.audioEngine.playEffect(res.sound.enemy2_down,!1);for(var a in this.images)this.images[a].visible=!1,this.dyingImages[0].visible=!0;this.dead=!0},hitting:function(){this.life--;if(0>=this.life)this.blowup();else{this.hit=!0;for(var a in this.images)this.images[a].visible=!1;this.hitImage.visible=
!0}},update:function(){if(100<=Date.now()-this.clock){if(this.dead)this.dyingIndex++,7===this.dyingIndex?this.removeFromParent(!0):(this.dyingImages[this.dyingIndex].visible=!0,this.dyingIndex&&(this.dyingImages[this.dyingIndex-1].visible=!1));else{if(!this.hit)for(var a in this.images)this.images[a].visible=!this.images[a].visible;this.status=!this.status}this.clock=Date.now()}Date.now()-this.delay>=(5E4<=window.score?125:150)&&(this.hit&&(this.images[this.status?1:0].visible=!0,this.hit=this.hitImage.visible=
!1),this.delay=Date.now())}});var Enemy2Layer=cc.Layer.extend({interval:null,clock:null,enemy2s:[],ctor:function(){this._super();this.interval=2E4;var a=this;cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.MOUSE,onMouseDown:function(c){if(c.getButton()===cc.EventMouse.BUTTON_LEFT&&!window.paused&&window.bomb){window.bombDone++;for(var b in a.enemy2s)a.enemy2s[b].blowup();a.enemy2s=[]}}}),this);this.clock=Date.now();this.scheduleUpdate();return!0},update:function(){var a=[],c;for(c in this.enemy2s){var b=
this.enemy2s[c];if(0>=b.y)b.removeFromParent(!0);else{b.anchorY=0;b.y-=159;b.x+=15;var d=b.getBoundingBox();d.width=81;d.height=115;b.anchorY=1;b.y+=159;b.x-=15;window.bullet.setAnchorPoint(0,0);window.bullet.x-=window.bullet.type?24:3;window.bullet.y-=14;var e=window.bullet.getBoundingBox();e.width=window.bullet.type?48:6;e.height=14;window.bullet.setAnchorPoint(0.5,0);window.bullet.x+=window.bullet.type?24:3;window.bullet.y+=14;window.hero.setAnchorPoint(0,0);window.hero.x-=33;window.hero.y-=82;
var f=window.hero.getBoundingBox();f.x+=24;f.y+=21;f.width=17;f.height=61;window.heroBoundingBox1=f;var g=window.hero.getBoundingBox();g.x+=7;g.y+=25;g.width=49;g.height=25;window.heroBoundingBox2=g;window.hero.setAnchorPoint(0.5,1);window.hero.x+=33;window.hero.y+=82;(cc.rectIntersectsRect(d,f)||cc.rectIntersectsRect(d,g))&&window.hero.blowup();cc.rectIntersectsRect(d,e)&&!b.dead&&(b.life-=window.bullet.type?1:0,b.hitting(),window.bullet.visible=!1,window.bullet.setPosition(-100,-100));b.dead||(b.y-=
b.speed,a.push(this.enemy2s[c]))}}this.enemy2s=a;!window.game_over&&Date.now()-this.clock>=this.interval&&(a=new Enemy2,a.setPosition(window.randrange(0,210),732),this.addChild(a,1),this.enemy2s.push(a),this.interval=5E4<=window.score?window.randrange(5E3,15001):window.randrange(1E4,20001),this.clock=Date.now())}});var Enemy3=cc.Sprite.extend({dead:!1,dyingImages:null,dyingIndex:0,hitimage:null,image:null,clock:0,speed:0,hit:!1,hitImage:null,life:8,delay:0,ctor:function(){this._super();var a=cc.Sprite.create(res.image.enemy3_fly_1);this.addChild(a,0);this.image=a;a.setAnchorPoint(0,1);a=cc.Sprite.create(res.image.enemy3_hit_1);this.addChild(a,0);this.hitImage=a;a.setAnchorPoint(0,1);a.visible=!1;this.speed=window.randrange(2500,5001)/1E3;this.dyingImages=[cc.Sprite.create(res.image.enemy3blowup_1),cc.Sprite.create(res.image.enemy3_blowup_2),
cc.Sprite.create(res.image.enemy3_blowup_3),cc.Sprite.create(res.image.enemy3_blowup_4)];for(var c in this.dyingImages)this.addChild(this.dyingImages[c],0),this.dyingImages[c].attr({anchorX:0,anchorY:1,visible:!1});this.clock=Date.now();this.delay=Date.now();this.scheduleUpdate();return!0},blowup:function(){window.score+=6E3;cc.audioEngine.playEffect(res.sound.enemy3_down,!1);this.image.visible=!1;this.dead=this.dyingImages[0].visible=!0},hitting:function(){this.life--;0>=this.life?this.blowup():
(this.hit=!0,this.image.visible=!1,this.hitImage.visible=!0)},update:function(){100<=Date.now()-this.clock&&(this.dead&&(this.dyingIndex++,4===this.dyingIndex?this.removeFromParent(!0):(this.dyingImages[this.dyingIndex].visible=!0,this.dyingIndex&&(this.dyingImages[this.dyingIndex-1].visible=!1))),this.clock=Date.now());Date.now()-this.delay>=(5E4<=window.score?125:150)&&(this.hit&&(this.image.visible=!0,this.hit=this.hitImage.visible=!1),this.delay=Date.now())}});var Enemy3Layer=cc.Layer.extend({interval:null,clock:null,enemy3s:[],ctor:function(){this._super();this.interval=1E4;var a=this;cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.MOUSE,onMouseDown:function(c){if(c.getButton()===cc.EventMouse.BUTTON_LEFT&&!window.paused&&window.bomb){window.bombDone++;for(var b in a.enemy3s)a.enemy3s[b].blowup();a.enemy3s=[]}}}),this);this.clock=Date.now();this.scheduleUpdate();return!0},update:function(){var a=[],c;for(c in this.enemy3s){var b=
this.enemy3s[c];if(0>=b.y)b.removeFromParent(!0);else{b.anchorY=0;b.y-=60;var d=b.getBoundingBox();d.width=46;d.height=60;b.anchorY=1;b.y+=60;window.bullet.setAnchorPoint(0,0);window.bullet.x-=window.bullet.type?24:3;window.bullet.y-=14;var e=window.bullet.getBoundingBox();e.width=window.bullet.type?48:6;e.height=14;window.bullet.setAnchorPoint(0.5,0);window.bullet.x+=window.bullet.type?24:3;window.bullet.y+=14;window.hero.setAnchorPoint(0,0);window.hero.x-=33;window.hero.y-=82;var f=window.hero.getBoundingBox();
f.x+=24;f.y+=21;f.width=17;f.height=61;window.heroBoundingBox1=f;var g=window.hero.getBoundingBox();g.x+=7;g.y+=25;g.width=49;g.height=25;window.heroBoundingBox2=g;window.hero.setAnchorPoint(0.5,1);window.hero.x+=33;window.hero.y+=82;(cc.rectIntersectsRect(d,f)||cc.rectIntersectsRect(d,g))&&window.hero.blowup();cc.rectIntersectsRect(d,e)&&!b.dead&&(b.life-=window.bullet.type?1:0,b.hitting(),window.bullet.visible=!1,window.bullet.setPosition(-100,-100));b.dead||(b.y-=b.speed,a.push(this.enemy3s[c]))}}this.enemy3s=
a;!window.game_over&&Date.now()-this.clock>=this.interval&&(a=new Enemy3,a.setPosition(window.randrange(0,274),628),this.addChild(a,1),this.enemy3s.push(a),this.interval=5E4<=window.score?window.randrange(1E3,2501):window.randrange(2E3,5001),this.clock=Date.now())}});var AllEnemiesLayer=cc.Layer.extend({ctor:function(){this._super();var a=new Enemy1Layer;this.addChild(a,2);a=new Enemy2Layer;this.addChild(a,0);a=new Enemy3Layer;this.addChild(a,1);return!0}});window.supply=null;window.supplyType=null;
var AllSuppliesLayer=cc.Layer.extend({clock:null,supplies:null,still:null,ctor:function(){this._super();this.supplies=[res.image.enemy4_fly_1,res.image.enemy5_fly_1];this.clock=Date.now();this.scheduleUpdate();return!0},update:function(){if(null!=window.supply){var a=window.supply.getBoundingBox();a.width=window.supply.getTextureRect().width;a.height=window.supply.getTextureRect().height;if(cc.rectIntersectsRect(window.heroBoundingBox1,a)||cc.rectIntersectsRect(window.heroBoundingBox2,a))cc.audioEngine.playEffect(res.sound.achievement,
!1),window.supplyType?(window.bullet.type||window.bullet.changeType(),this.still=Date.now()):window.bomb++,window.supply.setPosition(-100,-100)}window.bullet.type&&18E3<=Date.now()-this.still&&window.bullet.changeType();3E4<=Date.now()-this.clock&&(cc.audioEngine.playEffect(res.sound.out_porp,!1),null!=window.supply&&window.supply.removeFromParent(!0),a=window.randrange(0,2),window.supply=cc.Sprite.create(this.supplies[a]),this.addChild(window.supply),window.supplyType=a,window.supply.attr({x:window.randrange(0,
320-window.supply.getTextureRect().width),y:568,anchorX:0,anchorY:0}),this.clock=Date.now());null!=window.supply&&(window.supply.y-=5)}});window.paused=!1;window.lastBomb=0;
var PauseLayer=cc.Layer.extend({scoreLabel:null,canResume:!0,bombNumber:null,ctor:function(){this._super();var a=cc.winSize,c=this,b=cc.Sprite.create(res.image.gray);this.addChild(b,1);b.attr({anchorX:0,anchorY:0,visible:!1});var d=cc.Sprite.create(res.image.bomb);this.addChild(d,0);d.attr({x:10,y:10,anchorX:0,anchorY:0});d=cc.LabelTTF.create("x0","MarkerFelt",28);this.addChild(d,0);d.attr({x:55,y:10,anchorX:0,anchorY:0});this.bombNumber=d;var e=[cc.Sprite.create(res.image.game_pause),cc.Sprite.create(res.image.game_pause_hl)];
this.addChild(e[0],2);this.addChild(e[1],2);e[0].attr({x:5,y:563,anchorX:0,anchorY:1});e[1].attr({x:5,y:563,anchorX:0,anchorY:1,visible:!1});d=cc.LabelTTF.create("0","MarkerFelt",20);this.addChild(d,2);this.scoreLabel=d;d.attr({x:38,y:555,anchorX:0,anchorY:1});var f=cc.LabelTTF.create("\u8bf7\u5c06\u9f20\u6807\u653e\u5230\u98de\u673a\u4e0a\u518d\u6062\u590d\u6e38\u620f\uff01","",18);this.addChild(f,2);f.attr({x:a.width/2,y:530,anchorX:0.5,anchorY:1,visible:!1,color:cc.color(255,0,0)});cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.MOUSE,
onMouseDown:function(a){a.getButton()===cc.EventMouse.BUTTON_RIGHT?(e[0].visible=!1,e[1].visible=!0):a.getButton()===cc.EventMouse.BUTTON_LEFT&&!window.paused&&window.bomb&&cc.audioEngine.playEffect(res.sound.use_bomb,!1)},onMouseMove:function(a){window.paused&&(a=a.getLocation(),cc.rectContainsPoint(window.heroBoundingBox1,a)||cc.rectContainsPoint(window.heroBoundingBox2,a)||window.game_over?(c.canResume=!0,f.visible=!1):(c.canResume=!1,f.visible=!0))},onMouseUp:function(a){a.getButton()===cc.EventMouse.BUTTON_RIGHT&&
(e[0].visible=!0,e[1].visible=!1,window.paused&&c.canResume?(b.visible=!1,cc.director.resume(),window.paused=!1):(b.visible=!0,cc.director.pause(),window.paused=!0))}}),this);this.scheduleUpdate();return!0},update:function(){3===window.bombDone&&(window.bomb--,window.bombDone=0);if(window.score!=window.lastScore){this.scoreLabel.removeFromParent(!0);var a=cc.LabelTTF.create(window.score,"MarkerFelt",20);this.addChild(a,2);this.scoreLabel=a;a.attr({x:38,y:555,anchorX:0,anchorY:1});window.lastScore=
window.score}window.bomb!=window.lastBomb&&(this.bombNumber.removeFromParent(!0),a=cc.LabelTTF.create("x"+window.bomb,"MarkerFelt",24),this.addChild(a,0),a.attr({x:55,y:10,anchorX:0,anchorY:0}),this.bombNumber=a,window.lastBomb=window.bomb)}});window.playing=!1;window.game_over=!1;window.canvas=document.getElementById("gameCanvas");
var ScoreScene=cc.Scene.extend({hover:!1,onEnter:function(){this._super();var a=cc.winSize;cc.audioEngine.stopAllEffects();var c=this,b=window.localStorage.getItem("score100041512");(null===b||window.score>b)&&window.localStorage.setItem("score100041512",window.score);var d=new cc.Layer;this.addChild(d,0);var e=cc.LabelTTF.create("Loading...","MarkerFelt",24);d.addChild(e,1);e.attr({x:a.width/2,y:260,anchorX:0.5,anchorY:0.5});h5api.submitScore(window.score,function(b){h5api.getRank(function(b){if(1E4==
b.code){b=b.data;e.removeFromParent(!0);var c=cc.LabelTTF.create(b[0].score,"MarkerFelt",24);d.addChild(c,1);c.attr({x:a.width/2,y:260,anchorX:0.5,anchorY:0.5});if(window.score)for(var f in b){if(b[f].score==window.score){f=cc.LabelTTF.create(b[f].rank,"MarkerFelt",24);d.addChild(f,1);f.attr({x:a.width/2,y:160,anchorX:0.5,anchorY:0.5});break}}else f=cc.LabelTTF.create(b.length+1,"MarkerFelt",24),d.addChild(f,1),f.attr({x:a.width/2,y:160,anchorX:0.5,anchorY:0.5})}else window.alert("\u6392\u884c\u699c\u83b7\u53d6\u5931\u8d25\uff01")})});
b=cc.Sprite.create(res.image.background_2);d.addChild(b,0);b.setAnchorPoint(0,0);b=cc.LabelTTF.create("\u606d\u559c\uff01\u60a8\u7684\u6700\u7ec8\u6210\u7ee9\u662f","",26);d.addChild(b,1);b.attr({x:a.width/2,y:500,anchorX:0.5,anchorY:0.5,color:cc.color(130,130,130)});b=cc.LabelTTF.create(window.score||"0","MarkerFelt",24);d.addChild(b,1);b.attr({x:a.width/2,y:460,anchorX:0.5,anchorY:0.5});b=cc.LabelTTF.create("\u60a8\u7684\u6700\u9ad8\u5206","",26);d.addChild(b,1);b.attr({x:a.width/2,y:400,anchorX:0.5,
anchorY:0.5,color:cc.color(130,130,130)});b=cc.LabelTTF.create(window.localStorage.getItem("score100041512")||"0","MarkerFelt",24);d.addChild(b,1);b.attr({x:a.width/2,y:360,anchorX:0.5,anchorY:0.5});b=cc.LabelTTF.create("\u6240\u6709\u73a9\u5bb6\u7684\u6700\u9ad8\u5206","",26);d.addChild(b,1);b.attr({x:a.width/2,y:300,anchorX:0.5,anchorY:0.5,color:cc.color(130,130,130)});b=cc.LabelTTF.create("\u60a8\u7684\u6392\u540d","",26);d.addChild(b,1);b.attr({x:a.width/2,y:200,anchorX:0.5,anchorY:0.5,color:cc.color(130,
130,130)});b=cc.LabelTTF.create("\u518d\u73a9\u4e00\u6b21","",26);d.addChild(b,1);b.attr({x:a.width/2,y:50,anchorX:0.5,anchorY:0,color:cc.color(255,130,0)});var f=b.getBoundingBox();cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.MOUSE,onMouseDown:function(a){var b=a.getLocation();a.getButton()===cc.EventMouse.BUTTON_LEFT&&cc.rectContainsPoint(f,b)&&(window.canvas.style.cursor="default",cc.audioEngine.stopAllEffects(),cc.audioEngine.stopMusic(),window.playing=!1,window.game_over=
!1,window.bombDone=0,window.bomb=0,window.paused=!1,window.lastBomb=0,window.supply=null,window.supplyType=null,window.bullet.type=0,cc.director.runScene(new StartScene))},onMouseMove:function(a){a=a.getLocation();cc.rectContainsPoint(f,a)?(c.hover||(window.canvas.style.cursor="pointer",cc.audioEngine.playEffect(res.sound.button,!1)),c.hover=!0):(c.hover&&(window.canvas.style.cursor="default"),c.hover=!1)}}),this)}}),MainScene=cc.Scene.extend({clock:null,onEnter:function(){this._super();cc.audioEngine.playMusic(res.sound.game_music,
!0);var a=new BackgroundLayer;this.addChild(a,0);a=new HeroLayer;this.addChild(a,1);a=new AllEnemiesLayer;this.addChild(a,2);a=new AllSuppliesLayer;this.addChild(a,3);a=new PauseLayer;this.addChild(a,4)},update:function(){2E3<=Date.now()-this.clock&&cc.director.runScene(new ScoreScene)}}),StartScene=cc.Scene.extend({onEnter:function(){this._super();var a=new cc.Layer;this.addChild(a,0);var c=cc.Sprite.create(res.image.background_1);a.addChild(c,0);c.setAnchorPoint(0,0);cc.eventManager.addListener({event:cc.EventListener.MOUSE,
onMouseDown:function(a){window.playing||a.getButton()!==cc.EventMouse.BUTTON_LEFT||(window.mainScene=new MainScene,cc.director.runScene(window.mainScene),window.playing=!0)}},this)}});h5api.initGame(100041512,"\u7ecf\u5178\u98de\u673a\u5927\u6218",320,568);var progress=0,tag=window.setInterval(function(){h5api.progress(progress);100<=window.progress&&(h5api.progress(100),window.clearInterval(tag));progress+=10*Math.random()},300);
cc.game.onStart=function(){window.score=0;window.lastScore=0;cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(320,568,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new StartScene)},this)};cc.game.run();